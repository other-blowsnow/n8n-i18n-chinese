const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-CEydhDwY.js","assets/chunk-CC9Q-vWm.js","assets/core-nTgY3UvQ.js","assets/languageModules-Dms1yyhx.js","assets/xml-DSPlQU-O.js"])))=>i.map(i=>d[i]);
...
import { Ja as N8nButton_default, Ji as truncateBeforeLast } from "./src-BwN8TeVO.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-CEydhDwY.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-Dms1yyhx.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
