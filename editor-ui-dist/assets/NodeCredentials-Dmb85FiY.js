...
import { at as I18nT, it as useI18n } from "./core-CwaTdA6t.js";
import { Ai as N8nTooltip_default, Ca as N8nText_default, L as N8nNotice_default, Pi as Input_default, Ta as N8nIcon_default, W as ActionPill_default, _i as N8nBadge_default, _t as N8nOption_default, gt as N8nSelect_default, tt as N8nLink_default, ut as N8nInputLabel_default, wa as N8nButton_default } from "./src-4M_3Mukr.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Ai as getAppNameFromCredType, Ii as getNodeCredentialForSelectedAuthType, Ji as updateNodeAuthType, Mi as getAuthTypeForNodeCredential, Ni as getMainAuthField, Vi as hasProxyAuth, Wi as isRequiredCredential, b as useNodeTypesStore, cn as injectNDVStore, fn as injectWorkflowDocumentStore, ia as isEmpty, ki as getAllNodeCredentialForAuthType, pt as useCredentialsStore, r as useUIStore, rn as useTelemetry, s as useWorkflowsStore, tn as useProjectsStore, xn as useNodeHelpers } from "./users.store-DI4bmc3m.js";
import { t as useToast } from "./useToast-iCe0kksm.js";
import { Yi as WORKFLOW_SETTINGS_MODAL_KEY, _n as KEEP_AUTH_IN_NDV_FOR_NODES, ci as AI_GATEWAY_TOP_UP_MODAL_KEY, tl as getResourcePermissions } from "./constants-CVUc8I0d.js";
import { h as assert } from "./useRootStore-Dw8BvkQq.js";
import { n as ndvEventBus } from "./useCodeDiff-DjKMY7B9.js";
import { n as useCredentialOAuth, t as useQuickConnect } from "./useQuickConnect-D3MNoFOo.js";
...
var NodeCredentials_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		watch(credentialTypesNodeDescriptionDisplayed, (types) => {
			...
			if (allOptions.length === 0) {
				if (aiGateway.isEnabled.value) {
					for (const { type } of types) if (aiGateway.isCredentialTypeSupported(type.name)) onAiGatewaySelector(type.name, true);
				}
				return;
			}
		...
		function onAiGatewaySelector(credentialType, enable) {
			const credentials = { ...props.node.credentials ?? {} };
				...
				return openBlock(), createElementBlock("div", { key: type.name }, [createVNode(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [
						...
						__props.readonly && !isAiGatewayManagedCredentials(type.name) ? (openBlock(), createElementBlock("div", _hoisted_1, [createVNode(unref(Input_default), {
							...
							"service-name"
						]), createBaseVNode("span", { class: normalizeClass(_ctx.$style.setupManuallyContainer) }, [createVNode(unref(N8nText_default), {
							size: "small",
							...
							_: 1
						}, 8, ["class", "onClick"])], 2)], 2)) : showStandardEmptyState(type) && options.length === 0 ? (openBlock(), createElementBlock("div", {
							key: 3,
