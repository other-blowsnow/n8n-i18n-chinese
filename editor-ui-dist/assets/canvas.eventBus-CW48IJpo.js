...
import { bt as createEventBus } from "./src-DVkMmVCd.js";
import { a as require_toString, o as require__arrayMap, t as require_get } from "./get-Den8eczo.js";
import { G as nodeTypesToCreateElements, Gn as CanvasConnectionMode, H as isAINode, I as finalizeItems, J as searchNodes, K as prepareCommunityNodeDetailsViewStack, L as flattenCreateElements, Li as getThemedValue, Q as transformNodeType, R as getAiTemplatesCallout, S as useEvaluationStore, Un as isVueFlowConnection, V as groupItemsInSections, W as mapToolSubcategoryIcon, X as sortNodeCreateElements, Z as subcategorizeItems, b as useNodeTypesStore, fn as injectWorkflowDocumentStore, ln as useNDVStore, r as useUIStore, rn as useTelemetry, s as useWorkflowsStore, ut as require_upperFirst } from "./users.store-Dpbobzbe.js";
import { $ as AI_CATEGORY_TOOLS, B as AI_CATEGORY_AGENTS, Dt as AI_TRANSFORM_NODE_TYPE, Ec as EVALUATION_TRIGGER_NODE_TYPE, G as AI_CATEGORY_LANGUAGE_MODELS, Gc as require__SetCache, Gn as REMOVE_DUPLICATES_NODE_TYPE, Gs as isCommunityPackageName, Gt as DATETIME_NODE_TYPE, H as AI_CATEGORY_DOCUMENT_LOADERS, Ht as CRYPTO_NODE_TYPE, It as CODE_NODE_TYPE, Lt as COMPRESSION_NODE_TYPE, Pt as CHAT_TRIGGER_NODE_TYPE, Q as AI_CATEGORY_TEXT_SPLITTERS, Qn as SET_NODE_TYPE, Rc as v4, Rt as CONVERT_TO_FILE_NODE_TYPE, Sn as MARKDOWN_NODE_TYPE, Ss as isHitlToolType, U as AI_CATEGORY_EMBEDDING, Uo as require__arrayIncludesWith, V as AI_CATEGORY_CHAINS, Wc as require__cacheHas, Wo as require__arrayIncludes, Wt as DATA_TABLE_NODE_TYPE, X as AI_CATEGORY_RETRIEVERS, Xt as EMAIL_SEND_NODE_TYPE, Y as AI_CATEGORY_OUTPUTPARSER, Yn as SCHEDULE_TRIGGER_NODE_TYPE, Yt as EMAIL_IMAP_NODE_TYPE, Z as AI_CATEGORY_ROOT_NODES, _t as REGULAR_NODE_CREATOR_VIEW, an as FORM_TRIGGER_NODE_TYPE, at as AI_UNCATEGORIZED_CATEGORY, br as XML_NODE_TYPE, bt as TRANSFORM_DATA_SUBCATEGORY, cn as HTML_NODE_TYPE, ct as CORE_NODES_CATEGORY, ds as getNodeInputs, dt as HITL_SUBCATEGORY, et as AI_CATEGORY_VECTOR_STORES, fn as IF_NODE_TYPE, ft as HUMAN_IN_THE_LOOP_CATEGORY, ht as OTHER_TRIGGER_NODES_SUBCATEGORY, ir as SPLIT_OUT_NODE_TYPE, ko as require__createCompounder, ln as HTTP_REQUEST_NODE_TYPE, lt as FLOWS_CONTROL_SUBCATEGORY, mo as require__baseFlatten, mr as WEBHOOK_NODE_TYPE, mt as NODE_CREATOR_OPEN_SOURCES, nn as EXTRACT_FROM_FILE_NODE_TYPE, ot as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, pt as NEW_TOOL_CATEGORIES, q as AI_CATEGORY_MEMORY, qn as RSS_READ_NODE_TYPE, qt as EDIT_IMAGE_NODE_TYPE, rn as FILTER_NODE_TYPE, rr as SPLIT_IN_BATCHES_NODE_TYPE, rt as AI_OTHERS_NODE_CREATOR_VIEW, sr as SUMMARIZE_NODE_TYPE, tn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, uc as NodeConnectionTypes, ut as HELPERS_SUBCATEGORY, vn as LIMIT_NODE_TYPE, wn as MERGE_NODE_TYPE, wt as AGGREGATE_NODE_TYPE, xn as MANUAL_TRIGGER_NODE_TYPE, xt as TRIGGER_NODE_CREATOR_VIEW, yt as TEMPLATE_CATEGORY_AI } from "./constants-B2-iseoM.js";
...
import { n as getNodeIconSource } from "./nodeIcon-Dym8oa4A.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-DRsqgVDX.js";
import { t as _virtual_node_popularity_data_default } from "./_virtual_node-popularity-data-Dg9TLAjN.js";
