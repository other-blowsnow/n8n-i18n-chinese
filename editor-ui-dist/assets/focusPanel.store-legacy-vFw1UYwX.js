;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-2Qb71DGn.js", "./truncate-legacy-ZZ87M1Mo.js", "./useTelemetry-legacy-Ck7lGOrk.js", "./constants-legacy-D0ziSY9e.js", "./useRootStore-legacy-D1vvqLPX.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watchOnce, i18n, require_get, STORES, useWorkflowsStore, useNodeTypesStore, useStorage, FROM_AI_AUTO_GENERATED_MARKER, extractFromAICalls, jsonParse, LOCAL_STORAGE_FOCUS_PANEL, PLACEHOLDER_EMPTY_WORKFLOW_ID, defineStore, NODE_DENYLIST, PATH_DENYLIST, PROP_TYPE_DENYLIST, fromAIExtraProps, import_get, DEFAULT_PANEL_WIDTH, DEFAULT_FOCUS_PANEL_DATA, useFocusPanelStore;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        FROM_AI_AUTO_GENERATED_MARKER = _constantsLegacy00NJs.Da;
        extractFromAICalls = _constantsLegacy00NJs.Ur;
        jsonParse = _constantsLegacy00NJs.Xi;
        LOCAL_STORAGE_FOCUS_PANEL = _constantsLegacy00NJs._s;
