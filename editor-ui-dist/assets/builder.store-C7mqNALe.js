...
import { J as useDebounceFn, at as useI18n, v as useLocalStorage } from "./core-CiwaTfw5.js";
import { Oi as isToolMessage$1, ki as isWorkflowUpdatedMessage$1, lt as useRoute, ut as useRouter } from "./src-DpBG5nOa.js";
import { t as useMessage } from "./useMessage-Ci45nj0N.js";
import { $t as createWorkflowDocumentId, Mt as useWorkflowHelpers, Qi as stringSizeInBytes, Qt as useNDVStore, Rt as useWorkflowsListStore, Xt as usePostHog, ct as clearBuilderSession, dn as useCanvasStore, dt as getBuilderCredits, ea as tryToParseNumber, mt as useAIAssistantHelpers, nn as useWorkflowDocumentStore, pt as truncateBuilderMessages, qt as useTelemetry, r as useUIStore, ra as getNewWorkflow, s as useWorkflowsStore, st as chatWithBuilder, un as useNodeHelpers, ut as getAiSessions, yn as isDebouncedFunction, zr as useSourceControlStore } from "./users.store-Bfu2rIUB.js";
import { t as useToast } from "./useToast-D9LVQNVI.js";
import { Es as isExpression, Fc as AI_BUILDER_PLAN_MODE_EXPERIMENT, Hc as CODE_WORKFLOW_BUILDER_EXPERIMENT, Ni as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, Rc as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, Xc as FOCUSED_NODES_EXPERIMENT, Zc as MERGE_ASK_BUILD_EXPERIMENT, ci as MODAL_CANCEL, fi as NPS_SURVEY_MODAL_KEY, gl as THREE_DAYS_IN_MILLIS, hl as SIX_MONTHS_IN_MILLIS, li as MODAL_CLOSE, ml as SEVEN_DAYS_IN_MILLIS, pc as getResourcePermissions, rs as dedupe, t as AutoSaveState, ui as MODAL_CONFIRM, ul as DEBOUNCE_TIME, vl as getDebounceTime, zr as VIEWS } from "./constants-ixIyBnRU.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-Cj92_BSw.js";
import { In as STORES, a as updateWorkflowHistoryVersion, at as updateNpsSurveyState, i as getWorkflowVersionsByIds, n as getWorkflowHistory, r as getWorkflowVersion, t as useSettingsStore } from "./settings.store-VsmHBYo6.js";
import { t as useExternalHooks } from "./useExternalHooks-Dx9wPOUy.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-v4CaPDpq.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-B3l3Sgru.js";
