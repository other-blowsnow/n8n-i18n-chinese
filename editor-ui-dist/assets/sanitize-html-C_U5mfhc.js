...
import { a as require_call_bound, b as require_type, i as init_dist$1, n as init_empty, o as require_get_intrinsic, r as Buffer, t as empty_exports, w as require___vite_browser_external, x as require_path_browserify } from "./empty-CuAtJ5og.js";
	...
	*/
	function findOne(test, nodes, recurse) {
		...
		for (var i = 0; i < nodes.length && !elem; i++) {
			var node = nodes[i];
			if (!(0, domhandler_1.isTag)(node)) continue;
