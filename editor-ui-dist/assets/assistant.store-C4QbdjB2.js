...
import { ct as useRoute } from "./src-pyi3rpL8.js";
import { Ot as useAIAssistantHelpers, bt as chatWithAssistant, gn as createWorkflowDocumentId, ln as useTelemetry, pi as hasPermission, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, yn as useWorkflowDocumentStore, yt as useCredentialsStore } from "./users.store-DjNI0iy4.js";
import { Lc as v4, ni as EDITABLE_CANVAS_VIEWS } from "./constants-BC_f8ato.js";
...
import { r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-Ds9XMbrD.js";
	...
	*/
	async function getVisualContext(nodeInfo) {
		...
		return {
			...
			currentWorkflow: workflowDataStale.value ? await assistantHelpers.simplifyWorkflowForAssistant(workflowDocumentStore.value.getSnapshot(), { excludeParameterValues: !allowSendingParameterValues.value }) : void 0,
