import { d as defineComponent, Q as useUIStore, dh as useCredentialsStore, av as useProjectsStore, x as computed, c as useI18n, aC as getResourcePermissions, g6 as dateFormat, e as createBlock, g as openBlock, s as N8nCard, B as withModifiers, n as normalizeClass, w as withCtx, j as createBaseVNode, i as createVNode, h as createElementBlock, f as createCommentVNode, b3 as withDirectives, t as toDisplayString, b4 as vShow, k as createTextVNode, l as unref, eU as _sfc_main$2, p as N8nText, aT as ResourceType, gf as ProjectCardBadge, en as N8nActionToggle, aL as N8nBadge, gy as CredentialIcon, an as useMessage, ao as MODAL_CONFIRM, aU as PROJECT_MOVE_RESOURCE_MODAL, _ as _export_sfc, ae as useNodeTypesStore, ag as useSourceControlStore, di as useExternalSecretsStore, u as useUsersStore, gl as useInsightsStore, ay as useDocumentTitle, a3 as useRoute, b as useRouter, r as ref, gz as listenForModalChanges, a8 as watch, o as onMounted, e4 as N8nActionBox, ed as N8nInputLabel, eg as N8nSelect, F as Fragment, A as renderList, eh as _sfc_main$4, f7 as N8nCheckbox, gA as CREDENTIAL_EMPTY_VALUE, am as useTelemetry, v as useSettingsStore, aF as EnterpriseEditionFeature, cQ as useEnvironmentsStore, gB as CREDENTIAL_SELECT_MODAL_KEY, V as VIEWS, gC as CREDENTIAL_EDIT_MODAL_KEY, gD as isCredentialsResource } from "./index-BXVCKjk6.js";
import { _ as _sfc_main$3 } from "./EmptySharedSectionActionBox.vue_vue_type_script_setup_true_lang-BGar_HmM.js";
import { R as ResourcesListLayout } from "./ResourcesListLayout-Cgb5h0aS.js";
import { P as ProjectHeader } from "./ProjectHeader-C-ReXl77.js";
import { u as useProjectPages } from "./useProjectPages-BknnyrMl.js";
import { I as InsightsSummary } from "./InsightsSummary-CIB0-bC4.js";
import { p as pickBy } from "./pickBy-zPH9Ulgd.js";
import "./TableBase-BPe88VDG.js";
import "./PageViewLayout-O3qQyg0W.js";
import "./readyToRunWorkflowsV2.store-OdDm62FP.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(ResourcesListLayout, {
        ...
        empty: withCtx(() => [
          ...
          }, null, 8, ["personal-project"])) : (openBlock(), createBlock(_component_N8nActionBox, {
            key: 1,
