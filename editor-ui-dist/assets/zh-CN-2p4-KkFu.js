...
const zhCN = {
  ...
  "aiAssistant.builder.plan.intro": "你想继续执行这个计划吗？",
  "aiAssistant.builder.plan.approve": "批准计划",
  "aiAssistant.builder.plan.reject": "请求变更",
  "aiAssistant.builder.plan.whatToChange": "你希望改变什么？",
  ...
  "dataStore.empty.description": "一旦您为您的项目创建数据表，它们将在这里显示。",
  "dataStore.empty.button.label": '在 "{projectName}" 中创建数据表',
  ...
  "dataStore.add.title": "创建新的数据表",
  "dataStore.add.description": "设置一个新的数据表以组织和管理您的数据。",
  ...
  "dataStore.deleteColumn.confirm.message": "您确定要删除列“{name}”吗？此操作无法撤消。",
  "dataStore.addColumn.invalidName.error": "无效的列名",
  "dataStore.addColumn.invalidName.description": "列名称仅允许使用字母数字字符和非前导破折号。",
