...
import { Bt as useNDVStore, C as useNodeTypesStore, Ea as COMMUNITY_NODES_INSTALLATION_DOCS_URL, It as useNodeHelpers, Kt as ProjectTypes, Lt as useTelemetry, R as removePreviewToken, Rr as useWorkflowsListStore, Tt as useWorkflowHelpers, Vt as injectWorkflowState, _a as importCurlEventBus, fi as useHistoryStore, ka as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, w as useActionsGenerator, ws as useSettingsStore, xi as RenameNodeCommand, xr as useExternalHooks, yr as useToast } from "./users.store-BwYRQvCY.js";
import { O as NodeCredentials_default, d as useNodeSettingsParameters, f as collectParametersByTab, g as getNodeSettingsInitialValues, j as TitledList_default, k as useNodeCredentialOptions, m as createCommonNodeSettings, p as collectSettings, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-CMifcPXg.js";
import { n as ElRow, t as ElCol } from "./col-CzbFUcWF.js";
import { Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, Jn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Nn as MCP_TRIGGER_NODE_TYPE, Oo as OPEN_AI_API_CREDENTIAL_TYPE, Ua as deepCopy, Wa as isCommunityPackageName, Zn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, co as NodeConnectionTypes, d as CUSTOM_NODES_DOCS_URL, da as getNodeInputs, en as DATA_TABLE_NODES, gn as FORM_TRIGGER_NODE_TYPE, l as BUILTIN_NODES_DOCS_URL, pa as getNodeParameters, rs as VIEWS, s as BASE_NODE_SURVEY_URL, x as NPM_PACKAGE_DOCS_BASE_URL } from "./constants-RiJkz47J.js";
import { t as useDebounce } from "./useDebounce-BghtiK4X.js";
...
import { a as useInstalledCommunityPackage, i as ContactAdministratorToInstall_default, n as CommunityNodeUpdateInfo_default, o as useInstallNode, r as CommunityNodeFooter_default, t as QuickConnectBanner_default } from "./QuickConnectBanner-DdHTFyFX.js";
import { t as useQuickConnect } from "./useQuickConnect-ksDLeUyB.js";
import { t as NodeIcon_default } from "./NodeIcon-BdHBfPBt.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-BeuLcrBR.js";
import { t as useFreeAiCredits } from "./useFreeAiCredits-CggdbObE.js";
