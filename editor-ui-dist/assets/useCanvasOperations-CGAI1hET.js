...
import { s as useI18n$1 } from "./src-DXwO88M2.js";
import { Mi as require_markdown_it_link_attributes, ct as useRoute, lt as useRouter } from "./src-pyi3rpL8.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { c as useClipboard, v as useLocalStorage } from "./core-vNZq-xzE.js";
import { $ as removePreviewToken, $r as isValidNodeConnectionType, An as useHistoryStore, Bn as ReplaceNodeParametersCommand, Da as tryToParseNumber, Dn as useNodeHelpers, Dr as createCanvasConnectionHandleString, E as useNodeTypesStore, En as serializeNode, Gn as DEFAULT_NODE_SIZE, In as MoveNodeCommand, Jt as useTagsStore, Kn as DEFAULT_VIEWPORT_BOUNDARIES, Kt as useWorkflowHelpers, Ln as RemoveConnectionCommand, Mn as AddNodeCommand, Mr as mapLegacyConnectionToCanvasConnection, Nr as mapLegacyConnectionsToCanvasConnections, On as useCanvasStore, Pr as parseCanvasConnectionHandleString, Rn as RemoveNodeCommand, Sa as isPresent, Un as CONFIGURABLE_NODE_SIZE, Wn as CONFIGURATION_NODE_SIZE, Xn as generateOffsets, Yn as doRectsOverlap, Yt as ensureNodePosition, Zt as sanitizeConnections, ai as CanvasNodeRenderType, ci as pinDataToExecutionData, fn as usePostHog, hn as useNDVStore, jn as AddConnectionCommand, jr as mapCanvasConnectionToLegacyConnection, kt as useDataSchema, ln as useTelemetry, qn as PUSH_NODES_OFFSET, r as useUIStore, ri as CanvasConnectionMode, rr as getNodesGroupSize, s as useWorkflowsStore, sn as useProjectsStore, tr as getNewNodePosition, vn as injectWorkflowDocumentStore, x as getExecutionErrorToastConfiguration, yt as useCredentialsStore, zn as RenameNodeCommand } from "./users.store-g_JotOI6.js";
import { t as useToast } from "./useToast-Cj673zB7.js";
import { Gs as isObjectEmpty, Hl as NDV_IN_FOCUS_PANEL_EXPERIMENT, Lc as v4, No as require_cloneDeep, Ol as CANVAS_ZOOMED_VIEW_EXPERIMENT, Pt as CHAT_TRIGGER_NODE_TYPE, Ql as EnterpriseEditionFeature, Us as deepCopy, Vo as require__baseUniq, Ws as isCommunityPackageName, _s as getSubworkflowId, bn as MANUAL_CHAT_TRIGGER_NODE_TYPE, da as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, ds as getNodeOutputs, fa as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, fr as UPDATE_WEBHOOK_ID_NODE_TYPES, fs as getNodeParameters, ii as VIEWS, ks as resolveNodeWebhookId, lc as NodeConnectionTypes, ls as getConnectionTypes, ma as LOCAL_STORAGE_LOGS_SYNC_SELECTION, or as STICKY_NODE_TYPE, os as generateNodesGraph, pa as LOCAL_STORAGE_LOGS_PANEL_OPEN, us as getNodeInputs, xs as isHitlToolType } from "./constants-D4XflMq_.js";
import { T as defineStore, t as useRootStore } from "./useRootStore-CDKkkplG.js";
...
import { t as VueMarkdown } from "./VueMarkdown-CYxpnJwW.js";
import { t as useSetupPanelStore } from "./setupPanel.store-C2Sw57xf.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-BC1YADQS.js";
