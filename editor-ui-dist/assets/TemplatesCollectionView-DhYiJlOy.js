import { d as defineComponent, bo as useTemplatesStore, ae as useNodeTypesStore, a3 as useRoute, b as useRouter, ay as useDocumentTitle, r as ref, x as computed, a8 as watch, o as onMounted, e as createBlock, g as openBlock, bv as createSlots, w as withCtx, j as createBaseVNode, n as normalizeClass, h as createElementBlock, f as createCommentVNode, i as createVNode, l as unref, eQ as isFullTemplatesCollection, eR as N8nMarkdown, c as useI18n, m as N8nHeading, k as createTextVNode, t as toDisplayString, p as N8nText, dS as N8nLoading, V as VIEWS, am as useTelemetry, bt as useExternalHooks, _ as _export_sfc } from "./index-BXVCKjk6.js";
import { _ as __unplugin_components_6 } from "./TemplateDetails-cKnEltiu.js";
import { T as TemplateList } from "./TemplateList-DWi7ePZI.js";
import { T as TemplatesView } from "./TemplatesView-BgFzVBOw.js";
import { u as useTemplateWorkflow } from "./templateActions-Bl2a1-C5.js";
import "./Tags-DbYVCf8q.js";
        ...
        header: withCtx(() => [
          !notFoundError.value ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              ...
              collection.value && collection.value.name ? (openBlock(), createBlock(_component_N8nHeading, {
                key: 0,
                tag: "h1",
                size: "2xlarge"
              }, {
              ...
              collection.value && collection.value.name ? (openBlock(), createBlock(_component_N8nText, {
                key: 1,
                color: "text-base",
                size: "small"
              }, {
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", {
                ...
                loading.value || unref(isFullTemplatesCollection)(collection.value) ? (openBlock(), createElementBlock("div", {
                  ...
                  createVNode(_component_N8nMarkdown, {
