...
import { at as useI18n$1, c as useClipboard, v as useLocalStorage } from "./core-CiwaTfw5.js";
import { Ni as require_markdown_it_link_attributes, lt as useRoute, ut as useRouter } from "./src-DpBG5nOa.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { $n as DEFAULT_VIEWPORT_BOUNDARIES, $t as createWorkflowDocumentId, An as isValidNodeConnectionType, Fr as pinDataToExecutionData, Gn as RemoveNodeCommand, Gt as useProjectsStore, In as CanvasNodeRenderType, Kn as RenameNodeCommand, Ln as useHistoryStore, Mt as useWorkflowHelpers, Pn as CanvasConnectionMode, Pt as useTagsStore, Qn as DEFAULT_NODE_SIZE, Qt as useNDVStore, Rn as AddConnectionCommand, Un as MoveNodeCommand, Wn as RemoveConnectionCommand, Xn as CONFIGURABLE_NODE_SIZE, Xt as usePostHog, Yi as isPresent, Zn as CONFIGURATION_NODE_SIZE, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, cr as getNewNodePosition, d as isChatNode, dn as useCanvasStore, ea as tryToParseNumber, er as PUSH_NODES_OFFSET, ht as useDataSchema, ln as serializeNode, nn as useWorkflowDocumentStore, nr as doRectsOverlap, qn as ReplaceNodeParametersCommand, qt as useTelemetry, r as useUIStore, rr as generateOffsets, s as useWorkflowsStore, un as useNodeHelpers, ur as getNodesGroupSize, w as useNodeTypesStore, z as removePreviewToken, zn as AddNodeCommand } from "./users.store-Bfu2rIUB.js";
import { t as useToast } from "./useToast-D9LVQNVI.js";
import { Bc as CANVAS_ZOOMED_VIEW_EXPERIMENT, Do as getNodeParameters, Eo as getNodeOutputs, Gi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Io as isHitlToolType, Ki as LOCAL_STORAGE_LOGS_PANEL_OPEN, Mo as getSubworkflowId, Qc as NDV_IN_FOCUS_PANEL_EXPERIMENT, To as getNodeInputs, Wi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Wo as resolveNodeWebhookId, Xa as require_cloneDeep, Xs as v4, ar as STICKY_NODE_TYPE, as as isCommunityPackageName, cl as EnterpriseEditionFeature, dr as UPDATE_WEBHOOK_ID_NODE_TYPES, io as require__baseUniq, is as deepCopy, qi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, wo as getConnectionTypes, ws as NodeConnectionTypes, xo as generateNodesGraph, zr as VIEWS } from "./constants-ixIyBnRU.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-cjngw5T-.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-Bvswp292.js";
...
var useExperimentalNdvStore = defineStore("experimentalNdv", () => {
	...
	function collapseAllNodes() {
		collapsedNodes.value = (workflowDocumentStore.value?.allNodes ?? []).reduce((acc, node) => {
			acc[node.id] = true;
			return acc;
		}, {});
	}
