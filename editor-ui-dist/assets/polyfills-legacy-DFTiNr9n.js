(function() {
	...
	var internalize = function(holder, name, reviver, node) {
		...
		return call$10(reviver, holder, name, val, context);
	};
	...
	var forEach$1 = uncurryThis$14(URLSearchParamsPrototype$1.forEach);
	var push$2 = uncurryThis$14([].push);
	...
	var require_function_uncurry_this_accessor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(object, key$1, method) {
			try {
				return uncurryThis$10(aCallable$2(Object.getOwnPropertyDescriptor(object, key$1)[method]));
			} catch (error) {}
		};
	}));
	...
	var DROP_WITHOUT_THROWING_ON_INVALID_ITERATOR = !IS_PURE$4 && !iteratorHelperThrowsOnInvalidIterator("drop", 0);
	var dropWithoutClosingOnEarlyError = !IS_PURE$4 && !DROP_WITHOUT_THROWING_ON_INVALID_ITERATOR && iteratorHelperWithoutClosingOnEarlyError("drop", RangeError);
	var FORCED = IS_PURE$4 || DROP_WITHOUT_THROWING_ON_INVALID_ITERATOR || dropWithoutClosingOnEarlyError;
