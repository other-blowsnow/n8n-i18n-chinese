(function() {
	...
	var dropWithoutClosingOnEarlyError = !IS_PURE$5 && !DROP_WITHOUT_THROWING_ON_INVALID_ITERATOR && iteratorHelperWithoutClosingOnEarlyError$1("drop", RangeError);
	...
	var IteratorProxy$1 = createIteratorProxy$1(function() {
		...
		while (this.remaining) {
			this.remaining--;
			result = anObject$5(call$6(next$1, iterator));
			done = this.done = !!result.done;
			if (done) return;
		}
		result = anObject$5(call$6(next$1, iterator));
	...
	$$13({
		...
		if (dropWithoutClosingOnEarlyError) return call$6(dropWithoutClosingOnEarlyError, this, remaining);
		return new IteratorProxy$1(getIteratorDirect$3(this), { remaining });
	} });
