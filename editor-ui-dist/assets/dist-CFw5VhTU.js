import { g as NANOID_ALPHABET } from "./useRootStore-Bad1y11b.js";
...
//#endregion
//#region ../../@n8n/utils/dist/generate-nano-id2.mjs
/**
...
//#endregion
//#region ../../@n8n/utils/dist/sanitize-filename.mjs
...
new RegExp(`"(?:${SECRET_KEYS})"\\s*:\\s*"(?!\\[(?:redacted|REDACTED)(?::[^"\\]]*)?\\]")(?:[^"\\\\\\r\\n]|\\\\.)*"`, "gi"), new RegExp(`'(?:${SECRET_KEYS})'\\s*:\\s*'(?!\\[(?:redacted|REDACTED)(?::[^'\\]]*)?\\]')(?:[^'\\\\\\r\\n]|\\\\.)*'`, "gi"), new RegExp(`(?<!\\[(?:redacted|REDACTED):)\\b(?:${SECRET_KEYS})\\s*[:=]\\s*\\S+`, "gi");
//#endregion
//#region ../../@n8n/utils/dist/is-record2.mjs
function isRecord(value) {
	return typeof value === "object" && value !== null && !Array.isArray(value);
}
//#endregion
export { isPlaceholderValue as a, truncateBeforeLast as c, formatPlaceholderPath as i, generateNanoId as l, extractPlaceholderLabels as n, sanitizeFilename as o, findPlaceholderDetails as r, truncate as s, isRecord as t, nanoid as u };
