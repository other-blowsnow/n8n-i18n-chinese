...
import { g as onClickOutside, gt as i18n, yt as useI18n } from "./_MapCache-DKnT_8zF.js";
...
import { A as getHumanInTheLoopActions, B as shouldShowCommunityNodeDetails, C as useNodeTypesStore, E as filterAndSearchNodes, L as prepareCommunityNodeDetailsViewStack, Mn as getNewNodePosition, Nt as useTelemetry, O as flattenCreateElements, P as isNodePreviewKey, R as removePreviewToken, U as transformNodeType, _a as COMMUNITY_NODES_INSTALLATION_DOCS_URL, j as getRootSearchCallouts, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, vr as useExternalHooks, w as useActionsGenerator, xn as DEFAULT_NODE_SIZE } from "./users.store-DLa4KoOQ.js";
import { Ba as isCommunityPackageName, Dt as REGULAR_NODE_CREATOR_VIEW, F as CUSTOM_API_CALL_KEY, Gn as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, Kn as OPEN_AI_NODE_TYPE, L as DRAG_EVENT_DATA_KEY, Ot as REQUEST_NODE_FORM_URL, Sr as WEBHOOK_NODE_TYPE, St as HUMAN_IN_THE_LOOP_CATEGORY, Xt as CREDENTIAL_ONLY_NODE_PREFIX, dt as AI_OTHERS_NODE_CREATOR_VIEW, jt as TRIGGER_NODE_CREATOR_VIEW, lt as AI_EVALUATION, mt as AI_UNCATEGORIZED_CATEGORY, ut as AI_NODE_CREATOR_VIEW, vt as DEFAULT_SUBCATEGORY, xt as HITL_SUBCATEGORY, yn as HTTP_REQUEST_NODE_TYPE } from "./constants-DnWvXsAO.js";
...
import { n as useNodeType } from "./usePinnedData-DdqAJLEe.js";
import { t as getNodeIconSource } from "./nodeIcon-CcHQxG6q.js";
import "./canvas.utils-CehoSnOc.js";
import { a as AIView, c as TriggerView, i as AINodesView, l as require_camelCase, n as useViewStacks, o as HitlToolView, r as useKeyboardNavigation, s as RegularView, t as useNodeCreatorStore } from "./nodeCreator.store--7aPJJwB.js";
import "./useCanvasOperations-CrPWj_YE.js";
import "./folders.store-Bumnlqzv.js";
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-BKYNcRuv.js";
import { t as NodeIcon_default } from "./NodeIcon-eodi0mi8.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-rdDg34Gm.js";
