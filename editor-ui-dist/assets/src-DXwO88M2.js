...
var zh_CN_default = {
	...
	"generic.datatable": "数据表 | {count} 个数据表 | {count} 个数据表",
	...
	"auth.defaultPasswordRequirements": "{minimum}+ 字符，至少包含 1 个数字和 1 个大写字母",
	...
	"aiAssistant.reducedHelp.chat.notice": "您的管理员已关闭向 AI 发送实际数据值。响应可能不太准确。",
	...
	"aiAssistant.builder.existingWorkflow.emptyState.title": "修改你的工作流",
	"aiAssistant.builder.existingWorkflow.emptyState.body": "请让 n8n AI 修改现有节点、添加新步骤、更新参数，或在工作流中帮助调试问题。",
	...
	"aiAssistant.builder.planMode.selector.plan.description": "先细化需求 · 免费",
	"aiAssistant.builder.planMode.questions.title": "几个简单的问题",
	...
	"aiAssistant.builder.planMode.questions.next": "下一步",
	...
	"aiAssistant.builder.planMode.questions.somethingElse": "别的东西",
	"aiAssistant.builder.planMode.questions.clarifyPlaceholder": "在此澄清……",
	"aiAssistant.builder.planMode.questions.paginationOf": "的",
	"aiAssistant.builder.planMode.answers.skipped": "已跳过",
	"aiAssistant.builder.planMode.plan.title": "拟议方案",
	"aiAssistant.builder.planMode.plan.triggerLabel": "触发器",
	"aiAssistant.builder.planMode.plan.stepsLabel": "步骤",
	"aiAssistant.builder.planMode.plan.notesLabel": "备注",
	"aiAssistant.builder.planMode.plan.feedbackLabel": "反馈（可选）",
	"aiAssistant.builder.planMode.plan.feedbackPlaceholder": "请描述您想要更改的内容。",
	"aiAssistant.builder.planMode.actions.submitAnswers": "提交答案",
	"aiAssistant.builder.planMode.actions.implement": "执行计划",
	"aiAssistant.builder.planMode.actions.modify": "请求修改",
	"aiAssistant.builder.planMode.actions.modifyWithFeedback": "请求修改：{feedback}",
	"aiAssistant.builder.planMode.answers.noAnswer": "未提供答案",
	"aiAssistant.builder.planMode.actions.reject": "否决该计划",
	"aiAssistant.builder.planMode.actions.rejectWithFeedback": "拒绝该计划：{feedback}",
	"aiAssistant.builder.webFetch.prompt": "n8n AI 想要获取内容",
	"aiAssistant.builder.webFetch.allowOnce": "仅此一次",
	...
	"aiAssistant.builder.collapsedMessages.thinking": "思考中",
	...
	"aiAssistant.builder.reviewChanges.previousVersion": "上一个版本",
	"aiAssistant.builder.reviewChanges.currentVersion": "当前版本",
	"aiAssistant.builder.reviewChanges.error": "无法加载工作流的先前版本。版本历史可能不再可用。",
	"aiAssistant.versionCard.version": "版本",
	"aiAssistant.versionCard.versionNumber": "版本 #{number}",
	"aiAssistant.versionCard.menu.openDiff": "打开差异",
	...
	"aiAssistant.builder.credentialHelpMessage": "如何为 {credentialName} 设置凭据？",
	"aiAssistant.builder.errorHelpMessage": "我在“{nodeName}”节点上遇到了一个错误：{errorMessage}",
	"aiAssistant.builder.streamAbortedMessage": "任务被中止",
	"aiAssistant.builder.executeMessage.description": "请按照以下步骤完成您的工作流。",
	"aiAssistant.builder.executeMessage.noIssues": "您的工作流已准备好执行。",
	"aiAssistant.builder.executeMessage.noIssuesWithPinData": "您的工作流已设置了测试数据（固定数据）供您执行。取消固定节点以使用您自己的数据执行。",
	...
	"aiAssistant.builder.executeMessage.unpinAll": "取消固定所有节点",
	"aiAssistant.builder.executeMessage.unpinIndividually": "或逐个取消固定",
	"aiAssistant.builder.executeMessage.unpinTooltip": "在节点上右键单击，然后选择“取消固定”以取消固定该节点。",
	"aiAssistant.builder.followUps.title": "跟进事项",
	...
	"aiAssistant.builder.followUps.executeAndRefine": "执行并改进",
	"aiAssistant.builder.followUps.executeWithConfiguredData": "使用我配置的数据执行",
	"aiAssistant.builder.executeMessage.wizardSetupSuccess": "工作流已成功设置",
	"aiAssistant.builder.setupWizard.continue": "继续",
	"aiAssistant.builder.setupWizard.complete": "完成",
	"aiAssistant.builder.setupWizard.checkingCredentials": "正在验证凭据",
	...
	"aiAssistant.builder.thinkingCompletionMessage.codeBuilder": "构建工作流",
	...
	"aiAssistant.builder.settings.creditsLeft": "还剩 {count}",
	"aiAssistant.builder.settings.getMoreCredits": "获取更多积分",
	"aiAssistant.builder.settings.creditsTooltip": "一个积分等于一条消息。积分将于 {renewalDate} 续期。未使用的积分将在 {expiryDate} 过期。",
	"aiAssistant.builder.creditBanner.text": "{remaining}/{total} 本月剩余信用额度",
	"aiAssistant.builder.creditBanner.getMore": "获取更多",
	"aiAssistant.builder.upgradeWhileStreaming.title": "AI Builder 仍在工作中",
	"aiAssistant.builder.upgradeWhileStreaming.message": "AI Builder 目前正在生成您的工作流。离开此页面将停止生成。",
	...
	"nodeCreator.shortcutCoachmark.body": "我们更改了快捷键以改善键盘导航",
	"nodeCreator.shortcutCoachmark.gotIt": "明白了",
	...
	"chat.window.chat.placeholder": "输入消息，或按“上”键查看上一条",
	...
	"chatHub.agent.editor.systemPrompt.placeholder": "请输入说明（可选）",
	...
	"chatHub.agent.editor.files.tooLarge": "文件 \"{fileName}\" 太大。最大文件大小为 {maxSizeMb} MB。",
	"chatHub.agent.editor.files.createdAt": "添加于 {date}",
	"chatHub.agent.editor.files.indexing": "正在准备...",
	...
	"chatHub.agent.editor.files.embeddingMismatch.tooltip": "该文件使用 {fileProvider} 嵌入模型进行了索引。由于当前嵌入模型为 {currentProvider}，因此可能无法被搜索。",
	"chatHub.agent.editor.files.semanticSearchNotReady.tooltip": "语义搜索尚未配置。此文件可能无法被搜索。",
	...
	"chatHub.agent.editor.success.withFiles": "上传的文件可能需要几分钟，才能在代理的回复中体现出来。",
	"chatHub.agent.editor.success.delete": "代理已成功删除",
	"chatHub.agent.editor.dropOverlay.addFile": "将文件添加到代理",
	"chatHub.agent.editor.dropOverlay.unsupportedFileType": "不支持此文件类型。仅接受 PDF 文件。",
	"chatHub.agent.editor.semanticSearch.notReady": "要上传 PDF 文档，请联系您的实例所有者，在 {settingsLink} 中配置语义搜索。",
	"chatHub.agent.editor.semanticSearch.notReady.canConfigure": "要上传 PDF 文档，请在 {settingsLink} 配置语义搜索。",
	"chatHub.agent.editor.semanticSearch.settingsLink": "聊天设置",
	"chatHub.agent.editor.suggestedPrompts.label": "建议",
	"chatHub.agent.editor.suggestedPrompts.tooltip": "这些在与该代理开始新对话时显示为可点击的提示。",
	"chatHub.agent.editor.suggestedPrompts.placeholder": "输入一个建议的提示语",
	"chatHub.agent.editor.suggestedPrompts.addButton": "添加提示",
	...
	"chatHub.chat.header.button.manageConnections": "管理连接",
	...
	"chatHub.chat.prompt.callout.dynamicCredentials.expired": "连接已过期。请重新连接缺失的账户以继续。",
	"chatHub.chat.prompt.callout.dynamicCredentials.expired.button": "连接",
	"chatHub.dynamicCredentials.drawer.title": "凭据",
	"chatHub.dynamicCredentials.drawer.subtitle": "所需的连接",
	"chatHub.dynamicCredentials.drawer.description": "此工作流将访问下方的账户以完成您的请求。您可以随时对它们进行管理或断开连接。",
	...
	"chatHub.chat.attachments.unsupported.title": "有些文件无法上传",
	"chatHub.chat.attachments.unsupported.toast": "{fileName} 不是受支持的文件类型，且未被附上。",
	...
	"chatHub.tools.selector.disabled.noModel.tooltip": "选择要用于工具的模型",
	...
	"chatHub.toolsManager.remove": "删除",
	"chatHub.toolsManager.configure": "配置",
	"chatHub.toolsManager.manageTools": "管理工具",
	"chatHub.toolsManager.enableTool": "启用工具",
	"chatHub.toolsManager.confirmRemove.message": "您确定要删除此工具吗？它也会从您所有使用该工具的对话和个人代理中被移除。",
	...
	"credentialEdit.credentialConfig.accountNotConnected": "连接您的账户以使用此凭证",
	"credentialEdit.credentialConfig.connect": "连接",
	"credentialEdit.credentialConfig.connectOAuth2Credential": "连接 OAuth2 凭据",
	...
	"credentialEdit.credentialConfig.jwksUri.label": "OAuth2 JWKS 统一资源标识符",
	"credentialEdit.credentialConfig.jwksUri.hint": "将此 URL 提供给你的 OAuth2 提供者，以便它能够获取此实例用于加密令牌的公钥。",
	"credentialEdit.credentialConfig.jwksUri.copiedToast": "JWKS URI 已复制到剪贴板",
	...
	"credentialEdit.credentialConfig.oauthModeCustom": "自定义 OAuth 2.0",
	"credentialEdit.credentialConfig.setupCredential": "设置凭据",
	"credentialEdit.credentialConfig.quickConnect": "使用快速连接",
	"credentialEdit.credentialConfig.quickConnectTitle": "连接以配置凭据",
	...
	"credentialEdit.credentialConfig.oauthDisabledTooltip": "填写所有字段以连接",
	...
	"credentialEdit.credentialSharing.info.personalSpaceRestricted": "在个人空间中不允许共享。请将凭据移动到团队项目以进行共享。",
	...
	"experiments.instanceAiProactiveAgent.message": "嗨，我几分钟就能帮你构建你的第一个工作流。你知道自己想自动化什么，还是需要一些点子来帮助你？",
	"experiments.instanceAiProactiveAgent.typingLabel": "AI助手正在输入",
	"experiments.instanceAiPromptSuggestionsV2.emptyState.title": "你想要自动化什么？",
	"experiments.instanceAiPromptSuggestionsV2.input.placeholder": "告诉我该做什么，或者问我一个问题。",
	"experiments.instanceAiPromptSuggestionsV2.nextSuggestions": "显示更多提示建议",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.processInvoices.label": "处理发票",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.processInvoices.prompt": "每天早晨，扫描 Gmail 中的新发票，使用 Claude 提取明细并将其与 Google Sheets 中的采购订单进行核对，如发现差异则标记以供审核，并将所有应付款日期自动添加到 Google 日历。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.qualifyInboundLeads.label": "对入站潜在客户进行资格评估",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.qualifyInboundLeads.prompt": "当有新潜在客户填写我们的联系表单时，使用 Claude 对他们的公司进行在线研究，基于规模、行业和意向对其匹配度进行评分，撰写个性化的首次联系回复，并根据地区和产品兴趣将其分配给 HubSpot 中的合适销售代表。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.whatsappSupportAgent.label": "WhatsApp 客服代表",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.whatsappSupportAgent.prompt": "当客户发送 WhatsApp 消息时，使用 Claude 将他们的问题与我们在 Google 表格中的 FAQ 进行匹配，并立即回复。如果无法解决，请在 Notion 中创建一个支持工单，并在 Slack 上通知团队。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.scheduleSocialPosts.label": "排程社交媒体发文",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.scheduleSocialPosts.prompt": "每周一，从 Google 表格读取本周的内容创意，使用 Claude 为 LinkedIn、Instagram 和 X 撰写定制文案，然后将它们安排在整周内发布。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.analyzeExitInterviews.label": "分析离职面谈",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.analyzeExitInterviews.prompt": "当离职访谈的转录文本被添加到 Google Drive 时，使用 Gemini 提取主题与情感，将其与存储在 Notion 中的以往离职记录进行比较，并更新一个持续的趋势报告，标注反复出现的留任风险。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.postToLinkedIn.label": "发布到 LinkedIn",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.postToLinkedIn.prompt": "每次我发布一篇新博客文章时，使用 OpenAI 生成一篇 LinkedIn 帖子，包含一个钩子、三个关键要点，以及相关的标签，然后自动将其发布到我的 LinkedIn 公司页面。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.detectAtRiskAccounts.label": "检测高风险账户",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.detectAtRiskAccounts.prompt": "每周为每位活跃客户扫描电子邮件和支持工单，使用 Claude 根据语气和参与度下降来检测高风险账户，对每一个被标记的账户起草主动联系邮件，并在 Slack 上通知客户成功经理。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.automateOrderFlow.label": "自动化订单流程",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.automateOrderFlow.prompt": "当在 Shopify 下新订单时，向客户发送确认电子邮件，在 Google Sheets 更新库存数量，并将摘要发布到 #fulfillment Slack 频道。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.recoverAbandonedCarts.label": "找回已放弃的购物车",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.recoverAbandonedCarts.prompt": "每小时检查 Shopify 中的放弃购物车，使用 Claude 根据购物车内容和客户历史撰写个性化的找回邮件，并在两小时内未返回时自动发送。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.monitorMarketNews.label": "监控市场新闻",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.monitorMarketNews.prompt": "每周，使用 Gemini 扫描金融新闻，关注与我们关键供应商和客户相关的报道，评估潜在的业务影响，并在本周交易前向我发送一份简报，列出我应采取行动的任何风险或机会。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.onboardNewHires.label": "新员工入职",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.onboardNewHires.prompt": "当新员工被添加到我们的人力资源数据库时，向他们发送一封包含第一周日程的欢迎邮件，创建他们的 Notion 入职页面，并在 Slack 的 #welcome 频道中发布自我介绍消息。",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.extractDataFromEmails.label": "从电子邮件中提取数据",
	"experiments.instanceAiPromptSuggestionsV2.suggestions.extractDataFromEmails.prompt": "当 Gmail 收到带有 PDF 附件的邮件时，使用 Gemini 提取关键数据（例如金额、日期或合同条款），将结构化数据保存到 Google 表格中，并将 PDF 移动到相应的 Google Drive 文件夹。",
	...
	"experiments.resourceCenter.badge.readyToRun": "准备就绪",
	"experiments.resourceCenter.badge.template": "模板",
	"experiments.resourceCenter.badge.video": "视频",
	"experiments.resourceCenter.cta.runWorkflow": "运行工作流",
	...
	"experiments.resourceCenter.search.noResults": "未找到结果",
	"experiments.resourceCenter.search.placeholder": "搜索模板和指南…",
	...
	"executionsList.viewMode.workflows": "工作流程",
	"executionsList.viewMode.agents": "代理",
	"agentSessions.session": "会话",
	"agentSessions.agentName": "代理",
	"agentSessions.sessionName": "会话",
	"agentSessions.lastMessage": "最后一条消息",
	"agentSessions.tokenUsage": "令牌使用情况",
	"agentSessions.testChat": "测试聊天",
	"agentSessions.actions": "操作",
	"agentSessions.empty": "没有代理会话",
	"agentSessions.loadMore": "加载更多",
	"agentSessions.deleteConfirm.headline": "删除会话？",
	"agentSessions.deleteConfirm.message": "这将删除该会话及其所有执行记录。此操作无法撤销。",
	"agentSessions.deleteConfirm.confirmButtonText": "是的，删除。",
	"agentSessions.showMessage.deleted": "会话已删除",
	"agentSessions.showError.delete": "删除会话时出错",
	"agentSessions.showError.load": "加载会话时出错",
	"agentSessions.status": "状态",
	"agentSessions.duration": "持续时间",
	"agentSessions.sessionId": "会话ID",
	"agentSessions.success": "成功",
	"agentSessions.detail.backToSessions": "返回会话列表",
	"agentSessions.detail.selectMessage": "点击助手消息以查看详情",
	"agentSessions.detail.tokenUsage": "令牌使用情况",
	"agentSessions.detail.input": "输入",
	"agentSessions.detail.output": "输出",
	"agentSessions.detail.toolCalls": "工具调用",
	"agentSessions.detail.model": "模型",
	"agentSessions.detail.cost": "成本",
	"agentSessions.detail.toolCallSuspended": "工具调用已挂起——等待用户操作",
	"agentSessions.detail.suspendedNote": "此消息是工具调用暂停的一部分。令牌使用量和成本将在恢复的消息中报告。",
	"agentSessions.detail.builtInTools": "内置",
	"agentSessions.detail.userTools": "工具",
	"agentSessions.detail.richInteraction.userResponse": "用户已回复",
	"agentSessions.drawer.created": "已创建",
	"agentSessions.drawer.lastMessage": "最后一条消息",
	"agentSessions.drawer.duration": "持续时间",
	"agentSessions.drawer.tokens": "令牌",
	"agentSessions.drawer.cost": "成本",
	"agentSessions.drawer.status": "状态",
	"agentSessions.drawer.noTitle": "会话 #{number}",
	"agentSessions.timeline.backToAgent": "返回人工客服",
	"agentSessions.timeline.user": "用户",
	"agentSessions.timeline.assistant": "助手",
	"agentSessions.timeline.tool": "工具",
	"agentSessions.timeline.memory": "内存",
	"agentSessions.timeline.suspension": "工具调用已暂停",
	"agentSessions.timeline.success": "成功",
	"agentSessions.timeline.error": "错误",
	"agentSessions.timeline.id": "标识符",
	"agentSessions.timeline.created": "已创建",
	"agentSessions.timeline.duration": "持续时间",
	"agentSessions.timeline.status": "状态",
	"agentSessions.timeline.input": "输入",
	"agentSessions.timeline.output": "输出",
	"agentSessions.timeline.selectItem": "选择一个项目以查看详细信息",
	"agentSessions.timeline.continueChat": "继续聊天",
	"agentSessions.timeline.workflow": "工作流",
	"agentSessions.timeline.node": "节点",
	"agentSessions.timeline.memoryUpdated": "内存已更新",
	"agentSessions.timeline.openForm": "打开表单",
	"agentSessions.timeline.workflowError": "工作流调用未产生执行",
	"agentSessions.timeline.nodeError": "工具遇到了一个错误。",
	"agentSessions.timeline.filter": "筛选",
	"agentSessions.timeline.clearFilter": "清除",
	"agentSessions.timeline.suspended": "已暂停",
	"agentSessions.timeline.idle": "空闲",
	"agentSessions.timeline.agent": "代理",
	"agentSessions.timeline.tool.richInteraction": "已向用户请求反馈",
	"agentSessions.timeline.tool.richInteractionDisplay": "卡片已发送给用户",
	"agentSessions.timeline.waitingForUser": "等待用户回应",
	"agentSessions.timeline.events": "事件",
	"agentSessions.timeline.searchPlaceholder": "搜索",
	"agentSessions.timeline.triggeredVia": "通过 {source} 触发",
	"agentSessions.workflowLog.loading": "正在加载执行...",
	"agentSessions.workflowLog.stillRunning": "仍在运行中",
	"agentSessions.workflowLog.waiting": "等待中",
	"agentSessions.workflowLog.unavailable": "执行数据不可用",
	"agentSessions.workflowLog.openFull": "打开完整执行",
	"agentView.tab.editor": "编辑器",
	"agentView.tab.sessions": "会话",
	...
	"executionsFilter.version.hint": "按它们所运行的工作流版本筛选执行记录。",
	"executionsFilter.version.noVersions": "没有可用于此工作流执行的版本数据。",
	"executionsFilter.version.label": "{name} {date}",
	...
	"readOnlyEnv.instanceAi.notice": "这是一个受保护的实例。某些操作（如创建或修改工作流）受到限制。",
	...
	"logs.details.header.actions.viewAgentSession": "查看会话",
	...
	"mainSidebar.showMessage.handleArchive.message": "永久删除",
	...
	"ndv.execute.upstreamNodeHasIssues": "前一个节点缺少必填字段",
	...
	"ndv.input.redacted.title": "输入数据已脱敏",
	"ndv.output.redacted.title": "输出数据已被遮蔽",
	"ndv.redacted.description.sentence1": "执行数据已被编辑。",
	"ndv.redacted.description.sentence2": "在 {link} 中调整编辑规则。",
	"ndv.redacted.description.link": "工作流设置",
	"ndv.redacted.noPermission.description": "执行数据已被隐藏。您无权披露它。",
	"ndv.redacted.dynamicCredentials.description": "此次执行使用了动态凭据。来自动态凭据执行的数据无法披露。",
	"ndv.redacted.revealButton": "显示数据",
	"ndv.redacted.revealModal.title": "显示已遮蔽的数据",
	"ndv.redacted.revealModal.warning": "这些数据已被遮蔽，因为它们可能包含敏感信息。在继续之前，请阅读以下内容。",
	"ndv.redacted.revealModal.logged": "此操作将被记录",
	"ndv.redacted.revealModal.legitimate": "如果您有正当理由，请披露这些数据。",
	"ndv.redacted.revealModal.policy": "不必要的访问可能违反贵组织的政策。",
	"ndv.redacted.revealModal.confirmButton": "显示数据",
	"ndv.redacted.revealError": "无法显示执行数据",
	"ndv.redacted.error.title": "该节点遇到了错误",
	"ndv.redacted.error.description": "错误详情已被编辑，因为执行数据包含敏感信息。",
	"ndv.output": "输出",
	...
	"sticky.markdownHint": "<a target=\"_blank\" href=\"https://docs.n8n.io/workflows/sticky-notes/\">Markdown</a> 支持",
	...
	"nodeCreator.subcategoryDescriptions.modelContextProtocol": "从外部 MCP 服务器添加工具集",
	...
	"nodeCreator.subcategoryNames.modelContextProtocol": "MCP 服务器",
	...
	"nodeCredentials.credentialsLabelShort": "凭据",
	...
	"nodeCredentials.quickConnect.or": "或",
	...
	"nodeCredentials.quickConnect.credential.created.success": "凭据创建成功",
	"nodeCredentials.quickConnect.credential.created.error": "凭据创建失败",
	"nodeCredentials.emptyState.noCredentials": "尚无凭据",
	"nodeCredentials.emptyState.setupCredential": "设置凭据",
	"nodeCredentials.oauth.accountConnected": "账户已成功连接",
	"aiGateway.toggle.label": "通过 n8n Connect 连接",
	"aiGateway.toggle.description": "n8n Connect 是管理 AI 模型使用的简便方式",
	"aiGateway.toggle.topUp": "充值",
	"aiGateway.wallet.balanceRemaining": "剩余 {balance}",
	"aiGateway.wallet.noCredits": "没有积分",
	"aiGateway.credentialMode.sectionLabel": "凭据",
	"aiGateway.credentialMode.n8nConnect.title": "n8n 连接",
	"aiGateway.credentialMode.n8nConnect.subtitle": "不需要 API 密钥",
	"aiGateway.credentialMode.own.title": "我自己的凭据",
	"aiGateway.credentialMode.own.subtitle": "使用你自己的 API 密钥",
	"aiGateway.unsupportedAction.notice": "{actionName} 目前在 n8n Connect 中不受支持。请改用您自己的凭证来使用它。",
	...
	"nodeSettings.customTelemetryTags.displayName": "自定义遥测标签",
	"nodeSettings.customTelemetryTags.description": "添加自定义标签，这些标签将附加到此节点的 OpenTelemetry 跨度上。值支持表达式。",
	"nodeSettings.customTelemetryTags.placeholder": "添加标签",
	"nodeSettings.customTelemetryTags.tag.displayName": "标签",
	"nodeSettings.customTelemetryTags.tag.key.displayName": "键",
	"nodeSettings.customTelemetryTags.tag.value.displayName": "值",
	...
	"nodeView.showError.importWorkflowData.invalidNodes": "跳过 {count} 个节点，缺少类型",
	...
	"contextMenu.focusAiOnSelected": "添加到 n8n AI | 将 {count} 个节点添加到 n8n AI",
	...
	"openWorkflow.workflowDataInvalidError": "工作流数据无效",
	...
	"oauth.consentView.action.executionDetails": "获取特定工作流执行的详细信息",
	"oauth.consentView.action.createUpdateWorkflows": "代表您创建和更新工作流。",
	"oauth.consentView.action.createDataTables": "为您创建和更新数据表",
	"oauth.consentView.action.searchProjectsAndFolders": "搜索项目和文件夹",
	...
	"pushConnection.nodeNotExecuted.message": "执行路径不同，未到达此节点。这通常发生在像 If 或 Switch 这样的条件节点上。",
	...
	"projectRoles.paywall.description": "升级到企业版以解锁项目角色。它将允许创建自定义、粒度更细的权限，让您能够对每个项目的访问权限进行精细调控。",
	...
	"projectRoles.workflow:export": "导出",
	"projectRoles.workflow:export.tooltip": "在包导出中包含工作流",
	"projectRoles.workflow:execute": "执行",
	"projectRoles.workflow:execute.tooltip": "在项目中执行工作流",
	...
	"projectRoles.workflow:unpublish": "取消发布",
	"projectRoles.workflow:unpublish.tooltip": "取消已发布的工作流",
	"projectRoles.workflow:enableRedaction": "启用数据脱敏",
	"projectRoles.workflow:enableRedaction.tooltip": "允许在项目中为工作流启用数据脱敏",
	"projectRoles.workflow:disableRedaction": "禁用数据脱敏",
	"projectRoles.workflow:disableRedaction.tooltip": "允许在项目中的工作流禁用数据编辑",
	"projectRoles.agent:create": "创建",
	"projectRoles.agent:create.tooltip": "创建新的代理",
	"projectRoles.agent:read": "查看",
	"projectRoles.agent:read.tooltip": "查看项目中的代理",
	"projectRoles.agent:execute": "执行",
	"projectRoles.agent:execute.tooltip": "在项目中执行代理",
	"projectRoles.agent:update": "编辑",
	"projectRoles.agent:update.tooltip": "编辑代理",
	"projectRoles.agent:delete": "删除",
	"projectRoles.agent:delete.tooltip": "删除代理",
	"projectRoles.agent:list": "列表",
	"projectRoles.agent:list.tooltip": "在项目中列出代理",
	"projectRoles.agent:publish": "发布",
	"projectRoles.agent:publish.tooltip": "发布代理",
	"projectRoles.agent:unpublish": "取消发布",
	"projectRoles.agent:unpublish.tooltip": "取消发布代理",
	...
	"projectRoles.credential:unshare": "取消分享",
	"projectRoles.credential:unshare.tooltip": "取消与其他项目或用户共享凭据",
	...
	"projectRoles.execution:reveal": "揭示被涂改的数据",
	"projectRoles.execution:reveal.tooltip": "在启用数据脱敏的工作流中显示被遮蔽的执行数据。",
	...
	"projectRoles.backToProjectSettings": "返回项目设置",
	...
	"projectRoles.type.agent": "代理",
	"projectRoles.type.credential": "凭据",
	"projectRoles.type.execution": "执行记录",
	"projectRoles.type.sourceControl": "源代码管理",
	"projectRoles.type.dataTable": "数据表格",
	"projectRoles.type.projectVariable": "项目变量",
	"projectRoles.type.externalSecretsProvider": "机密库",
	"projectRoles.type.externalSecret": "机密",
	"projectRoles.externalSecretsProvider:read": "查看",
	"projectRoles.externalSecretsProvider:read.tooltip": "查看机密库连接并查看可用的机密名称",
	"projectRoles.externalSecretsProvider:create": "创建",
	"projectRoles.externalSecretsProvider:create.tooltip": "向项目添加新的机密库连接。",
	"projectRoles.externalSecretsProvider:update": "编辑",
	"projectRoles.externalSecretsProvider:update.tooltip": "编辑机密库的连接设置",
	"projectRoles.externalSecretsProvider:delete": "删除",
	"projectRoles.externalSecretsProvider:delete.tooltip": "从项目中移除密钥库连接",
	"projectRoles.externalSecretsProvider:sync": "同步",
	"projectRoles.externalSecretsProvider:sync.tooltip": "手动触发同步以从提供者刷新凭据",
	"projectRoles.externalSecret:list": "列表",
	"projectRoles.externalSecret:list.tooltip": "列出已连接的密钥库中可用的密钥名称",
	...
	"projectRoles.action.delete.useWarning.before": "在它被分配时，你不能删除这个角色。",
	"projectRoles.action.delete.useWarning.linkText": "{count} 个项目 | {count} 个项目",
	"projectRoles.action.delete.useWarning.after": "要删除它，先将项目中的用户重新分配到不同的角色。",
	...
	"projectRoles.tab.assignments": "任务分配",
	"projectRoles.sourceControl.table.projectsAssigned": "已分配的项目",
	"projectRoles.assignments.emptyState": "此角色尚未分配到任何项目。",
	"projectRoles.assignments.projectColumn": "项目",
	"projectRoles.assignments.membersColumn": "已分配成员",
	"projectRoles.assignments.lastAssignedColumn": "最后分配的",
	...
	"runData.trimmedData.corrupted": "此节点的固定数据已损坏，无法显示。",
	"runData.trimmedData.unpin": "取消固定数据",
	...
	"settings.communityNodes.managedByEnv": "社区软件包通过环境变量进行管理，无法通过用户界面修改。",
	...
	"settings.mcp": "MCP 访问",
	"settings.mcp.description": "将像 Claude Code 和 Cursor 这样的 MCP 客户端连接到您的实例，以构建、运行和迭代工作流。",
	"settings.mcp.preview.tooltip": "此功能处于预览阶段。请期待随时间的推移所带来的改进和变动。",
	"settings.mcp.header.toggle.enabled": "已启用",
	"settings.mcp.header.toggle.disabled": "已禁用",
	"settings.mcp.actionBox.heading": "连接 AI 助手以构建和运行工作流",
	...
	"settings.mcp.instanceCapacity.warning": "MCP 客户端注册已达到实例上限（{count}/{limit}）。新的 OAuth 连接将被拒绝，直到撤销客户端或提高 N8N_MCP_MAX_REGISTERED_CLIENTS 的值。",
	...
	"settings.mcp.managedByEnv.tooltip": "通过环境变量管理",
	...
	"experiments.surfaceMcpToNewCloudUsers.onboarding.title": "从你的助手构建",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.description": "将像 Claude Code 和 Cursor 这样的 MCP 客户端连接到您的实例，以构建、运行和迭代工作流",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.client.claude": "克洛德",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.client.claudeCode": "Claude 代码",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.client.cursor": "光标",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.client.codex": "Codex",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.client.chatgpt": "ChatGPT",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.intro.eyebrow": "新建 · 模型上下文协议",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.intro.title": "尝试将 MCP 与 Claude Code、Cursor 或 Codex 搭配使用",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.intro.description": "将 Claude Code 与 Cursor 等 MCP 客户端连接到你的实例，以构建、运行和迭代工作流。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.intro.settingsHint": "现在就设置，或稍后在 {settingsLink} 中进行设置。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.intro.settingsLink": "设置 > 实例级 MCP",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.intro.tryIt": "尝试 MCP",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.intro.skip": "暂时跳过",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.prompt.claude": "请向我展示 n8n 的 MCP 连接器，并在尚未开启时带我逐步完成启用它的过程。等你告诉我服务器 URL 放在哪儿时，我会把我的服务器 URL 粘贴上来。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.prompt.claudeCode": "为 Claude Code 设置 n8n MCP 服务器，使其在所有项目中可用。\n\n1. 通过以下命令在用户作用域注册服务器：\n\n   claude mcp add --scope user --transport http n8n \"{serverUrl}\"\n\n2. 一旦注册，请提醒我重新启动 Claude Code——我将在新会话中完成 n8n 的 OAuth 流程，因此在被提示之前不要尝试列出或调用它的工具。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.prompt.cursor": "为 Cursor 的所有项目设置 n8n MCP 服务器。\n\n1. 打开 ~/.cursor/mcp.json（如果不存在，请创建该文件及目录）。将下列条目添加进去，并与现有配置合并，以便其他服务器保持不变：\n\n{'{'}\n  \"mcpServers\": {'{'}\n    \"n8n\": {'{'}\n      \"url\": \"{serverUrl}\"\n    {'}'}\n  {'}'}\n{'}'}\n\n2. 保存后，当它提示我时，请提醒我重新启动 Cursor 并完成 n8n 的 OAuth 流程——在此之前服务器的工具将不可用。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.prompt.codex": "为 Codex 在所有项目中设置 n8n MCP 服务器。\n\n1. 打开 ~/.codex/config.toml（若文件及目录不存在，请创建）。追加以下部分，保持现有配置不变：\n\n   [mcp_servers.n8n]\n   url = \"{serverUrl}\"\n\n2. 保存后，请在浏览器提示时提醒我重启 Codex，并完成 n8n 的 OAuth 流程 —— 在此之前，服务器的工具不可用。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.client.title": "选择你的助手",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.access.title": "为我的实例启用 MCP",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.prompt.title": "将提示粘贴到 {assistant}",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.serverUrl.title": "粘贴服务器 URL",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.restart.title": "重新启动 {assistant} 并连接到 n8n",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.chatgptDeveloperMode.title": "在 ChatGPT 中启用开发者模式",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.chatgptDeveloperMode.description": "在 ChatGPT 中，前往 设置 > 应用与连接器 > 高级设置。开启开发者模式。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.chatgptCustomApp.title": "创建自定义应用",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.chatgptCustomApp.appName.label": "应用名称",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.chatgptCustomApp.appName.value": "n8n",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.section.chatgptCustomApp.serverUrl.label": "服务器 URL",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.footer": "您稍后可以在 {settingsLink} 处禁用此项。有关此功能的更多信息，请参阅 {docsLink}。",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.footer.docsLink": "这里",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.copy.tooltip": "复制设置提示",
	"experiments.surfaceMcpToNewCloudUsers.onboarding.copy.copied": "已复制",
	"experiments.surfaceMcpToNewCloudUsers.emptyState.tile.variant1.cta": "由你的助手构建",
	"experiments.surfaceMcpToNewCloudUsers.emptyState.tile.variant2.cta": "连接到你的人工智能",
	"experiments.surfaceMcpToNewCloudUsers.emptyState.tile.badge.new": "新建",
	"experiments.surfaceMcpToNewCloudUsers.emptyState.tile.badge.enabled": "已启用",
	"experiments.surfaceMcpToNewCloudUsers.emptyState.reminder": "稍后您可以在设置 > MCP 中启用它。",
	"settings.chatHub": "聊天",
	...
	"settings.chatHub.providers.modal.edit.responsesApi.description": "如果您的 OpenAI 凭据使用自定义基础 URL，且该 URL 不支持 Responses API，请禁用此项（例如通过 OpenAI 兼容层的 Gemini）。",
	"settings.chatHub.providers.modal.edit.contextWindowLength.label": "上下文窗口（消息）",
	"settings.chatHub.providers.modal.edit.contextWindowLength.description": "要包含为模型提供上下文的先前交互数量（消息和回复对）。默认值：20。",
	...
	"settings.chatHub.vectorStore.description": "用于存储和检索代理知识的文档嵌入的数据库。",
	"settings.chatHub.vectorStore.notShared": "将凭据全局共享，以确保所有用户都能在其个人代理中使用文件知识。",
	"settings.chatHub.vectorStore.missing": "向量存储凭证尚未设置。请选择一个提供商和凭证，以便为个人代理启用文件知识功能。",
	"settings.chatHub.vectorStore.save.error": "保存向量存储凭证时出错",
	"settings.chatHub.vectorStore.changeProvider.confirm.title": "更改向量存储提供程序",
	"settings.chatHub.vectorStore.changeProvider.confirm.message": "更改向量存储提供程序会使已索引的文档变得不可搜索。使用文件知识的代理需要重新上传文件。",
	"settings.chatHub.vectorStore.changeProvider.confirm.button": "更改提供商",
	"settings.chatHub.embeddingModel.title": "嵌入模型",
	"settings.chatHub.embeddingModel.description": "用于将文档和查询转换为向量嵌入的AI模型。",
	"settings.chatHub.embeddingModel.save.error": "保存嵌入模型凭据时出错。",
	"settings.chatHub.embeddingModel.changeProvider.confirm.title": "更改嵌入提供者",
	"settings.chatHub.embeddingModel.changeProvider.confirm.message": "更改嵌入提供商会使现有已索引的文档变得不可搜索。用户需要将文件重新上传到使用文件知识的代理。",
	"settings.chatHub.embeddingModel.changeProvider.confirm.button": "更改提供者",
	"settings.chatHub.embeddingModel.missing": "嵌入模型凭证尚未设置。请选择一个提供商和凭证，以启用个人代理的文件知识。",
	"settings.chatHub.embeddingModel.notShared": "将凭证全局共享，以确保所有用户可以在他们的个人代理中使用文件知识。",
	"settings.chatHub.label.provider": "提供者",
	"settings.chatHub.label.credential": "凭证",
	"settings.goBack": "返回",
	"settings.personal": "个人",
	"settings.personal.basicInformation": "基本信息",
	"settings.personal.managedByEnv": "您的账户凭据由环境变量管理，无法在此处更改。",
	...
	"settings.log-streaming.managedByEnv": "日志流输出目标通过环境变量进行管理，无法从 UI 修改。",
	...
	"settings.provisioningConfirmDialog.enable.description": "您正在更改 SSO 用户的角色分配方式。请在保存之前下载当前的角色和访问映射作为备份，以确保您的 SSO 提供商已正确配置。",
	"settings.provisioningConfirmDialog.enable.checkbox": "我已下载并审核了 CSV 导出。我的 SSO 提供商已为新的分配方法正确配置。",
	"settings.provisioningConfirmDialog.disable.title": "仅在 n8n 中管理用户角色配置",
	"settings.provisioningConfirmDialog.disable.description": "SSO 用户的角色和项目访问将不再由您的 IdP 提供。用户的角色和项目访问权限将直接在 n8n 中分配。",
	"settings.provisioningConfirmDialog.disable.checkbox": "我确认我希望直接在 n8n 中管理用户角色和访问权限，不再通过我的 SSO 提供商来配置它们。",
	...
	"settings.provisioningConfirmDialog.projectRulesDeletion.warning": "现有的项目映射规则将被永久删除。",
	"settings.provisioningConfirmDialog.projectRulesDeletion.description": "保存此更改将删除所有项目角色映射规则。请在保存之前下载上方的项目角色 CSV，以便在需要时可以重新创建它们。",
	"settings.provisioningInstanceRolesHandledBySsoProvider.description": "用户管理和实例角色由您的 SSO 提供商控制。请联系您的 n8n 实例所有者或管理员以进行更改。",
	"settings.provisioningInstanceRolesHandledByExpressionMapping.description": "实例角色由基于表达式的角色映射规则自动管理。手动更改角色已禁用。",
	"settings.provisioningProjectRolesHandledBySsoProvider.description": "用户管理和项目角色由您的 SSO 提供商控制。要进行更改，请联系您的 n8n 实例所有者或管理员。",
	"settings.provisioningProjectRolesHandledByExpressionMapping.description": "项目角色由基于表达式的角色映射规则自动管理。手动角色变更已禁用。",
	...
	"settings.externalSecrets.card.secretsCount": "{count} 秘密 | {count} 秘密",
	...
	"settings.externalSecrets.systemRoles.description": "为项目编辑者和项目管理员角色添加作用域，允许他们默认访问其项目中的外部机密。",
	"settings.externalSecrets.systemRoles.enabled.toast": "已为项目角色启用外部机密访问",
	"settings.externalSecrets.systemRoles.disabled.toast": "项目角色的外部机密访问已禁用",
	"settings.externalSecrets.systemRoles.error": "更新外部密钥设置失败",
	"settings.externalSecrets.systemRoles.confirm.headline": "为项目角色禁用外部密钥？",
	"settings.externalSecrets.systemRoles.confirm.message": "项目管理员和编辑将失去对其项目中外部机密的访问权限。",
	...
	"settings.secretsProviderConnections.emptyState.heading": "添加外部机密库",
	"settings.secretsProviderConnections.emptyState.description": "通过添加外部机密存储，在多个环境中管理凭据。为提高安全性，将敏感凭据信息保存在你的密钥库中。",
	"settings.secretsProviderConnections.buttons.addSecretsStore": "添加密钥库",
	"settings.secretsProviderConnections.description": "通过连接外部机密存储，在多个环境中管理凭据。将敏感凭据信息保存在你的保险库中，以提高安全性。",
	"settings.secretsProviderConnections.card.createdAt": "创建于 {date}",
	"settings.secretsProviderConnections.actions.share": "分享",
	"settings.secretsProviderConnections.actions.activate.success.title": "秘密存储已激活",
	"settings.secretsProviderConnections.actions.activate.success.description": "\"{provider}\" 现在已激活。",
	"settings.secretsProviderConnections.actions.activate.error.title": "无法激活秘密存储",
	"settings.secretsProviderConnections.actions.activate.error.description": "再试一次将“{provider}”设为激活状态。",
	"settings.secretsProviderConnections.oneSecret": "1 个秘密",
	...
	"settings.secretsProviderConnections.modal.scope.placeholder.project": "全局分配或在所选项目中进行分配",
	"settings.secretsProviderConnections.modal.scope.global": "全局",
	"settings.secretsProviderConnections.modal.scope.emptyOptionsText": "未找到匹配的项目",
	"settings.secretsProviderConnections.modal.scope.info": "将秘密库分配给用户，使他们能够在凭据中使用外部秘密。",
	"settings.secretsProviderConnections.modal.scope.label": "作用域",
	"settings.secretsProviderConnections.modal.connectionName": "密钥库名称",
	...
	"settings.secretsProviderConnections.modal.readOnly.notice.admin": "此保险库在实例级别进行管理。若要进行更改，请前往设置中的 External Secrets。",
	"settings.secretsProviderConnections.modal.readOnly.notice.noPermission": "此保管库在实例级别进行管理。请联系您的实例管理员以进行更改。",
	...
	"settings.secretsProviderConnections.modal.validation.connectionName.required": "必须提供 Vault 名称。请输入一个用于您的秘密存储的唯一名称。",
	"settings.secretsProviderConnections.modal.validation.connectionName.format": "名称必须以字母开头，并且仅使用字母或数字（例如“awsProduction”）。",
	...
	"settings.secretsProviderConnections.state.disabled": "不活跃",
	"settings.secretsProviderConnections.delete.title": "删除 \"{name}\"",
	"settings.secretsProviderConnections.delete.description": "删除此密钥库将删除它本身以及从中导入的 {secretsCount} 个秘密。这将影响依赖于这些秘密的凭据。",
	"settings.secretsProviderConnections.delete.impact.title": "影响：",
	"settings.secretsProviderConnections.delete.impact.oneCredential": "1 个凭据",
	...
	"settings.secretsProviderConnections.delete.description.noImpact": "删除此保管库会将其移除。此操作无法撤销。未从其中导入任何机密信息，也不会影响任何凭据。",
	"settings.secretsProviderConnections.delete.confirmationLabel": "输入“{name}”以确认。",
	"settings.secretsProviderConnections.delete.success": "机密存储“{name}”已成功删除",
	"settings.secretsProviderConnections.delete.error": "删除密钥存储失败",
	"settings.secretsProviderConnections.badge.tooltip.project": "该机密库与 {projectName} 共享。",
	"settings.secretsProviderConnections.badge.tooltip.global": "此机密库对本实例的所有项目和用户可用。",
	...
	"settings.sourceControl.modals.push.modifiedCredentialsNotice": "修改后的凭据将更新表达式、数字和布尔值，其他值将不会被同步，因为它们会在连接的 Git 仓库中以明文形式暴露。",
	"settings.sourceControl.modals.push.success.title": "推送成功",
	"settings.sourceControl.modals.push.success.description": "已提交并推送到您的远程仓库 | 已被提交并推送到您的远程仓库",
	...
	"settings.sourceControl.pull.success.description": "已被拉取 | 已被拉取",
	...
	"settings.sourceControl.modals.pull.modifiedCredentialsNotice": "修改后的凭据将更新表达式、数字和布尔值，其他任何值都无法通过环境变量获取，因为机密值无法同步。",
	"settings.sourceControl.modals.pull.buttons.cancel": "@:_reusableBaseText.cancel",
	"settings.sourceControl.modals.pull.buttons.save": "拉取并覆盖",
	"settings.sourceControl.modals.pull.buttons.pull": "拉取",
	"settings.sourceControl.modals.pull.dataTablesWarning": "以下数据表存在架构变更。删除列将导致无法恢复的数据丢失： | 以下数据表存在架构变更。删除列将导致无法恢复的数据丢失： | 以下 {count} 个数据表存在架构变更。删除列将导致无法恢复的数据丢失：",
	...
	"templates.connectionWarning": "! 获取工作流模板时出错。请检查您的网络连接。",
	...
	"templates.card.readyToRun": "准备运行",
	"textEdit.edit": "编辑",
	...
	"workflowActivator.showError.nodeError": "节点 \"{nodeName}\" 中发生错误：",
	...
	"canvas.selection.toolbar.group": "分组节点",
	"canvas.selection.toolbar.ungroup": "取消分组",
	"canvas.nodeGroup.defaultTitle": "分组",
	"canvas.nodeGroup.titlePlaceholder": "组名",
	...
	"workflowSettings.saveExecutionProgressOptions.save": "@:_reusableBaseText.save",
	"workflowSettings.redactProductionData": "对生产执行数据进行脱敏",
	"workflowSettings.redactProductionData.dynamicCredentialsHint": "在使用动态凭据的工作流中，生产环境的执行数据始终被脱敏。",
	"workflowSettings.redactManualData": "对手动执行数据进行脱敏",
	"workflowSettings.redactManualData.requiresProductionHint": "只有在生产执行的数据也被脱敏时，手动执行的数据才可以被脱敏。",
	"workflowSettings.redactionOptions.default": "默认 - 不进行脱敏",
	"workflowSettings.redactionOptions.redact": "编辑",
	"workflowSettings.helpTexts.redactProductionData": "控制生产环境中（非手动触发）执行的数据是否被隐藏。",
	"workflowSettings.helpTexts.redactManualData": "控制是否对手动触发的执行数据进行编辑隐藏。",
	"workflowSettings.redactionPermissionNotice": "您没有权限更改数据脱敏设置。",
	"workflowSettings.redactionPermissionNotice.viewUsers": "查看拥有访问权限的用户",
	"workflowSettings.redactionEnforcementNotice": "在实例级别强制执行",
	"workflowSettings.redactionEnforcementNotice.label": "在实例级别强制执行",
	"workflowSettings.redactionMembersModal.title": "可以编辑数据脱敏设置的用户",
	"workflowSettings.redactionMembersModal.description": "这些用户可以修改数据脱敏设置。请联系其中一位以请求更改。",
	...
	"credentialResolverEdit.confirmMessage.deleteResolver.messageWithWorkflows": "你确定要删除凭据解析器 {savedResolverName} 吗？以下工作流使用了此解析器，将不再解析动态凭据：",
	...
	"workflowSettings.toggleMCP.updateSkippedError": "工作流 {workflowId} 无法更新。它可能已被归档，或者您可能不再拥有编辑它的权限。",
	"workflowHistory.title": "版本历史记录",
	"workflowHistory.tab.history": "版本",
	"workflowHistory.tab.publishTimeline": "发布时间线",
	"workflowHistory.action.viewTimeline": "查看时间线",
	...
	"workflowHistory.item.actions.restore": "还原版本",
	...
	"workflowHistory.item.actions.name": "名称 版本",
	...
	"workflowHistory.item.compareTooltip.withLine": "带有“{name}”",
	...
	"workflowHistory.action.nameVersion.success.title": "版本名称已成功更新",
	"workflowHistory.action.nameVersion.error.title": "更新版本名称失败",
	"workflowHistory.nameVersionModal.title": "名称 版本",
	...
	"workflowHistory.publishTimeline.empty": "此工作流尚无发布历史。",
	"workflowHistory.publishTimeline.event.activated": "已发布",
	"workflowHistory.publishTimeline.event.activatedVersion": "已发布 {version}",
	"workflowHistory.publishTimeline.event.activatedDeletedVersion": "已发布一个版本",
	"workflowHistory.publishTimeline.event.activatedDeletedVersion.tooltip": "已发表的版本此后已被删减。",
	"workflowHistory.publishTimeline.event.deactivated": "未发布",
	"workflowHistory.publishTimeline.activeDuration": "有效期为 {duration}",
	"workflowHistory.publishTimeline.inactiveDuration": "在 {duration} 内不活跃",
	"workflowHistory.publishTimeline.tooltip.byUser": "{action} 由 {user}，{datetime}",
	"workflowHistory.publishTimeline.tooltip.noUser": "{action}, {datetime}",
	"workflowHistory.publishTimeline.deletedVersionsDisclaimer": "在 {date} 之前的历史记录可能不完整。",
	"workflowHistory.publishTimeline.deletedVersionsDisclaimer.tooltip": "在 2.17 版本之前，被修剪的工作流版本也会删除相关的发布历史。",
	"favorites.add": "最喜欢",
	...
	"workflows.publish.personalSpaceRestricted": "在个人空间中，工作流发布被禁用。将工作流移动到团队空间以启用工作流发布。",
	"workflows.unpublish": "取消发布",
	...
	"workflows.dependencies.tooltip.workflow": "点击查看此工作流所引用的资源",
	"workflows.dependencies.tooltip.credential": "点击查看引用此凭据的资源",
	"workflows.dependencies.tooltip.dataTable": "点击查看引用此数据表的资源",
	"workflows.dependencies.modal.title": "依赖项",
	"workflows.dependencies.modal.search": "正在搜索依赖项…",
	"workflows.dependencies.type.credentials": "凭据",
	"workflows.dependencies.type.dataTables": "数据表格",
	"workflows.dependencies.type.errorWorkflow": "错误的工作流",
	"workflows.dependencies.type.errorWorkflowParent": "错误处理程序的",
	"workflows.dependencies.type.subWorkflows": "子工作流",
	"workflows.dependencies.type.parentWorkflows": "由工作流使用",
	...
	"resourceDependents.tooltip": "由 1 个工作流使用 | 由 {count} 个工作流使用",
	"resourceDependents.modal.title": "供工作流使用",
	...
	"workflows.item.mcpDisabledByInstance": "实例级 MCP 已被禁用。请管理员启用它。",
	...
	"workflows.empty.headingWithIcon": "你想为 {name} 构建什么？",
	"workflows.empty.headingWithIcon.userNotSetup": "你想要构建什么？",
	"workflows.empty.heading.builder": "嗨 {name}，你想自动化什么？",
	"workflows.empty.heading.builder.userNotSetup": "嗨，你想要自动化什么？",
	"workflows.empty.description": "你想构建什么？",
	...
	"workflows.empty.buildAgent": "构建一个代理",
	"workflows.empty.buildWorkflow": "构建一个工作流",
	...
	"workflows.shareModal.info.personalSpaceRestricted": "在个人空间中禁用共享。将工作流移动到团队项目以进行共享。",
	"workflows.shareModal.role.editor": "@:_reusableBaseText.roles.editor",
	"workflows.roles.editor": "@:_reusableBaseText.roles.editor",
	...
	"workflows.remoteUpdateBlocked.title": "工作流已在其他地方更新",
	"workflows.remoteUpdateBlocked.message": "此工作流已在另一个标签页或由其他用户更新。我们保留了您未保存的更改，因此未在此处应用最新版本。请保存以覆盖，或重新加载以获取最新版本。",
	...
	"workflows.publishModal.aiGatewayWarning.header": "节点 | 节点",
	"workflows.publishModal.aiGatewayWarning.body": "使用一个 n8n Connect 凭据。 一旦您的 n8n Connect 余额耗尽，该工作流将停止工作。 | 使用 n8n Connect 凭据。 一旦您的 n8n Connect 余额耗尽，该工作流将停止工作。",
	...
	"importCurlParameter.showError.failedToLoad.title": "无法加载依赖项",
	...
	"dataTable.download.modal.title": "下载 CSV 文件",
	"dataTable.download.modal.includeSystemColumns": "包含系统列（id、createdAt、updatedAt）",
	"dataTable.download.modal.confirm": "下载",
	"dataTable.download.modal.cancel": "取消",
	"dataTable.importCsv": "导入 CSV",
	"dataTable.importCsv.title": "将 CSV 导入数据表",
	"dataTable.importCsv.description": "列名必须与表的列名匹配。CSV 中发现的系统列（id、createdAt、updatedAt）将被忽略。",
	"dataTable.importCsv.columnMismatch": "以下 CSV 列与表格不匹配：{unrecognized}。以下表格列在 CSV 中缺失：{missing}。",
	"dataTable.importCsv.unrecognizedColumnsOnly": "以下 CSV 列与表格不匹配：{columns}。请删除它们，然后再试一次。",
	"dataTable.importCsv.missingColumnsOnly": "以下表格列在 CSV 中缺失，将被设为 null：{columns}。",
	"dataTable.importCsv.noMatchingColumns": "未找到匹配的列。CSV 列名必须与表格的列名完全匹配。",
	"dataTable.importCsv.readyToImport": "准备导入 {count} 行 | 准备导入 {count} 行",
	"dataTable.importCsv.success": "已成功导入 {count} 行 | 已成功导入 {count} 行",
	"dataTable.importCsv.error": "CSV 导入失败",
	...
	"dataTable.updateRow.numberPrecisionWarning.title": "数字精度可能会丢失",
	"dataTable.updateRow.numberPrecisionWarning.message": "超过 9,007,199,254,740,991 的数值可能会丢失精度。如果你需要精确的数值，请将大数字存储为文本。",
	...
	"dataTable.sort.lastUpdated": "按最近更新排序",
	"dataTable.sort.lastCreated": "按最近创建排序",
	...
	"settings.n8nConnect.description": "轻松管理 AI 的使用与成本",
	"settings.n8nConnect.usage.title": "用法",
	"settings.n8nConnect.usage.refresh": "刷新",
	"settings.n8nConnect.usage.col.date": "日期",
	"settings.n8nConnect.usage.col.provider": "提供者",
	...
	"settings.n8nConnect.usage.col.cost": "成本（美元）",
	"settings.n8nConnect.usage.empty": "未找到使用记录。",
	"settings.n8nConnect.usage.loadMore": "加载更多",
	"settings.n8nConnect.usage.openExecution": "打开执行",
	...
	"settings.n8nAgent": "人工智能助手",
	"settings.n8nAgent.description": "为此实例启用或禁用 AI 助手并管理权限",
	"settings.agentBuilder.title": "代理",
	"settings.agentBuilder.description": "选择代理构建器所运行的模型。默认情况下，它使用 n8n AI 助手；管理员可以切换到自定义提供程序和凭据。",
	"settings.agentBuilder.section.model": "构建器模型",
	"settings.agentBuilder.section.help": "代理构建器是帮助用户设计和配置代理的人工智能。此设置控制该构建器所运行的LLM。",
	"settings.agentBuilder.mode.default.label": "使用 n8n AI",
	"settings.agentBuilder.mode.custom.label": "使用自定义提供者",
	"settings.agentBuilder.proxyDisabledTooltip": "n8n AI 需要有效的许可证和 N8N_AI_ASSISTANT_BASE_URL 设置。为此实例选择一个自定义提供程序以使用构建器。",
	"settings.agentBuilder.status.proxy": "构建者将使用 n8n AI 助手（{model}）。",
	"settings.agentBuilder.status.envVar": "构建器将使用 N8N_AI_ANTHROPIC_KEY 环境变量作为回退。通过配置凭据使该设置更明确。",
	"settings.agentBuilder.status.custom": "构建器将通过所选凭据使用 {provider}/{model}。",
	"settings.agentBuilder.status.customIncomplete": "选择一个提供商和凭据以完成设置。",
	"settings.agentBuilder.missingCredential.title": "需要凭据",
	"settings.agentBuilder.missingCredential.message": "在保存之前，请为此提供者选择一个凭据。",
	"settings.agentBuilder.saved": "代理构建器设置已保存",
	"settings.agentBuilder.saveError": "无法保存代理构建器设置",
	"settings.agentBuilder.loadError": "无法加载代理构建器设置",
	"agents.builder.unconfigured.title": "设置代理构建器",
	"agents.builder.unconfigured.description.admin": "选择一个提供商和凭据，以便代理构建器可以帮助您设计代理。",
	"agents.builder.unconfigured.description.nonAdmin": "请让实例管理员在您在此处构建代理之前，先配置代理构建器。",
	"agents.builder.unconfigured.cta": "打开代理构建器设置",
	"settings.n8nAgent.enable.label": "启用 AI 助手",
	"settings.n8nAgent.enable.description": "为实例中的所有用户启用该功能",
	"settings.n8nAgent.computerUse.label": "启用 AI 助手使用计算机。",
	"settings.n8nAgent.computerUse.description": "允许本实例的用户将 AI Assistant 连接到他们的计算机，以便与文件和浏览器一起工作。",
	"settings.n8nAgent.computerUse.disabled.warning": "计算机的使用已被管理员禁用。",
	"settings.n8nAgent.permissions.title": "权限",
	"settings.n8nAgent.permissions.description": "控制在代理执行操作之前需要审批哪些操作。这些设置不会为用户授予任何额外权限。",
	"settings.n8nAgent.permissions.alwaysAllow": "始终允许",
	"settings.n8nAgent.permissions.needsApproval": "需要批准",
	"settings.n8nAgent.permissions.blocked": "已阻塞",
	...
	"settings.n8nAgent.permissions.tagWorkflow": "为工作流打标签",
	"settings.n8nAgent.permissions.createDataTable": "创建数据表",
	"settings.n8nAgent.permissions.mutateDataTableSchema": "修改数据表结构",
	"settings.n8nAgent.permissions.mutateDataTableRows": "修改数据表中的行",
	"settings.n8nAgent.permissions.cleanupTestExecutions": "清理测试执行",
	"settings.n8nAgent.permissions.readFilesystem": "读取文件系统",
	"settings.n8nAgent.permissions.fetchUrl": "获取 URL",
	"settings.n8nAgent.permissions.webSearch": "在网上搜索",
	"settings.n8nAgent.permissions.restoreWorkflowVersion": "还原工作流版本",
	...
	"settings.security.description": "管理工作区安全要求。强制执行双因素认证，并控制个人空间的相关操作，例如发布工作流和共享资源。",
	"settings.security.managedByEnv": "这些安全设置是通过环境变量配置的，无法在此处进行更改。",
	"settings.security.personalSpace.title": "个人空间",
	"settings.security.personalSpace.publishing.title": "工作流发布",
	"settings.security.personalSpace.publishing.description": "在个人空间中发布工作流。更改设置不会取消已发布的工作流。",
	...
	"settings.security.personalSpace.publishing.existingCount.label": "已发布的工作流",
	"settings.security.personalSpace.publishing.existingCount.value": "{count} 个工作流",
	"settings.security.personalSpace.sharing.title": "分享",
	"settings.security.personalSpace.sharing.description": "从个人空间共享工作流、凭据及其他资源。更改此设置不会撤销现有的共享。",
	"settings.security.personalSpace.sharing.success.enabled": "工作流和凭据共享已启用",
	...
	"settings.security.personalSpace.unlicensed_tooltip": "升级到包含个人空间策略以管理此设置的计划。{action}",
	"settings.security.personalSpace.unlicensed_tooltip.link": "立即升级",
	"settings.security.dataRedaction.title": "数据脱敏",
	"settings.security.dataRedaction.enforce.title": "强制数据脱敏",
	"settings.security.dataRedaction.enforce.message": "覆盖工作流级别的设置，并在整个实例的所有执行中强制进行数据脱敏。",
	"settings.security.dataRedaction.enforce.success.enabled": "数据脱敏已强制执行",
	"settings.security.dataRedaction.enforce.success.disabled": "数据脱敏不再强制执行",
	"settings.security.dataRedaction.enforce.error": "更新数据脱敏强制执行失败",
	"settings.security.dataRedaction.enforce.confirmEnable.headline": "启用数据编辑执行",
	"settings.security.dataRedaction.enforce.confirmEnable.message": "本实例中的所有工作流将根据您的选择对执行数据进行脱敏处理：生产执行，或手动和生产执行。工作流编辑器将无法在所选级别之下禁用或降低脱敏程度。新建的工作流将继承此设置。",
	"settings.security.dataRedaction.enforce.confirmEnable.action": "启用",
	"settings.security.dataRedaction.enforce.confirmDisable.headline": "禁用数据编辑强制执行",
	"settings.security.dataRedaction.enforce.confirmDisable.message": "在此实例中将不再强制应用脱敏设置。工作流程将回退到各自的脱敏设置。工作流程的编辑者将能够自由更改这些设置。",
	"settings.security.dataRedaction.enforce.confirmDisable.action": "禁用",
	"settings.security.dataRedaction.scope.title": "脱敏执行记录",
	"settings.security.dataRedaction.scope.description": "选择是否对生产执行进行脱敏，或对手动和生产执行进行脱敏。",
	"settings.security.dataRedaction.scope.option.manual-only": "手动执行",
	"settings.security.dataRedaction.scope.option.non-manual": "生产执行（推荐）",
	"settings.security.dataRedaction.scope.option.all": "手动执行与生产执行",
	"settings.security.dataRedaction.scope.success": "脱敏范围已更新",
	"settings.security.dataRedaction.scope.error": "更新脱敏范围失败",
	"settings.security.dataRedaction.affectedScope.label": "受影响的范围",
	"settings.security.dataRedaction.affectedScope.none": "暂无执行记录",
	"settings.security.dataRedaction.affectedScope.manual-only": "手动执行",
	"settings.security.dataRedaction.affectedScope.non-manual": "生产执行",
	"settings.security.dataRedaction.affectedScope.all": "手动执行与生产执行",
	"settings.security.dataRedaction.unlicensed_tooltip": "升级到包含数据脱敏功能的计划以管理此设置。 {action}",
	"settings.security.dataRedaction.unlicensed_tooltip.link": "立即升级",
	"settings.encryptionKeys": "数据加密密钥",
	"settings.encryptionKeys.title": "数据加密密钥",
	"settings.encryptionKeys.description": "数据加密密钥在静态存储时保护凭据、变量和其他敏感数据。密钥轮换会生成一个新的活动密钥。过去的密钥将被存档并留存以供审计。",
	"settings.encryptionKeys.description.docsLink": "在文档中了解更多信息",
	"settings.encryptionKeys.column.key": "键",
	"settings.encryptionKeys.column.status": "状态",
	"settings.encryptionKeys.column.activated": "已激活",
	"settings.encryptionKeys.column.archived": "已归档",
	"settings.encryptionKeys.status.active": "启用",
	"settings.encryptionKeys.status.inactive": "未激活",
	"settings.encryptionKeys.sortBy.label": "排序依据",
	"settings.encryptionKeys.sortBy.activated": "已激活",
	"settings.encryptionKeys.sortBy.archived": "已归档",
	"settings.encryptionKeys.sortBy.status": "状态",
	"settings.encryptionKeys.filter.title": "筛选",
	"settings.encryptionKeys.filter.dateRange": "日期范围",
	"settings.encryptionKeys.filter.apply": "应用",
	"settings.encryptionKeys.filter.clear": "清除",
	"settings.encryptionKeys.rotate.button": "轮换密钥",
	"settings.encryptionKeys.rotate.confirm.title": "轮换加密密钥？",
	"settings.encryptionKeys.rotate.confirm.body": "将生成一个新的加密密钥，并用于对新数据进行加密。先前的密钥将被归档并保留以解密现有数据。",
	"settings.encryptionKeys.rotate.confirm.action": "轮换密钥",
	"settings.encryptionKeys.rotate.confirm.cancel": "取消",
	"settings.encryptionKeys.rotate.success": "加密密钥已轮换",
	"settings.encryptionKeys.rotate.error": "无法轮换加密密钥",
	"settings.encryptionKeys.empty.title": "还没有加密密钥",
	"settings.encryptionKeys.empty.description": "轮换一个密钥以生成你的第一个活动加密密钥。",
	"settings.encryptionKeys.loadError": "无法加载加密密钥",
	"settings.sso": "SSO",
	"settings.sso.title": "单点登录",
	"settings.sso.subtitle": "SAML 2.0 配置",
	"settings.sso.info": "配置单点登录（SSO），让您的团队通过身份提供商进行登录。支持 SAML 2.0 和 OpenID Connect 协议。在文档中了解更多。",
	...
	"settings.sso.settings.entityId.label": "实体 ID 的 URL",
	...
	"settings.sso.settings.roleAssignment.description": "选择如何将角色分配给 SSO 用户",
	"settings.sso.settings.roleAssignment.manual": "在 n8n 中手动分配",
	"settings.sso.settings.roleAssignment.manual.description": "管理员直接为每个用户分配角色。没有来自您的 IdP 的自动角色映射",
	"settings.sso.settings.roleAssignment.instanceRoles": "通过单点登录的实例角色",
	"settings.sso.settings.roleAssignment.instanceRoles.description": "将 IdP 的声明映射到 n8n 实例角色，如 Admin、Member 或自定义角色",
	"settings.sso.settings.roleAssignment.instanceAndProjectRoles": "通过单点登录的实例和项目角色",
	"settings.sso.settings.roleAssignment.instanceAndProjectRoles.description": "将 IdP 声明映射到实例角色以及按项目的访问，并分配特定角色",
	"settings.sso.settings.roleMappingMethod.label": "角色映射方法",
	"settings.sso.settings.roleMappingMethod.description": "选择如何把 SSO 声明映射到 n8n 角色",
	"settings.sso.settings.roleMappingMethod.idp": "在您的 IdP 上映射规则",
	"settings.sso.settings.roleMappingMethod.idp.description": "角色直接来自您的身份提供者（IdP），通过声明。无需规则。",
	"settings.sso.settings.roleMappingMethod.rulesInN8n": "在 n8n 中映射规则",
	"settings.sso.settings.roleMappingMethod.rulesInN8n.description": "在 n8n 中定义规则，以控制 IdP 声明如何映射为实例和项目角色。",
	"settings.sso.settings.roleMappingMethod.idp.instanceInfo": "实例角色直接来自您的身份提供者。用户将接收身份提供者通过 SAML/OIDC 声明发送的任何角色——无需映射规则。",
	"settings.sso.settings.roleMappingMethod.idp.instanceAndProjectInfo": "实例级和项目级角色直接来自您的身份提供者。用户将接收您的身份提供者通过 SAML/OIDC 声明发送的任意角色——无需映射规则。",
	...
	"settings.sso.settings.roleMappingRules.instanceRules.description": "定义规则，根据 IdP 声明来分配实例角色。先匹配的规则生效。",
	"settings.sso.settings.roleMappingRules.addRule": "添加规则",
	"settings.sso.settings.roleMappingRules.expression.placeholder": "检查 $claims.groups 是否包含 'admins'。",
	"settings.sso.settings.authProtocol.label": "认证协议",
	"settings.sso.settings.authProtocol.description": "选择您的单点登录协议",
	"settings.sso.settings.roleMappingRules.projectRules.title": "项目角色规则",
	"settings.sso.settings.roleMappingRules.projectRules.description": "定义基于 IdP 声明分配项目角色的规则。最先匹配的规则生效。",
	...
	"settings.sso.settings.roleMappingRules.removeMapping.confirm.message": "您确定要删除所有角色映射规则吗？此操作无法撤销。",
	"settings.sso.settings.roleMappingRules.removeMapping.confirm.confirm": "删除",
	"settings.sso.settings.roleMappingRules.removeMapping.confirm.cancel": "取消",
	"settings.sso.settings.ssoToggle.label": "单点登录 (SSO)",
	"settings.sso.settings.ssoToggle.description": "允许用户通过您的身份提供程序登录",
	...
	"settings.sso.settings.save.success": "单点登录配置已保存",
	"settings.sso.settings.unsavedChanges.title": "未保存的更改",
	"settings.sso.settings.unsavedChanges.message": "你有未保存的更改。若离开将会丢失。",
	"settings.sso.settings.unsavedChanges.saveAndLeave": "保存并离开",
	"settings.sso.settings.unsavedChanges.leaveWithoutSaving": "不保存就离开",
	...
	"settings.sso.settings.envConfigBanner": "SSO 连接已通过环境变量进行配置。如需修改，请更新环境变量并重新启动 n8n。",
	...
	"projects.header.create.agent": "创建代理",
	...
	"projects.menu.create.workflow": "新建工作流",
	"projects.menu.create.credential": "新凭据",
	"projects.menu.create.agent": "新建代理",
	"projects.menu.create.project": "新建项目",
	"projects.menu.create.instanceAiThread": "新建 AI 聊天",
	...
	"projects.settings.role.popover.viewAndEdit": "查看并编辑角色",
	"projects.settings.role.popover.viewDetails": "查看角色",
	"projects.settings.role.contactAdmin.title": "自定义角色尚未设置好",
	"projects.settings.role.contactAdmin.titleWithRoles": "只有实例管理员可以添加自定义角色。",
	"projects.settings.role.contactAdmin.body": "你可以分配系统角色，但自定义角色需要先由实例管理员创建。将 {documentation} 分享给你的实例管理员，以便设置自定义角色。",
	"projects.settings.role.contactAdmin.bodyWithRoles": "您可以分配现有的自定义角色，但要创建新的角色，您需要联系实例管理员。请在我们的{documentation}中了解更多信息。",
	"projects.settings.role.upgrade.custom.title": "升级到企业版",
	"projects.settings.role.upgrade.custom.body": "要创建和管理自定义角色，您需要将计划升级到企业版。请在{documentation}中了解更多信息。",
	...
	"projects.settings.externalSecrets": "外部秘密保管库",
	"projects.settings.externalSecrets.emptyState.heading": "尚无外部密钥可用",
	"projects.settings.externalSecrets.emptyState.instanceAdmin.noProjectProviders.description": "将机密库与此项目共享，以使外部机密在此处可用。共享后，机密将自动出现，并可通过凭据中的别名进行引用。",
	"projects.settings.externalSecrets.emptyState.projectAdmin.description": "添加一个机密库并将其与本项目共享，以在此处提供外部机密。共享后，机密将自动出现，并可在凭据中通过别名进行引用。",
	"projects.settings.externalSecrets.button.addSecretsStore": "添加机密保险库",
	"projects.settings.externalSecrets.button.shareSecretsStore": "共享秘密库",
	"projects.settings.externalSecrets.table.header.secretName": "密钥名称",
	"projects.settings.externalSecrets.table.header.usedInCredentials": "用于凭据",
	"projects.settings.externalSecrets.search.placeholder": "搜索凭证...",
	"projects.settings.externalSecrets.load.error": "在加载外部密钥时发生错误。",
	"projects.settings.externalSecrets.expand": "展开外部密钥库",
	"projects.settings.externalSecrets.collapse": "折叠外部秘密库",
	"projects.sharing.allUsers": "所有用户和项目",
	"projects.sharing.noMatchingProjects": "没有可用的项目",
	"projects.sharing.moreResults": "{count} 条更多结果 — 精炼您的搜索",
	...
	"projects.create.permissionDenied": "您当前的角色不允许您创建项目。请联系管理员以申请访问权限。",
	...
	"projects.move.resource.modal.message.unAccessibleCredentials.count": "{count} 条凭据 | {count} 条凭据",
	"projects.move.resource.modal.message.unAccessibleCredentials.note": "{credentials} 不能被共享。请在目标项目中将它们移动或重新创建，以确保此工作流继续运行。",
	"projects.move.resource.modal.message.unAccessibleCredentials.personalSpaceNote": "{credentials} 不能共享，因为管理员已禁用从个人空间共享。请将它们移动到你将要加入的项目或用户中，或在该项目或用户中重新创建它们，以确保此工作流继续运行。",
	...
	"setupPanel.empty.description": "目前没有可配置的内容。",
	"setupPanel.tabs.setup": "设置",
	"setupPanel.tabs.focus": "聚焦",
	"setupPanel.test.intro": "设置面板在这里。",
	"setupPanel.test.description": "在这里，您可以配置运行当前工作流所需的一切。",
	"setupPanel.credentialLabel": "凭据",
	"setupPanel.usedInNodes": "在 {count} 个节点中使用",
	"setupPanel.everythingConfigured.message": "您的工作流已准备好执行",
	"setupPanel.trigger.credential.note": "添加用于监听事件的凭据。",
	"setupPanel.trigger.listeningHint": "前往 {service} 并创建一个事件",
	"setupPanel.parameter.description": "此节点具有需要配置的必填参数。",
	"setupPanel.parameter.configureButton": "配置节点",
	"setupPanel.showCompleted": "显示已完成的步骤",
	"setupPanel.webhookUrl.title": "Webhook 地址",
	"setupPanel.webhookUrl.clickToCopy": "点击复制测试 URL",
	...
	"evaluation.runDetail.aiSummary.title": "AI 摘要",
	"evaluation.runDetail.aiSummary.placeholder": "本次运行的 AI 生成摘要将出现在这里。",
	"evaluation.runDetail.testCase.title": "测试 #{index}",
	"evaluation.runDetail.testCase.viewLink": "查看",
	"evaluation.runDetail.metrics.name": "名称",
	"evaluation.runDetail.metrics.result": "结果",
	"evaluation.runDetail.runComparison.comingSoon": "运行比较，功能即将推出",
	"evaluation.runDetail.backToRuns": "返回执行记录",
	"evaluation.runDetail.metricCategory.aiBased": "基于人工智能的",
	"evaluation.runDetail.metricCategory.stringSimilarity": "字符串相似度",
	"evaluation.runDetail.metricCategory.categorization": "分类",
	"evaluation.runDetail.metricCategory.toolsUsed": "使用的工具",
	"evaluation.runDetail.metricCategory.custom": "自定义",
	"evaluation.runDetail.testCase.pending": "待处理",
	"evaluation.runDetail.testCase.running": "正在运行…",
	"evaluation.runDetail.testCase.cancelled": "已取消",
	"evaluation.runDetail.testCase.failed": "失败",
	"evaluation.runDetail.testCase.cancel": "取消",
	"evaluation.runDetail.testCase.cancelError": "无法取消此测试用例",
	"evaluation.runDetail.testCase.rerun": "重新运行测试",
	"evaluation.runDetail.testCase.progress.accomplishing": "正在完成",
	"evaluation.runDetail.testCase.progress.actioning": "正在执行",
	"evaluation.runDetail.testCase.progress.actualizing": "正在实现",
	"evaluation.runDetail.testCase.progress.architecting": "架构设计",
	"evaluation.runDetail.testCase.progress.baking": "烘焙",
	"evaluation.runDetail.testCase.progress.beaming": "灿烂的笑容",
	"evaluation.runDetail.testCase.progress.beboppin": "在比波普中摇摆",
	"evaluation.runDetail.testCase.progress.befuddling": "令人困惑的",
	"evaluation.runDetail.testCase.progress.billowing": "翻腾的",
	"evaluation.runDetail.testCase.progress.blanching": "焯水",
	"evaluation.runDetail.testCase.progress.bloviating": "夸夸其谈",
	"evaluation.runDetail.testCase.progress.boogieing": "跳舞",
	"evaluation.runDetail.testCase.progress.boondoggling": "无用功",
	"evaluation.runDetail.testCase.progress.booping": "戳鼻子",
	"evaluation.runDetail.testCase.progress.bootstrapping": "引导",
	"evaluation.runDetail.testCase.progress.brewing": "酿造",
	"evaluation.runDetail.testCase.progress.bunning": "Bunning",
	"evaluation.runDetail.testCase.progress.burrowing": "挖洞",
	"evaluation.runDetail.testCase.progress.calculating": "正在计算",
	"evaluation.runDetail.testCase.progress.canoodling": "亲昵行为",
	"evaluation.runDetail.testCase.progress.caramelizing": "焦糖化",
	"evaluation.runDetail.testCase.progress.cascading": "级联",
	"evaluation.runDetail.testCase.progress.catapulting": "弹射",
	"evaluation.runDetail.testCase.progress.cerebrating": "正在思考",
	"evaluation.runDetail.testCase.progress.channeling": "引导",
	"evaluation.runDetail.testCase.progress.choreographing": "编舞",
	"evaluation.runDetail.testCase.progress.churning": "用户流失",
	"evaluation.runDetail.testCase.progress.clauding": "克劳丁",
	"evaluation.runDetail.testCase.progress.coalescing": "合并",
	"evaluation.runDetail.testCase.progress.cogitating": "正在思考",
	"evaluation.runDetail.testCase.progress.combobulating": "使井然有序",
	"evaluation.runDetail.testCase.progress.composing": "正在撰写",
	"evaluation.runDetail.testCase.progress.computing": "计算",
	"evaluation.runDetail.testCase.progress.concocting": "正在调制",
	"evaluation.runDetail.testCase.progress.considering": "考虑到",
	"evaluation.runDetail.testCase.progress.contemplating": "沉思",
	"evaluation.runDetail.testCase.progress.cooking": "烹饪",
	"evaluation.runDetail.testCase.progress.crafting": "制作",
	"evaluation.runDetail.testCase.progress.creating": "正在创建",
	"evaluation.runDetail.testCase.progress.crunching": "正在计算",
	"evaluation.runDetail.testCase.progress.crystallizing": "正在结晶",
	"evaluation.runDetail.testCase.progress.cultivating": "培养",
	"evaluation.runDetail.testCase.progress.deciphering": "解读",
	"evaluation.runDetail.testCase.progress.deliberating": "正在考虑",
	"evaluation.runDetail.testCase.progress.determining": "正在确定",
	"evaluation.runDetail.testCase.progress.dillyDallying": "拖拖拉拉",
	"evaluation.runDetail.testCase.progress.discombobulating": "让人困惑的",
	"evaluation.runDetail.testCase.progress.doing": "正在进行",
	"evaluation.runDetail.testCase.progress.doodling": "涂鸦",
	"evaluation.runDetail.runStatus.running": "正在运行",
	"evaluation.runDetail.runStatus.done": "完成",
	"evaluation.runDetail.runStatus.cancelled": "已取消",
	"evaluation.runDetail.runStatus.failed": "失败",
	"evaluation.runTest": "运行测试",
	"evaluation.stopTest": "停止测试",
	"evaluation.runInParallel.label.sequential": "顺序执行",
	"evaluation.runInParallel.label.concurrent": "并发 · {count}",
	"evaluation.runInParallel.tooltip": "拖动滑块以设置同时运行的评估测试用例数量。数值为 1 时，测试用例按顺序执行；数值越高并行度越大以提高速度，但可能会达到 LLM 的速率限制。",
	"evaluation.runInParallel.popover.title": "并发",
	"evaluation.runInParallel.popover.ariaLabel": "配置并行执行",
	"evaluation.runInParallel.popover.valuePill": "{max}中的{count}",
	"evaluation.runInParallel.popover.scaleSequential": "顺序的",
	"evaluation.runInParallel.popover.scaleFaster": "更快 · 可能触发速率限制",
	"evaluation.runInParallel.popover.helper": "设置要并行运行的测试数量。设置更高的数量可以加快运行速度，但可能会遇到速率限制。",
	...
	"insights.dashboard.chart.title": "按 {granularity} 细分",
	...
	"communityNodeInfo.quickConnect.tooltip": "本服务可让您通过 n8n 直接轻松登录或注册。",
	"communityNodeInfo.contact.admin": "请联系管理员安装此社区节点：",
	"credentialsAppSelection.installToConnect": "安装此节点以连接",
	"credentialsAppSelection.askAdminToInstall": "请让你的管理员安装此节点。",
	...
	"commandBar.sections.instanceAi": "AI 助手",
	"commandBar.instanceAi.open": "OpenAI 助手",
	...
	"focusedNodes.noMatches": "没有与“{query}”匹配的节点。",
	"focusedNodes.mentionPlaceholder": "搜索节点...",
	"focusedNodes.mentionTooltip": "提到一个节点",
	"focusedNodes.allNodes": "所有节点",
	"focusedNodes.unconfirmedTooltip": "将其添加为助手的上下文",
	"instanceAi.view.title": "AI助手",
	"instanceAi.view.subtitle": "与您的 n8n 实例聊天",
	"instanceAi.input.placeholder": "问任何问题……",
	"instanceAi.input.suspendedPlaceholder": "要继续，请完成或跳过上面的设置。",
	"instanceAi.statusBar.waitingForInput": "等待您的输入",
	...
	"instanceAi.toolResult.moreRows": "还有 {count} 行...",
	"instanceAi.toolResult.dataTruncated": "数据已被截断以便显示。",
	"instanceAi.thread.new": "新聊天",
	"instanceAi.sidebar.back": "返回",
	"instanceAi.sidebar.threads": "线程",
	"instanceAi.sidebar.chatHistory": "聊天记录",
	"instanceAi.sidebar.collapse": "折叠侧边栏",
	"instanceAi.message.reasoning": "推理",
	"instanceAi.sidebar.noThreads": "还没有对话",
	"instanceAi.sidebar.group.thisWeek": "本周",
	"instanceAi.sidebar.group.older": "更旧",
	"instanceAi.sidebar.renameThread": "重命名",
	"instanceAi.sidebar.deleteThread": "删除",
	"instanceAi.connections.title": "连接",
	"instanceAi.connections.empty.title": "还没有连接",
	"instanceAi.connections.empty.cta": "设置计算机使用",
	"instanceAi.connections.add.computerUse": "计算机使用",
	"instanceAi.connections.add.browserUse": "浏览器使用",
	"instanceAi.connections.add.nothingAvailableTooltip": "所有连接都已添加。",
	"instanceAi.connections.row.connect": "连接",
	"instanceAi.connections.row.disconnect": "断开连接",
	"instanceAi.connections.disconnectError.title": "网关断开连接失败",
	"instanceAi.connections.disconnectError.message": "无法断开网关",
	"instanceAi.connections.row.remove": "移除",
	"instanceAi.connections.row.settings": "设置",
	"instanceAi.connections.row.status.connected": "已连接",
	"instanceAi.connections.row.status.waiting": "正在等待…",
	"instanceAi.connections.row.status.disconnected": "已断开连接",
	"instanceAi.connections.types.computerUse.subtitle": "计算机使用",
	"instanceAi.connections.types.browserUse.subtitle": "浏览器使用",
	"instanceAi.browserUse.step.extension.title": "安装 Chrome 浏览器扩展程序",
	"instanceAi.browserUse.step.extension.description": "安装适用于 Google Chrome 的 n8n 浏览器使用扩展，以便代理能够控制您的浏览器。",
	"instanceAi.browserUse.step.extension.cta": "安装 Chrome 扩展程序",
	"instanceAi.browserUse.step.extension.waiting": "正在等待扩展连接…",
	"instanceAi.error.sendFailed": "消息发送失败",
	"instanceAi.view.reconnecting": "正在重新连接...",
	...
	"instanceAi.error.title": "发生了错误",
	"instanceAi.error.technicalDetails": "技术细节",
	"instanceAi.artifactsPanel.title": "制品",
	"instanceAi.artifactsPanel.showPreview": "显示工件预览",
	"instanceAi.artifactsPanel.hidePreview": "隐藏产物预览",
	"instanceAi.artifactsPanel.showPanel": "显示列表面板",
	"instanceAi.artifactsPanel.pinPanel": "固定面板",
	"instanceAi.artifactsPanel.unpinPanel": "取消固定面板",
	"instanceAi.artifactsPanel.noArtifacts": "尚无产物",
	"instanceAi.artifactsPanel.openArtifact": "打开 {name}",
	"instanceAi.artifactsPanel.tasks": "任务",
	"instanceAi.artifactsPanel.openWorkflow": "打开",
	"instanceAi.artifactsPanel.archived": "已归档",
	"instanceAi.previewTabBar.expand": "展开面板",
	"instanceAi.previewTabBar.collapse": "折叠面板",
	"instanceAi.previewTabBar.openInEditor": "在编辑器中打开",
	"instanceAi.previewTabBar.openWorkflowInEditor": "在编辑器中打开工作流",
	"instanceAi.previewTabBar.copyLink": "复制链接",
	...
	"instanceAi.confirmation.approve": "允许一次",
	"instanceAi.confirmation.alwaysAllow": "始终允许",
	"instanceAi.confirmation.alwaysAllowSuffix": "在本次会话期间",
	"instanceAi.confirmation.allowPrompt": "允许 AI 助手执行 {action} 吗？",
	"instanceAi.confirmation.deny": "拒绝",
	"instanceAi.confirmation.approved": "允许",
	"instanceAi.confirmation.denied": "已拒绝",
	"instanceAi.confirmation.deferred": "已跳过",
	...
	"instanceAi.confirmation.continue": "继续",
	"instanceAi.gatewayConfirmation.allowForSession": "允许会话",
	"instanceAi.gatewayConfirmation.allowOnce": "允许一次",
	"instanceAi.gatewayConfirmation.denyOnce": "拒绝",
	"instanceAi.gatewayConfirmation.prompt": "允许 AI 助手在计算机使用时访问 '{resources}' 吗？",
	"instanceAi.askUser.placeholder": "请输入你的答案…",
	"instanceAi.askUser.submit": "提交",
	"instanceAi.askUser.skip": "跳过",
	"instanceAi.domainAccess.prompt": "允许 AI 助手访问 {domain}？",
	...
	"instanceAi.webSearch.prompt": "AI 助手想在网上搜索信息",
	"instanceAi.webSearch.allowThread": "始终允许",
	"instanceAi.settings.permissions.fetchUrl.label": "无需批准即可获取 URL",
	"instanceAi.credential.selected": "已选择的凭据",
	"instanceAi.credential.required": "此操作需要凭据",
	"instanceAi.credential.allSelected": "所有凭据已配置",
	"instanceAi.credential.useSelected": "使用所选项",
	"instanceAi.credential.deny": "稍后",
	"instanceAi.credential.confirmAll": "确认所有凭据",
	"instanceAi.credential.autoSetup": "自动配置",
	"instanceAi.credential.autoSetupStarted": "自动凭据配置已启动",
	"instanceAi.credential.finalize.applyCredentials": "应用凭据",
	...
	"instanceAi.credential.modal.title": "设置凭据",
	...
	"instanceAi.workflowSetup.triggerSuccess": "触发测试通过",
	"instanceAi.workflowSetup.triggerError": "触发测试失败",
	"instanceAi.workflowSetup.triggerListening": "正在监听事件…",
	"instanceAi.workflowSetup.apply": "应用",
	"instanceAi.workflowSetup.credentialTestFailedTooltip": "凭据测试失败。请更新凭据后再试一次。",
	"instanceAi.workflowSetup.applyCompleted": "应用已完成",
	"instanceAi.workflowSetup.later": "暂时跳过设置",
	"instanceAi.workflowSetup.loading": "正在加载设置…",
	"instanceAi.workflowSetup.applying": "正在应用更改…",
	"instanceAi.workflowSetup.applied": "工作流已配置",
	"instanceAi.workflowSetup.partiallyApplied": "部分配置完成 — 某些节点已跳过",
	"instanceAi.workflowSetup.deferred": "已跳过 — 稍后配置",
	"instanceAi.workflowSetup.cardSkipped": "已跳过",
	"instanceAi.workflowSetup.selectOption": "请选择一个选项",
	"instanceAi.workflowSetup.confirmTitle": "准备申请",
	"instanceAi.workflowSetup.confirmDescription": "{count} 项已配置 | {count} 项已配置",
	"instanceAi.workflowSetup.reviewDetails": "查看详情",
	"instanceAi.workflowSetup.stepCounter": "{current} / {total}",
	"instanceAi.workflowSetup.prevStep": "上一步",
	"instanceAi.workflowSetup.nextStep": "下一步",
	"instanceAi.debug.title": "调试",
	"instanceAi.debug.copyTrace": "复制跟踪",
	"instanceAi.debug.timing": "定时",
	...
	"instanceAi.debug.threads.noThreads": "Mastra 存储中未找到任何线程",
	...
	"instanceAi.settings.section.memory": "内存",
	"instanceAi.settings.section.sandbox": "沙盒",
	"instanceAi.settings.section.search": "搜索",
	"instanceAi.settings.section.advanced": "高级",
	"instanceAi.settings.credential.label": "凭据",
	"instanceAi.settings.credential.placeholder": "选择一个凭据...",
	...
	"instanceAi.settings.credential.createSearxng": "+ 创建 SearXNG 凭据",
	...
	"instanceAi.settings.sandboxEnabled.label": "启用沙箱",
	"instanceAi.settings.sandboxProvider.label": "沙箱提供者",
	"instanceAi.settings.daytonaCredential.label": "Daytona 凭据",
	"instanceAi.settings.n8nSandboxCredential.label": "n8n 沙箱 API 密钥凭据",
	"instanceAi.settings.sandboxImage.label": "沙盒 Docker 镜像",
	"instanceAi.settings.sandboxTimeout.label": "沙箱超时（毫秒）",
	"instanceAi.settings.searchCredential.label": "搜索凭证",
	"instanceAi.settings.subAgentMaxSteps.label": "子代理最大步数",
	"instanceAi.settings.browserMcp.label": "Chrome 开发者工具 MCP",
	...
	"instanceAi.settings.permissions.description": "切换在代理执行之前需要你批准的哪些操作。",
	"instanceAi.settings.permissions.createWorkflow.label": "创建无需批准的工作流",
	"instanceAi.settings.permissions.updateWorkflow.label": "无需批准即可更新工作流",
	"instanceAi.settings.permissions.runWorkflow.label": "无需审批即可运行工作流",
	"instanceAi.settings.permissions.publishWorkflow.label": "无需批准即可发布/取消发布工作流",
	"instanceAi.settings.permissions.deleteWorkflow.label": "在未获得批准的情况下删除工作流",
	"instanceAi.settings.permissions.deleteCredential.label": "未经批准删除凭据",
	"instanceAi.settings.permissions.deleteDataTable.label": "在未获得批准的情况下删除数据表",
	"instanceAi.builderCard.title": "正在构建工作流",
	"instanceAi.builderCard.phase.researching": "正在研究节点",
	"instanceAi.builderCard.phase.schemas": "正在加载模式",
	...
	"instanceAi.dataTableCard.title": "数据表管理",
	"instanceAi.dataTableCard.phase.checking": "正在检查表格",
	"instanceAi.dataTableCard.phase.schema": "修改模式",
	"instanceAi.dataTableCard.phase.rows": "管理行",
	"instanceAi.dataTableCard.details": "详情",
	...
	"instanceAi.artifactCard.updatedAgo": "最近更新 {time} 前",
	...
	"instanceAi.planReview.title": "在构建之前请进行审核",
	"instanceAi.planReview.titleResolved": "计划",
	"instanceAi.planReview.building": "正在制定计划...",
	"instanceAi.planReview.awaitingApproval": "等待批准",
	"instanceAi.planReview.description": "审阅该计划，然后批准它以开始构建，或请求变更以修订它。",
	"instanceAi.planReview.feedbackPlaceholder": "描述在执行开始之前应该发生的变化。",
	"instanceAi.planReview.requestChanges": "请求修改",
	"instanceAi.planReview.approve": "允许",
	"instanceAi.planReview.deny": "拒绝",
	"instanceAi.planReview.approved": "计划已批准",
	"instanceAi.message.retry": "重试",
	"instanceAi.input.amendPlaceholder": "修改 {role} 代理...",
	"instanceAi.fixWithAi.button": "使用人工智能进行修复",
	"instanceAi.fixWithAi.notice.title.single": "在 '{nodeName}' 节点中执行失败",
	"instanceAi.fixWithAi.notice.title.multiple": "{count} 个节点失败",
	"instanceAi.fixWithAi.notice.dismiss": "忽略",
	"instanceAi.fixWithAi.errorDetails": "错误详情",
	"instanceAi.fixWithAi.prompt.single": "“{nodeName}” 节点失败，原因是：“{errorMessage}”。请帮我调试并修复它。",
	"instanceAi.fixWithAi.prompt.singleInWorkflow": "位于工作流 \"{workflowName}\" 的 \"{nodeName}\" 节点失败，原因：“{errorMessage}”。请帮助我调试并修复它。",
	"instanceAi.fixWithAi.prompt.multiple": "这些节点失败了：\n{errorList}\n\n请帮我调试并修复它们",
	"instanceAi.fixWithAi.prompt.multipleInWorkflow": "在工作流 \"{workflowName}\" 中的这些节点失败了：\n{errorList}\n\n请帮我调试并修复它们",
	"instanceAi.fixWithAi.prompt.errorLine": "- \"{nodeName}\": {errorMessage}",
	"instanceAi.feedback.success": "感谢您的反馈！",
	"instanceAi.emptyState.title": "人工智能助手",
	"instanceAi.emptyState.suggestions.buildWorkflow.label": "创建一个工作流",
	"instanceAi.emptyState.suggestions.buildWorkflow.prompt": "我想创建一个新的工作流。帮我弄清楚要构建什么。问我最终目标是什么，应该由什么触发，以及涉及哪些应用或服务。",
	"instanceAi.emptyState.suggestions.buildAgent.label": "构建一个代理",
	"instanceAi.emptyState.suggestions.buildAgent.prompt": "我想构建一个新的智能体。请帮我弄清楚应该构建什么。问我该智能体的主要目标是什么、在什么情况下会触发它行动、它应该访问哪些应用、工具或知识，以及我对所使用的AI模型是否有偏好。",
	"instanceAi.emptyState.suggestions.findAutomationIdeas.label": "寻找灵感",
	"instanceAi.emptyState.suggestions.findAutomationIdeas.prompt": "我想用人工智能来自动化更多工作。请给我一些建议。请问我从事什么工作、我使用哪些应用，以及我希望能完成的任务。",
	"instanceAi.emptyState.suggestions.quickExamples.label": "快速示例",
	"instanceAi.emptyState.quickExamples.monitorCompetitors.label": "跟踪竞争对手新闻",
	"instanceAi.emptyState.quickExamples.monitorCompetitors.prompt": "每周一次，在 Google News 上搜索 Google 表格中列出的所有竞争对手的提及，使用 Claude 对在过去一周内发表的任何文章进行摘要，并将摘要发布到 Slack 的 #competitive-intel 频道。",
	"instanceAi.emptyState.quickExamples.automateInbox.label": "自动化我的收件箱",
	"instanceAi.emptyState.quickExamples.automateInbox.prompt": "每天早上，从 Gmail 阅读过去 24 小时内收到的所有电子邮件，使用 OpenAI 提取行动项并对其进行优先级排序，然后向我发送一份结构化的每日摘要邮件，概述需要我关注的事项。",
	"instanceAi.emptyState.quickExamples.answerSupportRequests.label": "对请求进行摘要并路由",
	"instanceAi.emptyState.quickExamples.answerSupportRequests.prompt": "当我们的 Outlook 收件箱收到新邮件时，使用 Claude 摘要潜在客户正在寻找的内容，评估其紧急程度和潜在价值，然后根据潜在客户的产品与地区在 Slack 通知相关人员。",
	"instanceAi.emptyState.quickExamples.analyseAdSpend.label": "用一个代理来回答问题",
	"instanceAi.emptyState.quickExamples.analyseAdSpend.prompt": "创建一个由 WhatsApp 消息触发的代理，从我们的 Google 文档知识库中获取相关信息，使用 Claude 生成答案，并在同一条 WhatsApp 对话中直接回复。",
	"instanceAi.emptyState.quickExamples.getNewsSummary.label": "监控库存水平",
	"instanceAi.emptyState.quickExamples.getNewsSummary.prompt": "每天两次，从 Google 表格读取库存水平，将少于 10 个单位的物品标记为严重缺货，少于 30 个单位的标记为低库存，然后让 Claude 起草一封用于 Gmail 的汇总邮件，以及个性化的补货邮件。",
	"instanceAi.emptyState.quickExamples.close": "关闭快速示例",
	"instanceAi.statusBar.thinking": "正在思考",
	"instanceAi.tools.workflows": "工作流",
	"instanceAi.tools.workflows.list": "列出工作流",
	"instanceAi.tools.workflows.get": "读取工作流",
	"instanceAi.tools.workflows.get-as-code": "读取工作流代码",
	"instanceAi.tools.workflows.delete": "归档工作流",
	"instanceAi.tools.workflows.delete.imperative": "归档工作流",
	"instanceAi.tools.workflows.unarchive.imperative": "还原已归档的工作流",
	"instanceAi.tools.workflows.setup": "设置工作流",
	"instanceAi.tools.workflows.validate": "正在验证工作流",
	"instanceAi.tools.workflows.publish": "发布工作流",
	"instanceAi.tools.workflows.publish.imperative": "发布工作流",
	"instanceAi.tools.workflows.unpublish": "取消发布工作流",
	"instanceAi.tools.workflows.unpublish.imperative": "取消发布工作流",
	"instanceAi.tools.workflows.list-versions": "列出工作流版本",
	"instanceAi.tools.workflows.get-version": "正在读取工作流版本",
	"instanceAi.tools.workflows.update-version": "正在更新工作流版本",
	"instanceAi.tools.workflows.update-version.imperative": "更新工作流版本",
	"instanceAi.tools.workflows.restore-version": "正在恢复工作流版本",
	"instanceAi.tools.workflows.restore-version.imperative": "恢复工作流版本",
	"instanceAi.tools.executions": "执行",
	"instanceAi.tools.executions.list": "正在检查执行情况",
	"instanceAi.tools.executions.get": "正在获取执行结果",
	"instanceAi.tools.executions.run": "正在运行工作流",
	"instanceAi.tools.executions.run.imperative": "执行工作流",
	"instanceAi.tools.executions.debug": "调试执行",
	"instanceAi.tools.executions.get-node-output": "读取节点输出",
	"instanceAi.tools.executions.stop": "停止执行",
	"instanceAi.tools.credentials": "凭证",
	"instanceAi.tools.credentials.list": "正在检查凭据",
	"instanceAi.tools.credentials.get": "读取凭证",
	"instanceAi.tools.credentials.delete": "正在删除凭据",
	"instanceAi.tools.credentials.delete.imperative": "删除凭据",
	"instanceAi.tools.credentials.search-types": "正在搜索凭证类型",
	"instanceAi.tools.credentials.setup": "设置凭据",
	"instanceAi.tools.credentials.test": "测试凭证",
	"instanceAi.tools.data-tables": "数据表",
	"instanceAi.tools.data-tables.list": "列出数据表",
	"instanceAi.tools.data-tables.schema": "读取数据表结构",
	"instanceAi.tools.data-tables.query": "查询数据",
	"instanceAi.tools.data-tables.create": "创建数据表",
	"instanceAi.tools.data-tables.create.imperative": "创建数据表",
	"instanceAi.tools.data-tables.delete": "删除数据表",
	"instanceAi.tools.data-tables.delete.imperative": "删除数据表",
	"instanceAi.tools.data-tables.add-column": "添加表列",
	"instanceAi.tools.data-tables.add-column.imperative": "添加列",
	"instanceAi.tools.data-tables.delete-column": "删除表列",
	"instanceAi.tools.data-tables.delete-column.imperative": "删除列",
	"instanceAi.tools.data-tables.rename-column": "重命名表列",
	"instanceAi.tools.data-tables.rename-column.imperative": "重命名列",
	"instanceAi.tools.data-tables.insert-rows": "正在插入多行",
	"instanceAi.tools.data-tables.insert-rows.imperative": "插入行",
	"instanceAi.tools.data-tables.update-rows": "正在更新多条记录",
	"instanceAi.tools.data-tables.update-rows.imperative": "更新行",
	"instanceAi.tools.data-tables.delete-rows": "删除行",
	"instanceAi.tools.data-tables.delete-rows.imperative": "删除行",
	"instanceAi.tools.workspace": "工作区",
	"instanceAi.tools.workspace.list-projects": "项目列表",
	"instanceAi.tools.workspace.list-tags": "列出标签",
	"instanceAi.tools.workspace.tag-workflow": "标记工作流",
	"instanceAi.tools.workspace.tag-workflow.imperative": "标记工作流",
	"instanceAi.tools.workspace.cleanup-test-executions": "清理测试执行",
	"instanceAi.tools.workspace.cleanup-test-executions.imperative": "删除测试执行",
	"instanceAi.tools.workspace.list-folders": "列出文件夹",
	"instanceAi.tools.workspace.create-folder": "创建文件夹",
	"instanceAi.tools.workspace.create-folder.imperative": "创建文件夹",
	"instanceAi.tools.workspace.delete-folder": "正在删除文件夹",
	"instanceAi.tools.workspace.delete-folder.imperative": "删除文件夹",
	"instanceAi.tools.workspace.move-workflow-to-folder": "将工作流程移动到文件夹",
	"instanceAi.tools.workspace.move-workflow-to-folder.imperative": "移动工作流",
	"instanceAi.tools.research": "研究",
	"instanceAi.tools.research.web-search": "正在网上搜索",
	"instanceAi.tools.research.fetch-url": "正在获取页面",
	"instanceAi.tools.filesystem": "文件系统",
	"instanceAi.tools.filesystem.list": "列出文件",
	"instanceAi.tools.filesystem.read": "读取文件",
	"instanceAi.tools.filesystem.search": "正在搜索文件",
	"instanceAi.tools.filesystem.tree": "读取文件树",
	"instanceAi.tools.nodes": "节点",
	"instanceAi.tools.nodes.list": "正在列出可用节点",
	"instanceAi.tools.nodes.search": "正在搜索节点",
	"instanceAi.tools.nodes.describe": "正在读取节点详细信息",
	"instanceAi.tools.nodes.type-definition": "正在加载节点模式",
	"instanceAi.tools.nodes.suggested": "正在获取建议的节点",
	"instanceAi.tools.nodes.explore-resources": "探索节点资源",
	"instanceAi.tools.templates": "模板",
	"instanceAi.tools.templates.search-structures": "正在搜索模板结构",
	"instanceAi.tools.templates.search-parameters": "正在搜索模板",
	"instanceAi.tools.templates.best-practices": "加载最佳实践",
	"instanceAi.tools.task-control": "任务控制",
	"instanceAi.tools.task-control.update-checklist": "正在更新任务",
	"instanceAi.tools.task-control.cancel-task": "取消任务",
	"instanceAi.tools.task-control.correct-task": "纠正任务",
	"instanceAi.tools.search-nodes": "正在搜索节点",
	...
	"instanceAi.tools.get-suggested-nodes": "获取推荐节点",
	"instanceAi.tools.list-nodes": "列出可用节点",
	"instanceAi.tools.get-workflow-as-code": "读取工作流代码",
	"instanceAi.tools.build-workflow": "正在生成工作流",
	"instanceAi.tools.submit-workflow": "正在提交工作流",
	"instanceAi.tools.list-workflows": "工作流列表",
	"instanceAi.tools.get-workflow": "读取工作流",
	"instanceAi.tools.delete-workflow": "归档工作流",
	"instanceAi.tools.activate-workflow": "正在激活工作流",
	"instanceAi.tools.materialize-node-type": "正在安装节点类型",
	"instanceAi.tools.write-file": "正在写入文件",
	"instanceAi.tools.list-executions": "正在检查执行",
	"instanceAi.tools.run-workflow": "正在运行工作流",
	"instanceAi.tools.get-execution": "正在获取执行结果",
	"instanceAi.tools.debug-execution": "调试执行",
	"instanceAi.tools.stop-execution": "正在停止执行",
	...
	"instanceAi.tools.delete-data-table": "正在删除数据表",
	"instanceAi.tools.add-data-table-column": "添加表格列",
	"instanceAi.tools.delete-data-table-column": "删除表格列",
	"instanceAi.tools.rename-data-table-column": "重命名表中的列",
	"instanceAi.tools.query-data-table-rows": "查询数据",
	"instanceAi.tools.insert-data-table-rows": "正在插入多行",
	"instanceAi.tools.update-data-table-rows": "正在更新多行",
	"instanceAi.tools.delete-data-table-rows": "删除行",
	"instanceAi.tools.list-credentials": "正在验证凭据",
	"instanceAi.tools.get-credential": "正在读取凭据",
	"instanceAi.tools.test-credential": "测试凭据",
	"instanceAi.tools.setup-credentials": "设置凭据",
	"instanceAi.tools.delete-credential": "正在删除凭据",
	"instanceAi.tools.plan": "计划",
	"instanceAi.tools.list_skills": "检查可用技能",
	"instanceAi.tools.load_skill": "开场技能",
	"instanceAi.tools.load_skill.asset": "打开",
	"instanceAi.tools.load_skill.assetFallback": "资产",
	"instanceAi.tools.load_skill.example": "阅读",
	"instanceAi.tools.load_skill.exampleFallback": "示例",
	"instanceAi.tools.load_skill.file": "阅读",
	"instanceAi.tools.load_skill.reference": "阅读",
	"instanceAi.tools.load_skill.referenceFallback": "参考",
	"instanceAi.tools.load_skill.script": "检查",
	"instanceAi.tools.load_skill.scriptFallback": "脚本",
	"instanceAi.tools.load_skill.template": "阅读",
	"instanceAi.tools.load_skill.templateFallback": "模板",
	"instanceAi.tools.delegate": "委派任务",
	"instanceAi.tools.web-search": "正在网上搜索",
	"instanceAi.tools.fetch-url": "正在获取页面",
	"instanceAi.tools.build-workflow-with-agent": "正在构建工作流",
	"instanceAi.tools.build-workflow-with-agent.imperative": "编辑工作流",
	"instanceAi.tools.browser-credential-setup": "在浏览器中设置凭据",
	"instanceAi.tools.get-best-practices": "正在加载最佳实践",
	"instanceAi.tools.search-template-parameters": "正在搜索模板",
	"instanceAi.tools.search-template-structures": "正在搜索模板结构",
	"instanceAi.tools.ask-user": "正在询问用户",
	"instanceAi.tools.cancel-background-task": "正在取消任务",
	"instanceAi.tools.correct-background-task": "纠正任务",
	"instanceAi.tools.pause-for-user": "等待输入",
	"instanceAi.tools.update-tasks": "正在更新任务",
	"instanceAi.tools.report-verification-verdict": "正在验证工作流",
	"instanceAi.tools.verify-built-workflow": "正在验证工作流",
	"instanceAi.tools.complete-checkpoint": "正在完成检查点",
	"instanceAi.tools.updateWorkingMemory": "正在更新内存",
	"instanceAi.tools.apply-workflow-credentials": "正在应用凭据",
	"instanceAi.tools.setup-workflow": "设置工作流",
	"instanceAi.tools.publish-workflow": "发布工作流",
	"instanceAi.tools.unpublish-workflow": "取消发布工作流",
	"instanceAi.tools.tag-workflow": "标记工作流",
	"instanceAi.tools.move-workflow-to-folder": "将工作流移动到文件夹",
	"instanceAi.tools.get-workflow-version": "正在读取工作流版本",
	"instanceAi.tools.list-workflow-versions": "列出工作流版本",
	"instanceAi.tools.update-workflow-version": "正在更新工作流版本",
	...
	"instanceAi.tools.create-folder": "正在创建文件夹",
	"instanceAi.tools.delete-folder": "正在删除文件夹",
	"instanceAi.tools.list-folders": "列出文件夹",
	"instanceAi.tools.list-projects": "列出项目",
	"instanceAi.tools.list-tags": "标签列表",
	"instanceAi.tools.get-file-tree": "正在读取文件树",
	"instanceAi.tools.list-files": "列出文件",
	"instanceAi.tools.read-file": "正在读取文件",
	"instanceAi.tools.search-files": "正在搜索文件",
	"instanceAi.tools.parse-file": "正在解析文件",
	"instanceAi.tools.workspace_read_file": "正在读取文件",
	"instanceAi.tools.workspace_write_file": "正在写入文件",
	"instanceAi.tools.workspace_edit_file": "正在编辑文件",
	"instanceAi.tools.workspace_str_replace_file": "正在编辑文件",
	"instanceAi.tools.workspace_batch_str_replace_file": "编辑文件",
	"instanceAi.tools.workspace_append_file": "正在追加文件",
	"instanceAi.tools.workspace_list_files": "正在列出文件",
	"instanceAi.tools.workspace_delete": "正在删除文件",
	"instanceAi.tools.workspace_delete_file": "正在删除文件",
	"instanceAi.tools.workspace_file_stat": "正在检查文件信息",
	"instanceAi.tools.workspace_mkdir": "正在创建目录",
	"instanceAi.tools.workspace_rmdir": "正在删除目录",
	"instanceAi.tools.workspace_copy_file": "正在复制文件",
	"instanceAi.tools.workspace_move_file": "正在移动文件",
	"instanceAi.tools.workspace_grep": "正在搜索文件",
	"instanceAi.tools.workspace_ast_edit": "编辑代码",
	"instanceAi.tools.workspace_execute_command": "正在运行命令",
	"instanceAi.tools.workspace_execute_command.skill": "运行技能脚本",
	"instanceAi.tools.workspace_execute_command.skillScript": "运行",
	"instanceAi.tools.workspace_get_process_output": "正在读取进程输出",
	"instanceAi.tools.workspace_list_processes": "正在列出进程",
	"instanceAi.tools.workspace_kill_process": "正在停止进程",
	"instanceAi.tools.workspace_search": "正在搜索工作区",
	"instanceAi.tools.workspace_index": "索引工作区",
	"instanceAi.stepTimeline.showData": "显示数据",
	"instanceAi.stepTimeline.hideData": "隐藏数据",
	"instanceAi.stepTimeline.showBrief": "显示摘要",
	"instanceAi.stepTimeline.hideBrief": "隐藏摘要",
	"instanceAi.stepTimeline.done": "完成",
	"instanceAi.stepTimeline.craftingWorkflow": "构建工作流",
	...
	"projects.menu.instanceAi": "人工智能助手",
	"chatInputBase.button.attach": "添加附件",
	"instanceAi.filesystem.access.read": "只读",
	"instanceAi.filesystem.access.readWrite": "读写",
	...
	"instanceAi.filesystem.category.shell": "Shell（命令行界面）",
	"instanceAi.settings.permissions.activateWorkflow.label": "无需批准即可激活工作流",
	"instanceAi.tools.patch-workflow": "正在更新工作流",
	"agents.home.untitledAgent": "未命名的代理",
	"agents.relativeTime.justNow": "刚刚",
	"agents.relativeTime.secondsAgo": "{count}秒前",
	"agents.relativeTime.minutesAgo": "{count}分钟前",
	"agents.relativeTime.hoursAgo": "{count}小时前",
	"agents.relativeTime.yesterday": "昨天",
	"agents.sort.lastUpdated": "按最近更新排序",
	"agents.sort.lastCreated": "按最近创建日期排序",
	"agents.sort.nameAsc": "按名称排序（A-Z）",
	"agents.sort.nameDesc": "按名称排序（Z-A）",
	"agents.builder.save": "保存",
	"agents.builder.deleteAgent": "删除代理",
	"agents.delete.modal.title": "删除 \"{name}\"？",
	"agents.delete.modal.description": "您确定要删除 \"{name}\" 吗？此操作无法撤销。",
	"agents.delete.modal.button.delete": "删除",
	"agents.builder.saveError": "无法保存代理设置",
	"agents.builder.chatColumn.ariaLabel": "聊天",
	"agents.builder.chatMode.build": "构建",
	"agents.builder.chatMode.test": "测试",
	"agents.builder.chatMode.ariaLabel": "在构建器和代理聊天之间切换",
	"agents.builder.chatMode.test.lockedTooltip": "完成构建你的代理，以便与它聊天",
	"agents.builder.chat.sessionPicker.ariaLabel": "会话历史",
	"agents.builder.chat.sessionPicker.empty": "没有之前的聊天记录",
	"agents.builder.chat.newChat.ariaLabel": "开始新的聊天",
	"agents.builder.chat.newChat.label": "新聊天",
	"agents.builder.chat.fullWidth.expand.ariaLabel": "展开",
	"agents.builder.chat.fullWidth.collapse.ariaLabel": "折叠",
	"agents.chat.loadHistory.error": "无法加载聊天记录",
	"agents.chat.clearHistory.error": "无法清除聊天记录",
	"agents.chat.clearHistory": "清除聊天记录",
	"agents.chat.input.placeholder": "输入一条消息…",
	"agents.chat.answerQuestionPlaceholder": "请回答上面的提问以继续",
	"agents.chat.misconfigured.title": "该代理尚未准备好运行。",
	"agents.chat.misconfigured.missingPrefix": "缺失：",
	"agents.chat.misconfigured.missing.instructions": "使用说明",
	"agents.chat.misconfigured.missing.model": "模型",
	"agents.chat.misconfigured.missing.credential": "凭据",
	"agents.chat.misconfigured.missing.episodicMemory.credential": "情景记忆凭证",
	"agents.chat.misconfigured.missing.agent": "代理",
	"agents.chat.misconfigured.missing.skill": "技能 ({id})",
	"agents.chat.misconfigured.openBuild": "在构建阶段完成设置",
	"agents.chat.misconfigured.dismiss": "关闭",
	"agents.chat.askCredential.skip": "跳过",
	"agents.chat.askQuestion.otherLabel": "其他",
	"agents.chat.askQuestion.otherPlaceholder": "再输入一个答案",
	"agents.chat.askQuestion.submit": "提交",
	"agents.heading": "代理",
	"agents.list.published": "已发布",
	"agents.list.noDescription": "没有描述",
	"agents.list.updatedAt": "已更新 {date}",
	"agents.list.updated": "最近更新",
	"agents.list.created": "已创建",
	"agents.list.empty.heading": "尚无代理",
	"agents.list.empty.description": "创建你的第一个代理，以自动化任务并利用你已连接的工具和数据来回答问题。",
	"agents.list.empty.button.label": "创建代理",
	"agents.list.empty.button.disabled.tooltip": "你在该项目中的当前角色不允许你创建代理。",
	"agents.list.actions.publish": "发布",
	"agents.list.actions.unpublish": "取消发布",
	"agents.list.actions.delete": "删除",
	"agents.list.readonly": "只读",
	"agents.publish.button.publish": "发布",
	"agents.publish.button.published": "已发布",
	"agents.publish.dropdown.publish": "发布",
	"agents.publish.dropdown.revertToPublished": "撤销更改",
	"agents.publish.dropdown.unpublish": "取消发布",
	"agents.publish.dropdown.ariaLabel": "更多发布操作",
	"agents.publish.toast.published": "代理已发布",
	"agents.publish.toast.reverted": "已回滚到已发布版本",
	"agents.publish.toast.unpublished": "代理未发布",
	"agents.publish.error.publish": "发布代理失败",
	"agents.publish.error.revert": "无法将代理回滚到已发布版本。",
	"agents.publish.error.unpublish": "取消发布代理失败",
	"agents.schedule.title": "计划",
	"agents.schedule.description": "按计划运行已发布的代理。",
	"agents.schedule.status.active": "启用",
	"agents.schedule.status.inactive": "未激活",
	"agents.schedule.cron": "计划",
	"agents.schedule.cron.mode.custom": "表达式",
	"agents.schedule.cron.mode.preset": "预设",
	"agents.schedule.cron.placeholder": "* * * * *",
	"agents.schedule.nextOccurrence": "下一次出现：{occurrence}",
	"agents.schedule.presets.everyDay": "每天",
	"agents.schedule.presets.everyHour": "每小时",
	"agents.schedule.presets.everyMonday": "每周一",
	"agents.schedule.presets.everyWeekday": "每个工作日",
	"agents.schedule.wakeUpPrompt": "唤醒提示",
	"agents.schedule.wakeUpPrompt.placeholder": "自动消息：您已按计划被触发。",
	"agents.schedule.wakeUpPrompt.help": "在每次计划触发时发送给代理。",
	"agents.schedule.publishRequired": "在激活计划触发器之前先发布代理。",
	"agents.schedule.activate": "启用",
	"agents.schedule.deactivate": "停用",
	"agents.schedule.loadError": "无法加载计划触发器",
	"agents.schedule.saveError": "无法保存计划触发器",
	"agents.schedule.activateError": "无法激活计划触发器",
	"agents.schedule.deactivateError": "无法停用计划触发器",
	"agents.unpublish.modal.title": "取消发布 {name}",
	"agents.unpublish.modal.description": "这将阻止所有生产环境中的执行在你再次发布之前使用此代理。",
	"agents.unpublish.modal.button.unpublish": "取消发布",
	"agents.revertToPublished.modal.title": "还原更改？",
	"agents.revertToPublished.modal.description": "这将永久删除自最新发布版本以来所做的所有更改。",
	"agents.revertToPublished.modal.button.revert": "撤销更改",
	"agents.search.placeholder": "搜索代理人...",
	"agents.tools.title": "工具",
	"agents.tools.add": "添加工具",
	"agents.tools.search.placeholder": "搜索工具",
	"agents.tools.availableTools": "可用工具 ({count})",
	"agents.tools.availableWorkflows": "工作流程（{count}）",
	"agents.tools.noResults": "没有可用的工具",
	"agents.tools.noResults.withQuery": "没有与“{query}”匹配的工具。请尝试使用不同的关键词。",
	"agents.tools.configure": "配置",
	"agents.tools.connect": "连接",
	"agents.tools.added": "工具已添加",
	"agents.tools.connected": "已连接",
	"agents.tools.addCredentials": "添加凭据",
	"agents.tools.noCredentials": "没有凭据",
	"agents.tools.workflow.incompatible.title": "工作流不兼容",
	"agents.tools.workflow.incompatible.message": "工作流“{name}”包含不能用作代理工具的节点：{nodes}。",
	"agents.tools.workflow.fetchFailed.title": "无法检查工作流兼容性",
	"agents.tools.workflow.fetchFailed.message": "请再次尝试连接工作流。",
	"agents.toolConfig.workflow.description": "描述",
	"agents.toolConfig.workflow.description.placeholder": "向代理解释何时应使用此工作流以及它的作用。",
	"agents.toolConfig.workflow.description.hint": "LLM 读取此内容以决定何时调用工作流。",
	"agents.toolConfig.workflow.allOutputs": "返回所有节点的输出",
	"agents.toolConfig.workflow.allOutputs.hint": "关闭时，只返回最后一个节点的输出。",
	"agents.toolConfig.save": "保存",
	"agents.toolConfig.cancel": "取消",
	"agents.new.title": "新建代理",
	"agents.new.defaultName": "新建代理",
	"agents.new.startBlank": "从空白开始",
	"agents.new.heading": "我们应该开发什么？",
	"agents.new.headingWithName": "我们应该构建什么，{name}？",
	"agents.new.description.placeholder": "描述你的代理人...",
	"agents.new.templates.label": "或者试用一个模板",
	"agents.builder.readonly.placeholder": "你没有权限编辑此代理",
	"agents.builder.sections.agent": "代理",
	"agents.builder.sections.advanced": "高级",
	"agents.builder.sections.configJson": "原始",
	"agents.builder.sections.evaluations": "评估",
	"agents.builder.sections.evaluations.comingSoon": "敬请期待",
	"agents.builder.sections.executions": "会话",
	"agents.builder.sections.guardrails": "护栏",
	"agents.builder.sections.instructions": "说明",
	"agents.builder.sections.memory": "会话内存",
	"agents.builder.sections.model": "模型",
	"agents.builder.sections.skills": "技能",
	"agents.builder.sections.tools": "工具",
	"agents.builder.sections.triggers": "触发器",
	"agents.builder.agent.title": "代理",
	"agents.builder.agent.description": "定义该代理行为的核心设置",
	"agents.builder.agent.name.label": "名称",
	"agents.builder.agent.name.placeholder": "我的代理人",
	"agents.builder.agent.description.label": "描述",
	"agents.builder.agent.description.placeholder": "这个代理做什么？",
	"agents.builder.agent.model.label": "模型",
	"agents.builder.agent.instructions.label": "说明",
	"agents.builder.agent.instructions.characterCount": "{count} 个字符",
	"agents.builder.advanced.title": "高级",
	"agents.builder.advanced.description": "执行调优——推理深度、工具并行性和审批门控。",
	"agents.builder.advanced.thinking.label": "思考中",
	"agents.builder.advanced.thinking.hint": "让模型在回应前进行推理。",
	"agents.builder.advanced.thinking.unsupportedTooltip": "{provider} 不支持思考",
	"agents.builder.advanced.thinking.unsupportedProviderFallback": "本提供者",
	"agents.builder.advanced.budgetTokens.label": "预算令牌",
	"agents.builder.advanced.reasoningEffort.label": "推理成本",
	"agents.builder.advanced.concurrency.label": "工具调用并发",
	"agents.builder.advanced.concurrency.hint": "代理可以同时执行多少个工具调用？",
	"agents.builder.advanced.approval.label": "需要工具审批",
	"agents.builder.advanced.approval.hint": "在运行工具调用之前暂停，直到获得人工批准。",
	"agents.builder.advanced.recentMessages.label": "会话内存窗口",
	"agents.builder.advanced.recentMessages.hint": "在每次回合中，代理能看到该线程的最近多少条消息？",
	"agents.builder.advanced.recentMessages.memoryDisabledTooltip": "在内存部分启用会话内存以配置窗口。",
	"agents.builder.advanced.maxIterations.label": "最大迭代次数",
	"agents.builder.advanced.maxIterations.hint": "每次运行的代理循环迭代最大次数（1–200）。留空以使用平台默认值。",
	"agents.builder.memory.title": "会话内存",
	"agents.builder.memory.description": "将本会话中的最近消息保留为上下文。",
	"agents.builder.memory.episodicMemory.label": "情节记忆",
	"agents.builder.memory.episodicMemory.hint": "存储来自先前对话的有出处的记忆。",
	"agents.builder.memory.episodicMemory.changeCredential": "更改凭据",
	"agents.builder.episodicMemoryCredentialModal.title": "连接情景记忆",
	"agents.builder.episodicMemoryCredentialModal.description": "选择用于为情景记忆创建嵌入的 OpenAI 凭据。",
	"agents.builder.episodicMemoryCredentialModal.confirm": "启用情景记忆",
	"agents.builder.memory.semanticRecall.topK": "前 K 个",
	"agents.builder.memory.semanticRecall.rangeBefore": "之前的范围",
	"agents.builder.memory.semanticRecall.rangeAfter": "后续范围",
	"agents.builder.editor.copy": "复制到剪贴板",
	"agents.builder.editor.copied": "已复制",
	"agents.builder.progress.building.title": "正在构建您的代理……",
	"agents.builder.progress.building.hint": "这通常需要 30–60 秒。请稍等。",
	"agents.builder.progress.error.title": "出现了错误",
	"agents.builder.progress.error.hint": "请查看下面的日志并重试。",
	"agents.builder.tools.title": "工具",
	"agents.builder.tools.count": "{count} 个工具已配置 | {count} 个工具已配置",
	"agents.builder.tools.add": "添加工具",
	"agents.builder.tools.builtIn.title": "内置节点工具",
	"agents.builder.tools.builtIn.hint": "让代理搜索 n8n 节点目录并按需执行节点。",
	"agents.builder.tools.empty": "尚未添加任何工具。",
	"agents.builder.tools.type.workflow": "工作流",
	"agents.builder.tools.type.custom": "自定义工具",
	"agents.builder.tools.workflows.title": "工作流",
	"agents.builder.tools.remove": "移除工具",
	"agents.builder.tools.back": "返回工具",
	"agents.builder.skills.title": "技能",
	"agents.builder.skills.count": "{count} 个技能已应用 | {count} 个技能已应用",
	"agents.builder.skills.add": "添加技能",
	"agents.builder.skills.empty": "尚未应用任何技能。",
	"agents.builder.skills.instructions": "说明",
	"agents.builder.skills.name.label": "标题",
	"agents.builder.skills.name.placeholder": "总结会议",
	"agents.builder.skills.description.label": "描述",
	"agents.builder.skills.description.placeholder": "在总结会议或笔记时使用。",
	"agents.builder.skills.instructions.label": "说明",
	"agents.builder.skills.instructions.characterCount": "{count} / {max} 字符",
	"agents.builder.skills.instructions.file.upload": "上传 .txt 或 .md",
	"agents.builder.skills.instructions.file.invalidType": "上传一个 .txt 或 .md 文件。",
	"agents.builder.skills.instructions.file.readError": "无法读取该文件。",
	"agents.builder.skills.create.title": "添加技能",
	"agents.builder.skills.create.cancel": "取消",
	"agents.builder.skills.create.save": "保存技能",
	"agents.builder.skills.create.error": "无法创建技能",
	"agents.builder.skills.added": "技能已添加",
	"agents.builder.skills.saveError": "无法保存技能",
	"agents.builder.skills.validation.nameRequired": "输入标题。",
	"agents.builder.skills.validation.nameMaxLength": "标题必须为 128 个字符或更少。",
	"agents.builder.skills.validation.descriptionRequired": "请输入描述。",
	"agents.builder.skills.validation.descriptionMaxLength": "描述长度不得超过 512 个字符。",
	"agents.builder.skills.validation.instructionsRequired": "请输入指令。",
	"agents.builder.skills.validation.instructionsMaxLength": "指令必须为{max}个字符或更少。",
	"agents.builder.skills.remove": "移除技能",
	"agents.builder.skills.back": "返回技能",
	"agents.builder.editor.invalidJson": "无效的 JSON",
	"agents.builder.editorColumn.ariaLabel": "配置编辑器",
	"agents.builder.tree.ariaLabel": "配置部分",
	"agents.builder.tree.empty": "尚无章节",
	"agents.builder.tree.toolFallback": "工具 {index}",
	"agents.builder.tree.customBadge": "自定义",
	"agents.builder.tree.foldersEmpty": "暂无项目",
	"agents.builder.header.executions": "执行",
	"agents.builder.header.tab.agent": "代理人",
	"agents.builder.header.tab.executions": "会话",
	"agents.builder.header.tab.memory": "内存",
	"agents.builder.header.tab.evaluations": "评估",
	"agents.builder.header.tab.raw": "原始",
	"agents.builder.header.workspaceCrumb": "工作区",
	"agents.builder.header.projectFallback": "项目",
	"agents.builder.header.switcher.empty": "没有其他代理",
	"agents.builder.header.switcher.newAgent": "新代理",
	"agents.builder.header.switcher.ariaLabel": "切换代理",
	"agents.builder.header.saving": "正在保存…",
	"agents.builder.header.saved": "已保存",
	"agents.builder.preview.button": "预览",
	"agents.builder.preview.disabledTooltip": "请在预览此代理之前添加指令、一个模型和凭据。",
	"agents.builder.preview.close.ariaLabel": "关闭预览",
	"agents.builder.executions.count": "{count} 个会话 | {count} 个会话",
	"agents.builder.raw.description": "代理 JSON 配置",
	"agents.builder.evaluations.comingSoon": "评估功能即将推出。",
	"agents.builder.evaluations.configuredInCode": "在代码中配置了 {count} 个评估 | 在代码中配置了 {count} 个评估",
	"agents.builder.evaluations.type.check": "检查",
	"agents.builder.evaluations.type.judge": "判断",
	"agents.builder.evaluations.credentialConfigured": "凭据已配置",
	"agents.builder.evaluations.emptyPrefix": "未配置评估。",
	"agents.builder.quickActions.addTool": "添加工具",
	"agents.builder.quickActions.addTrigger": "添加触发器",
	"agents.builder.capabilities.title": "功能",
	"agents.builder.triggers.title": "触发器",
	"agents.builder.triggers.description": "可调用此代理的通道",
	"agents.builder.triggers.count": "{count} 个触发器已连接 | {count} 个触发器已连接",
	"agents.builder.triggers.empty": "尚未连接任何触发器。",
	"agents.builder.triggers.add": "添加触发器",
	"agents.builder.triggers.empty.title": "未配置触发器",
	"agents.builder.triggers.empty.description": "添加一个触发器，让该代理对来自聊天平台的事件做出响应，或按计划运行。",
	"agents.builder.addTrigger.modal.title": "添加触发器",
	"agents.builder.addTrigger.modal.description": "添加一个触发器，允许向代理发送消息，或将其排程为定期执行任务。",
	"agents.builder.addTrigger.picker.label": "触发器",
	"agents.builder.addTrigger.picker.placeholder": "选择一个触发器...",
	"agents.builder.addTrigger.picker.empty": "在上方选择一个触发器进行配置。",
	"agents.builder.addTrigger.status.connected": "已连接",
	"agents.builder.addTrigger.status.disconnected": "已断开连接",
	"agents.builder.addTrigger.credential": "凭据",
	"agents.builder.addTrigger.selectCredential": "请选择一个凭据…",
	"agents.builder.addTrigger.editCredential": "编辑凭据",
	"agents.builder.addTrigger.noCredentials": "未找到 {label} 的凭据。",
	"agents.builder.addTrigger.addCredential": "添加 {label} 凭证",
	"agents.builder.addTrigger.newCredential": "新建凭据",
	"agents.builder.addTrigger.connect": "连接",
	"agents.builder.addTrigger.publishPrompt.title": "发布代理以连接触发器",
	"agents.builder.addTrigger.publishPrompt.description": "触发器只能连接到已发布的代理。现在发布此代理并连接触发器吗？",
	"agents.builder.addTrigger.publishPrompt.confirm": "发布并连接",
	"agents.builder.addTrigger.disconnect": "断开连接",
	"agents.builder.addTrigger.copy": "复制",
	"agents.builder.addTrigger.copied": "已复制",
	"agents.builder.addTrigger.noIntegrations": "没有可用的集成。",
	"agents.builder.addTrigger.slack.setup.title": "创建 Slack 应用",
	"agents.builder.addTrigger.slack.setup.hint": "输入临时的 Slack 应用配置令牌。n8n 将创建该应用、安装它，并连接此代理。",
	"agents.builder.addTrigger.slack.setup.tokenPlaceholder": "应用程序配置令牌",
	"agents.builder.addTrigger.slack.setup.tokenLink": "在 Slack 中创建一个。",
	"agents.builder.addTrigger.slack.setup.button": "创建并安装",
	"agents.builder.addTrigger.slack.setup.error": "无法创建并安装 Slack 应用。",
	"agents.builder.addTrigger.slack.manual.title": "手动配置",
	"agents.builder.addTrigger.slack.manual.description": "如果你想手动创建 Slack 应用，请使用此应用清单来创建它，安装它，然后使用 Slack 机器人令牌和签名密钥创建 Slack 凭据。",
	"agents.builder.addTrigger.slack.manifestHint": "复制应用清单并将其粘贴到 Slack 应用的设置中，以配置事件、作用域和交互性。",
	"agents.builder.addTrigger.slack.viewJson": "查看 JSON",
	"agents.builder.addTrigger.slack.hideJson": "隐藏 JSON",
	"agents.builder.addTrigger.slack.copyManifest": "复制清单",
	"agents.builder.addTrigger.slack.manifestTitle": "Slack 应用清单",
	"agents.builder.addTrigger.slack.manifestLoading": "正在加载 Slack 应用清单...",
	"agents.builder.addTrigger.slack.manifestError": "无法加载 Slack 应用清单。请再试一次。",
	"agents.builder.addTrigger.slack.docsCalloutLink": "查看文档",
	"agents.builder.addTrigger.telegram.accessMode.label": "访问模式",
	"agents.builder.addTrigger.telegram.accessMode.private": "私有",
	"agents.builder.addTrigger.telegram.accessMode.public": "公开",
	"agents.builder.addTrigger.telegram.public.warning": "任何 Telegram 用户都可以与该代理聊天。",
	"agents.builder.addTrigger.telegram.users.label": "仅限用户",
	"agents.builder.addTrigger.telegram.users.placeholder": "输入一个用户ID或用户名，然后按空格键",
	"agents.builder.addTrigger.telegram.validation.invalid": "请输入有效的 Telegram 用户ID 或用户名。",
	"agents.builder.addTrigger.telegram.validation.required": "请至少添加一个 Telegram 用户ID或用户名。",
	"agents.builder.addTrigger.helpText.slack": "连接 Slack 机器人凭据以允许该代理接收并回复 Slack 消息。",
	"agents.builder.addTrigger.helpText.telegram": "连接一个 Telegram 机器人凭证，以便该代理能够接收并响应 Telegram 消息。",
	"agents.builder.addTrigger.helpText.linear": "连接一个 Linear API 凭据，使该代理能够对 Linear 问题中的评论进行回复。将 Linear webhook 指向下方的 URL，并将其签名密钥粘贴到凭据中。",
	"agents.builder.addTrigger.connectedText.slack": "您的代理已连接到 Slack，准备发送和接收消息。",
	"agents.builder.addTrigger.connectedText.telegram": "你的代理已连接到 Telegram，可以接收消息。",
	"agents.builder.addTrigger.connectedText.linear": "你的代理已连接到 Linear，能够对 @提及进行回复。",
	"instanceAi.welcomeModal.gateway.title": "将 AI 助手连接到你的电脑",
	"instanceAi.welcomeModal.gateway.description": "允许 AI 助手处理本地文件、运行终端命令，并控制你的浏览器，以帮助在你的机器上构建自动化流程。它通过 n8n Computer Use 连接，这是一个轻量级的本地进程，你可以随时断开连接。",
	"instanceAi.welcomeModal.gateway.warning": "AI 助手处于预览阶段，可能会出现不可预测的情况。请注意不要授权访问敏感数据。权限可以在设置过程中进行调整。",
	"instanceAi.welcomeModal.gateway.os.mac": "苹果电脑",
	"instanceAi.welcomeModal.gateway.os.windows": "Windows",
	"instanceAi.welcomeModal.gateway.os.linux": "Linux",
	"instanceAi.welcomeModal.gateway.waiting": "正在等待连接...",
	"instanceAi.welcomeModal.gateway.alreadyRunning": "已经在运行 <code>npx {'@'}n8n/computer-use</code> 吗？",
	"instanceAi.welcomeModal.gateway.connect": "连接",
	"instanceAi.welcomeModal.gateway.instructions.mac": "打开终端（按 Cmd + 空格，输入 \"Terminal\"）并粘贴下面的命令。",
	"instanceAi.welcomeModal.gateway.instructions.windows": "打开终端（按 Windows 键，输入“Terminal”）并粘贴下面的命令。",
	"instanceAi.welcomeModal.gateway.instructions.linux": "打开终端并粘贴下面的命令。",
	"instanceAi.welcomeModal.gateway.tokenExpiresIn": "令牌将在 {minutes} 分钟后过期",
	"instanceAi.welcomeModal.gateway.tokenExpired": "令牌已过期。请再次复制该命令。"
};
//#endregion
