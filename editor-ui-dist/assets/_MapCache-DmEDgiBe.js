...
var zh_CN_default = {
	...
	"settings.secretsProviderConnections.modal.testConnection.success.description": "已成功连接到 {providerName}",
	...
	"settings.secretsProviderConnections.modal.testConnection.error.serviceDisabled": "连接失败。无法连接到提供商。",
	...
	"projects.settings.role.contactAdmin.body": "你可以分配系统角色，但自定义角色需要先由实例管理员创建。请将文档分享给你的实例管理员，以便设置自定义角色。",
	"projects.settings.role.contactAdmin.bodyWithRoles": "您可以分配现有的自定义角色，但只有实例管理员可以创建新的自定义角色。如需新的自定义角色，请联系实例管理员。请在 {documentation} 中了解更多。",
	"projects.settings.role.upgrade.custom.title": "升级到企业版",
	"projects.settings.role.upgrade.custom.body": "要创建和管理自定义角色，您需要将计划升级到企业版。请在文档中了解更多信息。",
	...
	"projects.settings.externalSecrets.button.addSecretsStore": "添加机密存储",
	...
	"projects.settings.externalSecrets.table.header.provider": "密钥存储",
	...
	"setupPanel.everythingConfigured.message": "所有凭据已配置完毕。",
