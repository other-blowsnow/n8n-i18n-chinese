const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-B0XeDRnM.js","assets/chunk-CC9Q-vWm.js","assets/core-Cv3sKa7Y.js","assets/languageModules-DNHbC9nB.js","assets/xml-BrFE0qvZ.js"])))=>i.map(i=>d[i]);
...
import { ji as require_markdown_it_link_attributes, wa as N8nButton_default, zi as truncateBeforeLast } from "./src-4M_3Mukr.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-B0XeDRnM.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-DNHbC9nB.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
