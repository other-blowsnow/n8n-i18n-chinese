import { d as defineComponent, av as useProjectsStore, aw as useFoldersStore, r as ref, x as computed, c as useI18n, aG as ProjectTypes, a8 as watch, X as onBeforeUnmount, h as createElementBlock, g as openBlock, e as createBlock, f as createCommentVNode, bv as createSlots, w as withCtx, Y as renderSlot, i as createVNode, n as normalizeClass, en as N8nActionToggle, _ as _export_sfc, k as createTextVNode, j as createBaseVNode, t as toDisplayString, l as unref, a as useToast, Q as useUIStore, aA as useWorkflowHelpers, a2 as useWorkflowsStore, dh as useCredentialsStore, fu as getActivatableTriggerNodes, fv as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, a4 as PLACEHOLDER_EMPTY_WORKFLOW_ID, a9 as resolveComponent, cg as resolveDirective, p as N8nText, b3 as withDirectives, aa as Tooltip, N as N8nIcon, fw as OPEN_AI_API_CREDENTIAL_TYPE, fx as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, aX as h } from "./index-BXVCKjk6.js";
import { B as Breadcrumbs, _ as __unplugin_components_0$1 } from "./ProjectBreadcrumb-DJjEQuAF.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        visibleBreadcrumbsItems.value.length ? (openBlock(), createBlock(_component_N8nBreadcrumbs, {
          key: 0,
        ...
        visibleBreadcrumbsItems.value && _ctx.actions?.length ? (openBlock(), createBlock(_component_N8nActionToggle, {
          key: 3,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", {
          ...
          _ctx.workflowActive ? (openBlock(), createBlock(_component_N8nText, {
            key: 0,
            ...
            _: 1
          }, 8, ["color"])) : (openBlock(), createBlock(_component_N8nText, {
            key: 1,
            color: "text-base",
            size: "small",
            bold: ""
        ...
        createVNode(_component_N8nTooltip, {
          ...
          default: withCtx(() => [
            withDirectives(createVNode(_component_ElSwitch, {
...
const WorkflowActivator = /* @__PURE__ */ _export_sfc(_sfc_main, [["__cssModules", cssModules], ["__scopeId", "data-v-90b29744"]]);
export {
