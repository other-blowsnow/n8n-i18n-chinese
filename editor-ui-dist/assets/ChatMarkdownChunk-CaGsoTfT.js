const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-BDRejcTj.js","assets/chunk-CC9Q-vWm.js","assets/core-Cv3sKa7Y.js","assets/languageModules-DPxpIQTs.js","assets/xml-BrFE0qvZ.js"])))=>i.map(i=>d[i]);
...
import { ji as require_markdown_it_link_attributes, wa as N8nButton_default, zi as truncateBeforeLast } from "./src-CSSRFm72.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-BDRejcTj.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-DPxpIQTs.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
...
var ChatMarkdownChunk_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_jac20_125",
	chatMessageMarkdown: "_chatMessageMarkdown_jac20_133",
	codeBlockActions: "_codeBlockActions_jac20_392",
	singlePre: "_singlePre_jac20_405",
	footnoteRef: "_footnoteRef_jac20_410",
	tableContainer: "_tableContainer_jac20_423",
	command: "_command_jac20_428"
};
