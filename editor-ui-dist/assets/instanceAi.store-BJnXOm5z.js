import { Ft as ref, It as shallowReactive, Nt as reactive, R as inject, S as computed, Ut as triggerRef, tt as provide } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
...
import { Da as findAgent, Ea as createInitialState, Lc as v4, Oa as reduceEvent, al as isSafeObjectKey, il as instanceAiEventSchema, ka as toAgentTree } from "./constants-D4XflMq_.js";
import { T as defineStore, a as ResponseError, c as makeRestApiRequest, t as useRootStore } from "./useRootStore-CDKkkplG.js";
import "./settings.store-C8To3Sgr.js";
import { t as usePushConnectionStore } from "./pushConnection.store-BydMNiVZ.js";
import "./constants-D7Uopedo.js";
import { a as postCancelTask, c as postMessage, i as postCancel, n as ensureThread, o as postConfirmation, r as getInstanceAiCredits, s as postFeedback, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-BaDocCtS.js";
...
function createThreadRuntime(threadId, hooks) {
	...
	*/
	...
	async function dispatchUserMessage(message, attachments, pushRef) {
		try {
			await postMessage(rootStore.restApiContext, threadId, message, attachments, Intl.DateTimeFormat().resolvedOptions().timeZone, pushRef);
			return true;
		} catch (error) {
