...
import { pt as useCredentialsStore, rn as useTelemetry, s as useWorkflowsStore, t as useUsersStore, tn as useProjectsStore } from "./users.store-DI4bmc3m.js";
import { s as sanitizeHtml, t as useToast } from "./useToast-iCe0kksm.js";
import { Do as createResultOk, Eo as createResultError } from "./constants-CVUc8I0d.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-DJF03LT0.js");
			return { ConnectPopup };
		}, []);
		return await new Promise((resolve) => {
