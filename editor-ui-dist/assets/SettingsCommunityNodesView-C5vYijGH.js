import { d as defineComponent, Q as useUIStore, v as useSettingsStore, ae as useNodeTypesStore, r as ref, x as computed, ew as semver, ex as COMMUNITY_PACKAGE_MANAGE_ACTIONS, c as useI18n, a8 as watch, h as createElementBlock, g as openBlock, n as normalizeClass, f as createCommentVNode, i as createVNode, dS as N8nLoading, j as createBaseVNode, p as N8nText, w as withCtx, k as createTextVNode, t as toDisplayString, l as unref, F as Fragment, A as renderList, e as createBlock, N as N8nIcon, aa as Tooltip, q as N8nButton, en as N8nActionToggle, am as useTelemetry, ey as NPM_PACKAGE_DOCS_BASE_URL, _ as _export_sfc, b as useRouter, a1 as usePushConnectionStore, a as useToast, ay as useDocumentTitle, ez as useCommunityNodesStore, eA as COMMUNITY_NODES_INSTALLATION_DOCS_URL, b2 as onBeforeMount, o as onMounted, X as onBeforeUnmount, m as N8nHeading, e4 as N8nActionBox, bt as useExternalHooks, eB as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY } from "./index-BXVCKjk6.js";
import { u as usePushConnection } from "./usePushConnection-BHDoA4HB.js";
...
import "./useProjectPages-BknnyrMl.js";
      ...
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.loading ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", {
            ...
            _ctx.communityPackage.failedLoading === true ? (openBlock(), createBlock(_component_N8nTooltip, {
              key: 0,
              placement: "top"
            }, {
              content: withCtx(() => [
              ...
              _: 1
            })) : hasUnverifiedPackagesUpdate.value || hasVerifiedPackageUpdate.value ? (openBlock(), createBlock(_component_N8nTooltip, {
              key: 1,
              placement: "top"
            }, {
              content: withCtx(() => [
              ...
              _: 1
            })) : (openBlock(), createBlock(_component_N8nTooltip, {
              key: 2,
              placement: "top"
            }, {
              content: withCtx(() => [
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          unref(settingsStore).isUnverifiedPackagesEnabled && unref(communityNodesStore).getInstalledPackages.length > 0 && !loading.value ? (openBlock(), createBlock(_component_N8nButton, {
            key: 0,
