...
import { gn as createWorkflowDocumentId, ln as useTelemetry, s as useWorkflowsStore, yn as useWorkflowDocumentStore, yt as useCredentialsStore } from "./users.store-g_JotOI6.js";
import { t as useToast } from "./useToast-Cj673zB7.js";
import { A as IN_PROGRESS_EXECUTION_ID, Ba as chatHubMessageWithButtonsSchema, Fa as PROVIDER_CREDENTIAL_TYPE_MAP, Ha as chatHubVectorStoreProviderSchema, Ia as VECTOR_STORE_PROVIDER_CREDENTIAL_TYPE_MAP, Lc as v4, Pt as CHAT_TRIGGER_NODE_TYPE, Ql as EnterpriseEditionFeature, Ua as emptyChatModelsResponse, Us as deepCopy, ts as createRunExecutionData, za as chatHubLLMProviderSchema } from "./constants-D4XflMq_.js";
import { T as defineStore, a as ResponseError, c as makeRestApiRequest, r as STORES, t as useRootStore } from "./useRootStore-CDKkkplG.js";
import { t as useSettingsStore } from "./settings.store-C8To3Sgr.js";
import { t as retry } from "./retry-BUXcNIID.js";
import { T as unflattenModel, a as createSessionFromStreamingState, i as createFakeAgent, l as flattenModel, n as chunkFilesBySize, r as createAiMessageFromStreamingState, t as buildUiMessages, y as isMatchedAgent } from "./chat.utils-MSX9WTjT.js";
...
var useChatStore = defineStore(STORES.CHAT_HUB, () => {
	...
	*/
	function isCanvasManualExecution(model) {
		...
		const chatTrigger = useWorkflowDocumentStore(createWorkflowDocumentId(workflowsStore.workflowId)).allNodes.find((node) => node.type === CHAT_TRIGGER_NODE_TYPE);
