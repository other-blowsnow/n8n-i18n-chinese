const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-rRYkjeZe.js","assets/chunk-CC9Q-vWm.js","assets/core-Cv3sKa7Y.js","assets/languageModules-CNz-5agG.js","assets/xml-BrFE0qvZ.js"])))=>i.map(i=>d[i]);
...
import { Ja as N8nButton_default, Ji as truncateBeforeLast } from "./src-BY3LHeey.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-rRYkjeZe.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-CNz-5agG.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
