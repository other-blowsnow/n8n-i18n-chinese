import { d as defineComponent, e as createBlock, g as openBlock, go as Draggable, n as normalizeClass, w as withCtx, j as createBaseVNode, h as createElementBlock, f as createCommentVNode, i as createVNode, N as N8nIcon, _ as _export_sfc, cs as useThrottleFn, aZ as useNDVStore, Q as useUIStore, r as ref, fP as useSlots, o as onMounted, x as computed, cD as ndvEventBus, X as onBeforeUnmount, a8 as watch, hM as MAIN_NODE_PANEL_WIDTH, bd as useStorage, hN as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, l as unref, aq as normalizeStyle, Y as renderSlot, co as N8nResizeWrapper, Z as nextTick, bQ as useNodeHelpers, eD as storeToRefs, bO as usePinnedData, ae as useNodeTypesStore, a2 as useWorkflowsStore, cR as useDeviceSupport, cS as useTelemetryContext, hO as getNodeOutputs, bH as NodeConnectionTypes, bV as START_NODE_TYPE, hP as EXECUTABLE_TRIGGER_NODE_TYPES, b1 as STICKY_NODE_TYPE, hQ as BASE_NODE_SURVEY_URL, hR as dataPinningEventBus, a9 as resolveComponent, aa as Tooltip, p as N8nText, k as createTextVNode, t as toDisplayString, c as useI18n, bv as createSlots, hS as NodeSettings, ar as createEventBus, hT as InputPanel, cp as useStyles, hU as APP_MODALS_ELEMENT_ID, am as useTelemetry, an as useMessage, ao as MODAL_CONFIRM, dt as jsonParse, bt as useExternalHooks } from "./index-DgSMGi0-.js";
import { _ as __unplugin_components_0, O as OutputPanel, T as TriggerPanel } from "./TriggerPanel-BCZOWk2g.js";
import { u as useWorkflowActivate } from "./useWorkflowActivate-DADHnZfj.js";
import "./RunDataParsedAiContent-Bak1XUvQ.js";
import "./core-DGb5GWIj.js";
import "./ConsumedTokensDetails.vue_vue_type_script_setup_true_lang-BBJyHl1H.js";
import "./NodeView-VIJa0pxm.js";
import "./global-link-actions-cPy93bIn.js";
import "./useExecutionDebugging-Bo6-daZB.js";
import "./useBeforeUnload-C3agoXu-.js";
import "./canvas-BoAGzhkz.js";
import "./readyToRunWorkflows.store-BeEq2UEr.js";
import "./InfoAccordion-CcXn9sfW.js";
        ...
        default: withCtx(({ isDragging }) => [
          createBaseVNode("div", {
            ...
            _ctx.canMoveLeft ? (openBlock(), createElementBlock("span", {
              ...
              createVNode(_component_N8nIcon, { icon: "arrow-left" })
            ...
            _ctx.canMoveRight ? (openBlock(), createElementBlock("span", {
              ...
              createVNode(_component_N8nIcon, { icon: "arrow-right" })
            ], 2)) : createCommentVNode("", true),
            createBaseVNode("div", {
