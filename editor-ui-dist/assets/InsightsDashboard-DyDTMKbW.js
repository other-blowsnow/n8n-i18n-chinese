const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-B54Jd0nQ.js","assets/index-Bwe5xApO.js","assets/index-CFiA0qjr.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CgDhcPPd.js","assets/chartjs.utils-B2D04PLy.js","assets/InsightsSummary-F5UgGbUe.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-7pAbEjVD.js","assets/InsightsChartFailed-BEM4X3Ud.js","assets/InsightsChartFailureRate-CXgL5Y9a.js","assets/InsightsChartTimeSaved-D1ag5Sm_.js","assets/InsightsChartAverageRuntime-CVB6iuP4.js","assets/InsightsTableWorkflows-nRoo6xx1.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eY as useModel, gX as useInsightsStore, h5 as getTimeRangeLabels, r as ref, hM as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, k as unref, eO as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, eN as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, fM as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hN as INSIGHT_TYPES, e5 as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b3 as onBeforeMount, m as N8nHeading, n as normalizeClass, gn as ProjectSharing, em as _sfc_main$4, c0 as resolveDynamicComponent, aW as __vitePreload, al as useTelemetry, hO as TELEMETRY_TIME_RANGE } from "./index-Bwe5xApO.js";
import { I as InsightsSummary } from "./InsightsSummary-F5UgGbUe.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-B54Jd0nQ.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CgDhcPPd.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BEM4X3Ud.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-CXgL5Y9a.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-D1ag5Sm_.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-CVB6iuP4.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-nRoo6xx1.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
