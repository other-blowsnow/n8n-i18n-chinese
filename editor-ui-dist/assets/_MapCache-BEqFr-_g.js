...
var zh_CN_default = {
	...
	"settings.secretsProviderConnections.modal.title.create": "添加外部机密连接",
	...
	"settings.secretsProviderConnections.modal.error.invalidCredentials": "凭据无效。请检查您的设置。",
	"settings.secretsProviderConnections.modal.error.insufficientPermissions": "你没有权限执行此操作。",
	"settings.secretsProviderConnections.modal.success.created": "连接创建成功",
	"settings.secretsProviderConnections.modal.success.updated": "连接已成功更新",
	...
	"settings.secretsProviderConnections.modal.connectionName.error": "必须提供机密存储名称。请输入一个唯一的机密存储名称。",
	...
	"settings.secretsProviderConnections.modal.connectionName.placeholder": "请输入一个唯一的密钥存储名称。之后将无法更改。",
