const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-JqbyZiPL.js","assets/index-BxcQLnKq.js","assets/index-DH8MNLw5.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, as as useNDVStore, r as ref, gN as useElementSize, q as computed, fb as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, dj as defineAsyncComponent, cN as Suspense, gI as TextWithHighlights, n as normalizeClass, gJ as MappingPill, ge as Draggable, ao as __vitePreload, v as shorten, gM as getMappedExpression, aP as useExternalHooks, ag as useTelemetry, gO as isString, gP as nonExistingJsonPath, _ as _export_sfc } from "./index-BxcQLnKq.js";
import { t as VueJsonPretty } from "./RunData-CsqRYKqQ.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-JqbyZiPL.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
