...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, O as createSlots, S as computed, Sn as toDisplayString, T as createCommentVNode, W as nextTick, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, f as vModelText, gt as watch, h as withModifiers, j as createVNode, rt as renderList, st as resolveDynamicComponent, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { s as useI18n } from "./src-BZxl6qSA.js";
import { Ca as N8nCallout_default, Ct as N8nCard_default, Ea as N8nIcon_default, Fi as Input_default, M as N8nRadioButtons_default, Sa as N8nHeading_default, T as Switch_default, Ta as N8nButton_default, _t as N8nOption_default, gt as N8nSelect_default, wa as N8nText_default } from "./src-pyi3rpL8.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { w as require___vite_browser_external } from "./empty-CuAtJ5og.js";
import { r as useUIStore, sn as useProjectsStore, yt as useCredentialsStore } from "./users.store-CyAaJx7n.js";
import { el as getResourcePermissions, ro as AGENT_SCHEDULE_TRIGGER_TYPE } from "./constants-Dxn6bmLi.js";
import { t as useRootStore } from "./useRootStore-DPt_yVCx.js";
import { t as Modal_default } from "./Modal-D1NXvatb.js";
import { t as CredentialsDropdown_default } from "./CredentialsDropdown-BU6pGg6X.js";
import { O as updateScheduleIntegration, a as activateScheduleIntegration, d as deactivateScheduleIntegration, y as getScheduleIntegration } from "./agentTelemetry.utils-DhKWZHA9.js";
import { n as useAgentIntegrationStatus, r as useAgentIntegrationsCatalog } from "./useAgentIntegrationStatus-DErJPERF.js";
...
var AgentSlackSettingsForm_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function slackWebhookUrl() {
			return `${rootStore.urlBaseWebhook.replace(/\/$/, "")}/rest/projects/${props.projectId}/agents/v2/${props.agentId}/webhooks/slack`;
		}
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.manifestSection) }, [
				createVNode(unref(N8nText_default), {
					size: "small",
					bold: ""
				}, {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.codeBlock) }, [createVNode(unref(N8nButton_default), {
					...
					_: 1
				}, 8, ["class"]), createBaseVNode("pre", { class: normalizeClass(_ctx.$style.manifestCode) }, toDisplayString(slackAppManifest.value), 3)], 2)
			], 2);
		};
	}
});
var AgentSlackSettingsForm_vue_vue_type_style_index_0_lang_module_default = {
	manifestSection: "_manifestSection_5d6jk_125",
	docsCallout: "_docsCallout_5d6jk_131",
	docsLink: "_docsLink_5d6jk_135",
	manifestHint: "_manifestHint_5d6jk_140",
	codeBlock: "_codeBlock_5d6jk_144",
	codeBlockCopy: "_codeBlockCopy_5d6jk_153",
	manifestCode: "_manifestCode_5d6jk_160"
};
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.body) }, [
					...
					!selectedTriggerType.value ? (openBlock(), createElementBlock("div", {
						...
						!unref(isConnected)(currentIntegration.value.type) ? (openBlock(), createElementBlock("div", {
							...
							_: 1
						})], 2), createBaseVNode("div", { class: normalizeClass(_ctx.$style.selectRow) }, [createVNode(AgentCredentialSelect_default, {
						...
						}, null, 8, ["aria-label", "data-testid"])) : createCommentVNode("", true)], 2)], 2)) : (openBlock(), createElementBlock("div", {
							key: 2,
						...
						!unref(isConnected)(currentIntegration.value.type) && hasError(currentIntegration.value.type) ? (openBlock(), createBlock(unref(N8nText_default), {
							key: 3,
							class: normalizeClass(_ctx.$style.errorText),
							size: "small"
						}, {
...
var AgentAddTriggerModal_vue_vue_type_style_index_0_lang_module_default = {
	body: "_body_x72s3_125",
	pickerRow: "_pickerRow_x72s3_132",
	triggerPicker: "_triggerPicker_x72s3_138",
	triggerPickerWithIcon: "_triggerPickerWithIcon_x72s3_144",
	optionRow: "_optionRow_x72s3_148",
	optionIcon: "_optionIcon_x72s3_156",
	optionLabel: "_optionLabel_x72s3_160",
	placeholderState: "_placeholderState_x72s3_167",
	integrationConfig: "_integrationConfig_x72s3_177",
	modalDescription: "_modalDescription_x72s3_183",
	connectForm: "_connectForm_x72s3_187",
	label: "_label_x72s3_193",
	selectRow: "_selectRow_x72s3_197",
	select: "_select_x72s3_197",
	footer: "_footer_x72s3_208",
	footerActions: "_footerActions_x72s3_214",
	connectedSection: "_connectedSection_x72s3_220",
	errorText: "_errorText_x72s3_226",
	link: "_link_x72s3_230",
	webhookRow: "_webhookRow_x72s3_237",
	webhookInput: "_webhookInput_x72s3_243"
};
