...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_N8nUserStack = N8nUserStack;
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(`collaboration-pane-container ${_ctx.$style.container}`),
        "data-test-id": "collaboration-pane"
      }, [
        showUserStack.value ? (openBlock(), createBlock(_component_N8nUserStack, {
          key: 0,
          ...
          createBaseVNode("span", _hoisted_1$1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(tags.value, (tag) => {
              return openBlock(), createElementBlock("span", {
                ...
                tag.isCount ? (openBlock(), createBlock(_component_ElTag, {
                  key: 0,
                  title: tag.title,
                  type: "info",
                  size: "small",
...
const TagsContainer = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-d925d1fa"]]);
