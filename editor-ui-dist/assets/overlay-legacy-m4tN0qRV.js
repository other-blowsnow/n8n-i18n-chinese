;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./src-legacy-BL8uywAx.js", "./truncate-legacy-ZZ87M1Mo.js"], function (_export, _context) {
    "use strict";

    var onBeforeUnmount, NOOP, h, createVNode, onScopeDispose, init_reactivity_esm_bundler, defineComponent, onMounted, watch, renderSlot, isRef, init_shared_esm_bundler, watchEffect, computed, getScrollBarWidth, PatchFlags, removeClass, definePropType, throwError, addClass, addUnit, isClient, buildProps, getStyle, useNamespace, hasClass, useDraggable, useLockscreen, useSameTarget, overlayProps, overlayEmits, BLOCK, Overlay, ElOverlay;
    return {
