const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CbGmNJM_.js","assets/index-DgSMGi0-.js","assets/index-pk1znPBP.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CEW5EiSA.js","assets/chartjs.utils-bMwFWDJO.js","assets/InsightsSummary-B5qyb5gJ.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-BpKAZuVm.js","assets/InsightsChartFailed-54ca8ScP.js","assets/InsightsChartFailureRate-D53jXBx4.js","assets/InsightsChartTimeSaved-CR5O93vX.js","assets/InsightsChartAverageRuntime-YUNNBaDZ.js","assets/InsightsTableWorkflows-LRlRZVV4.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eq as useModel, gl as useInsightsStore, gv as getTimeRangeLabels, r as ref, hf as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, eh as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, eg as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hg as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hh as INSIGHT_TYPES, dA as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b2 as onBeforeMount, m as N8nHeading, n as normalizeClass, fM as ProjectSharing, dR as _sfc_main$4, c9 as resolveDynamicComponent, aV as __vitePreload, am as useTelemetry, hi as TELEMETRY_TIME_RANGE } from "./index-DgSMGi0-.js";
import { I as InsightsSummary } from "./InsightsSummary-B5qyb5gJ.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CbGmNJM_.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CEW5EiSA.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-54ca8ScP.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-D53jXBx4.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-CR5O93vX.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-YUNNBaDZ.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-LRlRZVV4.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
