...
import { it as useI18n, q as useDebounceFn, v as useLocalStorage } from "./core-CzIVo7k9.js";
import { Di as isWorkflowUpdatedMessage$1, Ei as isToolMessage$1, ct as useRoute, lt as useRouter } from "./src-DVkMmVCd.js";
import { t as useMessage } from "./useMessage-B0gp0e5D.js";
import { An as isDebouncedFunction, Bt as useWorkflowHelpers, Jt as useWorkflowsListStore, Sn as useCanvasStore, St as useAIAssistantHelpers, Xr as useSourceControlStore, da as tryToParseNumber, fn as injectWorkflowDocumentStore, gt as clearBuilderSession, ht as chatWithBuilder, la as stringSizeInBytes, ln as useNDVStore, ma as getNewWorkflow, on as usePostHog, pn as useWorkflowDocumentStore, r as useUIStore, rn as useTelemetry, s as useWorkflowsStore, un as createWorkflowDocumentId, vt as getAiSessions, xn as useNodeHelpers, xt as truncateBuilderMessages, yt as getBuilderCredits } from "./users.store-Dpbobzbe.js";
import { t as useToast } from "./useToast-Pwu_Jqrl.js";
import { $i as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, Al as CODE_WORKFLOW_BUILDER_EXPERIMENT, Bl as MERGE_ASK_BUILD_EXPERIMENT, Cl as AI_BUILDER_PLAN_MODE_EXPERIMENT, Di as MODAL_CANCEL, El as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, Oi as MODAL_CLOSE, Ql as DEBOUNCE_TIME, Rl as FOCUSED_NODES_EXPERIMENT, Us as dedupe, fc as isExpression, ii as VIEWS, iu as THREE_DAYS_IN_MILLIS, ji as NPS_SURVEY_MODAL_KEY, ki as MODAL_CONFIRM, nu as SEVEN_DAYS_IN_MILLIS, ou as getDebounceTime, ru as SIX_MONTHS_IN_MILLIS, t as AutoSaveState, tl as getResourcePermissions } from "./constants-B2-iseoM.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-CX_m119O.js";
import { In as STORES, a as updateWorkflowHistoryVersion, at as updateNpsSurveyState, i as getWorkflowVersionsByIds, n as getWorkflowHistory, r as getWorkflowVersion, t as useSettingsStore } from "./settings.store-D1h6gV_f.js";
import { t as useExternalHooks } from "./useExternalHooks-DiXjEaBn.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-BTEL7zQL.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-CaxuMXjN.js";
