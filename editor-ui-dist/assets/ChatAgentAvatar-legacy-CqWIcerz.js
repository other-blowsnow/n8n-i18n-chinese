;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./src-legacy-BL8uywAx.js", "./useTelemetry-legacy-Ck7lGOrk.js", "./constants-legacy-D0ziSY9e.js", "./useRootStore-legacy-D1vvqLPX.js", "./retry-legacy-WzzNqxgG.js", "./CredentialIcon-legacy-CLlljIZ1.js", "./constants-legacy-BrIb7Ao9.js"], function (_export, _context) {
    "use strict";

    var computed, unref, ref, defineComponent, toDisplayString, createBlock, withCtx, openBlock, createTextVNode, createSlots, N8nIcon_default, N8nAvatar_default, N8nTooltip_default, v4_default, useTelemetry, PROVIDER_CREDENTIAL_TYPE_MAP, chatHubProviderSchema, emptyChatModelsResponse, defineStore, makeRestApiRequest, streamRequest, useRootStore, retry, CredentialIcon_default, CHAT_VIEW, CHAT_STORE, STREAM_SEPARATOR, fetchChatModelsApi, stopGenerationApi, fetchConversationsApi, updateConversationApi, updateConversationTitleApi, deleteConversationApi, fetchSingleConversationApi, fetchAgentApi, createAgentApi, updateAgentApi, deleteAgentApi, useChatStore, ChatAgentAvatar_vue_vue_type_script_setup_true_lang_default, ChatAgentAvatar_default;
    ...
    _export({
      a: flattenModel,
      c: groupConversationsByDate,
      d: unflattenModel,
      i: findOneFromModelsResponse,
      l: isMatchedAgent,
      o: fromStringToModel,
      r: filterAndSortAgents,
      s: getAgentRoute,
      u: stringifyModel
    });
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        streamRequest = _useRootStoreLegacy00TJs.d;
        ...
        CHAT_STORE = _constantsLegacy03fJs.i;
      }],
      execute: function () {
        //#region src/features/ai/chatHub/chat.api.ts
        STREAM_SEPARATOR = "\n";
        _export("f", fetchChatModelsApi = async (context, payload) => {
        ...
        _export("n", useChatStore = defineStore(CHAT_STORE, () => {
          ...
          function sendMessage(sessionId, message, model, credentials, tools) {
          ...
          async function updateToolsInSession(sessionId, tools) {
            if (!sessions.value?.find(s => s.id === sessionId)) throw new Error(`Session with ID ${sessionId} not found`);
        ...
        _export("t", ChatAgentAvatar_default = ChatAgentAvatar_vue_vue_type_script_setup_true_lang_default); //#endregion
      }
    };
  });
})();