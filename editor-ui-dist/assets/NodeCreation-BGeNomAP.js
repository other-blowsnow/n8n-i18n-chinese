const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-BMcXRZEM.js","assets/index-BxcQLnKq.js","assets/index-DH8MNLw5.css","assets/NodeCreator-Cp8Apzva.css"])))=>i.map(i=>d[i]);
import { cA as useNodeCreatorStore, bz as useNodeTypesStore, q as computed, c as useI18n, Q as useWorkflowsStore, gQ as MANUAL_TRIGGER_NODE_TYPE, gR as CHAIN_LLM_LANGCHAIN_NODE_TYPE, by as NodeConnectionTypes, cH as CHAT_TRIGGER_NODE_TYPE, gS as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, gT as OPEN_AI_NODE_TYPE, gU as SPLIT_IN_BATCHES_NODE_TYPE, gV as NO_OP_NODE_TYPE, gW as WEBHOOK_NODE_TYPE, gX as SCHEDULE_TRIGGER_NODE_TYPE, gY as transformNodeType, aP as useExternalHooks, $ as useCanvasStore, gZ as AI_CATEGORY_LANGUAGE_MODELS, g_ as QA_CHAIN_NODE_TYPE, g$ as AGENT_NODE_TYPE, h0 as BASIC_CHAIN_NODE_TYPE, h1 as OPEN_AI_ASSISTANT_NODE_TYPE, ay as STICKY_NODE_TYPE, h2 as sortNodeCreateElements, h3 as TRIGGER_NODE_CREATOR_VIEW, cB as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, H as useUIStore, r as ref, bU as useThrottleFn, o as onMounted, y as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, bQ as KeyboardShortcutTooltip, dj as defineAsyncComponent, cN as Suspense, F as Fragment, ao as __vitePreload, h4 as getMidCanvasPosition, h5 as DEFAULT_STICKY_WIDTH, h6 as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-BxcQLnKq.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-BMcXRZEM.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
