...
import { J as useDebounceFn, at as useI18n, v as useLocalStorage } from "./core-D-eEyYCm.js";
import { Oi as isToolMessage$1, ki as isWorkflowUpdatedMessage$1, lt as useRoute, ut as useRouter } from "./src-mYri3GUV.js";
import { t as useMessage } from "./useMessage-DGVvpUxw.js";
import { $t as createWorkflowDocumentId, Mt as useWorkflowHelpers, Qi as stringSizeInBytes, Qt as useNDVStore, Rt as useWorkflowsListStore, Xt as usePostHog, ct as clearBuilderSession, dn as useCanvasStore, dt as getBuilderCredits, ea as tryToParseNumber, mt as useAIAssistantHelpers, nn as useWorkflowDocumentStore, pt as truncateBuilderMessages, qt as useTelemetry, r as useUIStore, ra as getNewWorkflow, s as useWorkflowsStore, st as chatWithBuilder, un as useNodeHelpers, ut as getAiSessions, yn as isDebouncedFunction, zr as useSourceControlStore } from "./users.store-Dv9IVEcY.js";
import { t as useToast } from "./useToast-BnMoCkvI.js";
import { Es as isExpression, Fc as AI_BUILDER_PLAN_MODE_EXPERIMENT, Hc as CODE_WORKFLOW_BUILDER_EXPERIMENT, Ni as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, Rc as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, Xc as FOCUSED_NODES_EXPERIMENT, Zc as MERGE_ASK_BUILD_EXPERIMENT, _l as getDebounceTime, ci as MODAL_CANCEL, fi as NPS_SURVEY_MODAL_KEY, hl as THREE_DAYS_IN_MILLIS, li as MODAL_CLOSE, ll as DEBOUNCE_TIME, ml as SIX_MONTHS_IN_MILLIS, pc as getResourcePermissions, pl as SEVEN_DAYS_IN_MILLIS, rs as dedupe, t as AutoSaveState, ui as MODAL_CONFIRM, zr as VIEWS } from "./constants-D-WeCtpr.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-CYGIbXSW.js";
import { In as STORES, a as updateWorkflowHistoryVersion, at as updateNpsSurveyState, i as getWorkflowVersionsByIds, n as getWorkflowHistory, r as getWorkflowVersion, t as useSettingsStore } from "./settings.store-DbGY4mvC.js";
import { t as useExternalHooks } from "./useExternalHooks-5J0wDC4J.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-C3yv9Bg4.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-CSLSxhit.js";
