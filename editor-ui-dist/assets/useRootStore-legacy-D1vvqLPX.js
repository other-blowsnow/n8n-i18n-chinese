  ...
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-2Qb71DGn.js", "./empty-legacy-CsIOGMHW.js", "./constants-legacy-D0ziSY9e.js"], function (_export, _context) {
    ...
    */
    function merge() {
      ...
      const assignValue = (val, key) => {
        ...
        if (isPlainObject(result[targetKey]) && isPlainObject(val)) result[targetKey] = merge(result[targetKey], val);else if (isPlainObject(val)) result[targetKey] = merge({}, val);else if (isArray(val)) result[targetKey] = val.slice();else if (!skipUndefined || !isUndefined(val)) result[targetKey] = val;
      };
    ...
    */
    ...
    _export({
      ...
      E: createPinia,
      O: storeToRefs,
      c: makeRestApiRequest,
      d: streamRequest,
      l: post,
      m: assert,
      n: getAndParseConfigFromMetaTag,
      o: get,
      s: getFullApiResponse,
      u: request
    });
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        process$1 = _emptyLegacy00tJs.D;
        init_dist$1 = _emptyLegacy00tJs.E;
        init_dist$2 = _emptyLegacy00tJs.i;
        Buffer = _emptyLegacy00tJs.r;
      }, function (_constantsLegacy00NJs) {
        randomString = _constantsLegacy00NJs.$i;
        jsonParse = _constantsLegacy00NJs.Xi;
        ApplicationError = _constantsLegacy00NJs.ma;
        setGlobalState = _constantsLegacy00NJs.pi;
      }],
      execute: function () {
        ...
        */
        ...
        _export("T", PiniaVuePlugin = function (_Vue) {
          _Vue.mixin({
            beforeCreate() {
        ...
        _export("w", N8N_IO_BASE_URL = "https://api.n8n.io/api/"); //#endregion
        //#region ../../@n8n/constants/src/browser.ts
        _export("C", BROWSER_ID_STORAGE_KEY = "n8n-browserId"); //#endregion
        //#region ../../@n8n/constants/src/community-nodes.ts
        _export("S", NPM_COMMUNITY_NODE_SEARCH_API_URL = "https://api.npms.io/v2/"); //#endregion
        //#region ../../@n8n/constants/src/instance.ts
        _export("b", INSTANCE_ID_HEADER = "n8n-instance-id");
        _export("x", INSTANCE_VERSION_HEADER = "n8n-version"); //#endregion
        //#region ../../@n8n/constants/src/execution.ts
        _export("y", TOOL_EXECUTOR_NODE_NAME = "PartialExecutionToolExecutor"); //#endregion
        ...
        */
        ...
        _export("_", LOGSTREAMING_DEFAULT_MAX_FREE_SOCKETS = 5);
        _export("v", LOGSTREAMING_DEFAULT_MAX_SOCKETS = 50);
        ...
        _export("g", LOGSTREAMING_CB_DEFAULT_MAX_FAILURES = 5);
        _export("h", LOGSTREAMING_CB_DEFAULT_FAILURE_WINDOW_MS = 1 * Time.minutes.toMilliseconds);
        init_dist();
        init_dist$1();
        ({
          toString
        ...
        */
        ...
        axios.default = axios;
        _export("p", axios_default = axios); //#endregion
        ...
        ({
          ...
          getAdapter,
          mergeConfig
        } = axios_default), _export("f", AxiosError); //#endregion
        ...
        _export("i", NO_NETWORK_ERROR_CODE = 999);
        STREAM_SEPARATOR = "⧉⇋⇋➽⌑⧉§§\n";
        _export("r", MfaRequiredError = class extends ApplicationError {
          constructor() {
            super("MFA is required to access this resource. Please set up MFA in your user settings.");
            this.name = "MfaRequiredError";
          }
        });
        _export("a", ResponseError = class extends ApplicationError {
          httpStatusCode;
          errorCode;
          serverStackTrace;
          meta;
        ...
        _export("t", useRootStore = defineStore(STORES.ROOT, () => {
          const state = ref({
