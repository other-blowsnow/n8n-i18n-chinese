const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-B0XeDRnM.js","assets/chunk-CC9Q-vWm.js","assets/core-Cv3sKa7Y.js","assets/languageModules-DNThZmnq.js","assets/xml-BrFE0qvZ.js"])))=>i.map(i=>d[i]);
...
import { Bi as truncateBeforeLast, Ta as N8nButton_default } from "./src-pyi3rpL8.js";
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName, footnoteRefClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			...
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-DNThZmnq.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
