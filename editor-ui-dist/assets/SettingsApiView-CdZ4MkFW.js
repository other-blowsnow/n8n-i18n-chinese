import { d as defineComponent, r as ref, e as createBlock, g as openBlock, s as N8nCard, n as normalizeClass, w as withCtx, j as createBaseVNode, i as createVNode, en as N8nActionToggle, h as createElementBlock, f as createCommentVNode, k as createTextVNode, t as toDisplayString, p as N8nText, c as useI18n, be as DateTime, _ as _export_sfc, v as useSettingsStore, Q as useUIStore, bc as useCloudPlanStore, a as useToast, ay as useDocumentTitle, aB as usePageRedirectionHelper, eC as useApiKeysStore, eD as storeToRefs, au as useRootStore, o as onMounted, eE as DOCS_DOMAIN, a9 as resolveComponent, l as unref, m as N8nHeading, F as Fragment, A as renderList, C as N8nLink, q as N8nButton, e4 as N8nActionBox, an as useMessage, ao as MODAL_CONFIRM, am as useTelemetry, eF as API_KEY_CREATE_OR_EDIT_MODAL_KEY } from "./index-BXVCKjk6.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          unref(apiKeysSortByCreationDate).length ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(apiKeysSortByCreationDate), (apiKey, index) => {
            return openBlock(), createBlock(_component_ElRow, {
              ...
              default: withCtx(() => [
                createVNode(_component_ElCol, null, {
                  default: withCtx(() => [
        ...
        unref(isPublicApiEnabled) && unref(apiKeysSortByCreationDate).length ? (openBlock(), createElementBlock("div", {
          ...
          unref(isSwaggerUIEnabled) ? (openBlock(), createBlock(_component_N8nLink, {
            key: 0,
            ...
            _: 1
          }, 8, ["to"])) : (openBlock(), createBlock(_component_N8nLink, {
            key: 1,
        ...
        createBaseVNode("div", _hoisted_4, [
          unref(isPublicApiEnabled) && unref(apiKeysSortByCreationDate).length ? (openBlock(), createBlock(_component_N8nButton, {
            key: 0,
            size: "large",
        ...
        !unref(isPublicApiEnabled) && unref(cloudPlanStore).userIsTrialing ? (openBlock(), createBlock(_component_N8nActionBox, {
          key: 2,
        ...
        unref(isPublicApiEnabled) && !unref(apiKeysSortByCreationDate).length ? (openBlock(), createBlock(_component_N8nActionBox, {
          key: 3,
