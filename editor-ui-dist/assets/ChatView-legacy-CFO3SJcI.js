  ...
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-2Qb71DGn.js", "./src-legacy-BL8uywAx.js", "./en-legacy-s6H-lEA2.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-ZZ87M1Mo.js", "./icon-legacy-CRT-hvlv.js", "./overlay-legacy-m4tN0qRV.js", "./empty-legacy-CsIOGMHW.js", "./dialog-legacy-NLNFRJF3.js", "./useTelemetry-legacy-Ck7lGOrk.js", "./useToast-legacy-tN8taI-S.js", "./sanitize-html-legacy-Cack6L-S.js", "./path-browserify-legacy-BQKq4wLb.js", "./constants-legacy-D0ziSY9e.js", "./merge-legacy-BVgKBTAX.js", "./useRootStore-legacy-D1vvqLPX.js", "./dateformat-legacy-BaeIHy_2.js", "./useDebounce-legacy-B8z7M2-W.js", "./useExternalHooks-legacy-DgS1u46v.js", "./useStyles-legacy-DnD2qvTK.js", "./retry-legacy-WzzNqxgG.js", "./nodeIcon-legacy-Y3uKJRlj.js", "./useClipboard-legacy-C1DalLye.js", "./NodeIcon-legacy-CDp2SR0v.js", "./Modal-legacy-BUoIu2MX.js", "./CredentialIcon-legacy-CLlljIZ1.js", "./VueMarkdown-legacy-Codm_cmy.js", "./constants-legacy-BrIb7Ao9.js", "./ChatAgentAvatar-legacy-CqWIcerz.js", "./ChatSidebarOpener-legacy-Cb7u_RJE.js", "./useChatHubSidebarState-legacy-DEvuSMoc.js", "./ToolsSelector-legacy-CT3lVoJP.js", "./useAgent-legacy-CoFHQ8wi.js"], function (_export, _context) {
    ...
    function useChatHubMarkdownOptions() {
      ...
      async function loadLanguageModules() {
        ...
        try {
          asyncImport = {
            status: "inProgress",
            promise: Promise.all([__vitePreload(() => _context.import("./es-legacy-BKkRYCar.js"), true               ? void 0 : void 0), __vitePreload(() => _context.import("./languageModules-legacy-D2vC-n3I.js"), true               ? void 0 : void 0)])
          };
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        INodesSchema = _constantsLegacy00NJs.Fr;
        VIEWS = _constantsLegacy00NJs.Oo;
        PROVIDER_CREDENTIAL_TYPE_MAP = _constantsLegacy00NJs.cr;
        LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL = _constantsLegacy00NJs.ds;
        LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS = _constantsLegacy00NJs.fs;
        chatHubConversationModelSchema = _constantsLegacy00NJs.lr;
      }, function (_mergeLegacy00PJs) {}, function (_useRootStoreLegacy00TJs) {}, function (_dateformatLegacy00VJs) {}, function (_useDebounceLegacy00XJs) {}, function (_useExternalHooksLegacy00ZJs) {}, function (_useStylesLegacy00$Js) {}, function (_retryLegacy01fJs) {}, function (_nodeIconLegacy01pJs) {}, function (_useClipboardLegacy01rJs) {
        useClipboard = _useClipboardLegacy01rJs.t;
      }, function (_NodeIconLegacy01zJs) {}, function (_ModalLegacy01NJs) {}, function (_CredentialIconLegacy02fJs) {}, function (_VueMarkdownLegacy02lJs) {
        ...
        unflattenModel = _ChatAgentAvatarLegacy04PJs.d;
        findOneFromModelsResponse = _ChatAgentAvatarLegacy04PJs.i;
        useChatStore = _ChatAgentAvatarLegacy04PJs.n;
        ChatAgentAvatar_default = _ChatAgentAvatarLegacy04PJs.t;
      }, function (_ChatSidebarOpenerLegacy04RJs) {
        ChatLayout_default = _ChatSidebarOpenerLegacy04RJs.n;
        useChatCredentials = _ChatSidebarOpenerLegacy04RJs.r;
        ChatSidebarOpener_default = _ChatSidebarOpenerLegacy04RJs.t;
      ...
      execute: function () {
        ...
        ChatPrompt_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props, {
            ...
            return (_ctx, _cache) => {
              ...
              }, null, 8, ["modelValue", "class", "placeholder", "disabled"]), _ctx.isToolsSelectable ? (openBlock(), createElementBlock("div", {
                key: 2,
              ...
              }, null, 8, ["selected", "disabled"])], 2)) : createCommentVNode("", true), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.actions)
        ...
        prompt$1 = "_prompt_17wu6_123";
        inputWrap = "_inputWrap_17wu6_128";
        callout = "_callout_17wu6_136";
        input = "_input_17wu6_128";
        tools = "_tools_17wu6_163";
        actions = "_actions_17wu6_174";
        recording = "_recording_17wu6_187";
        chatHubPromptRecordingPulse = "_chatHubPromptRecordingPulse_17wu6_1";
        ...
        ChatView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            const canSelectTools = computed(() => selectedModel.value?.model.provider !== "custom-agent" && selectedModel.value?.model.provider !== "n8n");
            const {
              arrivedState,
              measure
            ...
            function onSubmit(message$1) {
              ...
              chatStore.sendMessage(sessionId.value, message$1, selectedModel.value.model, credentialsForSelectedProvider.value, canSelectTools.value ? selectedTools.value : []);
            ...
            return (_ctx, _cache) => {
              return openBlock(), createBlock(ChatLayout_default, {
                ...
                default: withCtx(() => [createVNode(ChatConversationHeader_default, {
                  ref_key: "headerRef",
                  ref: headerRef,
        ...
        scrollArea = "_scrollArea_1cs1t_123";
        scrollable = "_scrollable_1cs1t_128";
        isNewSession = "_isNewSession_1cs1t_137";
        header = "_header_1cs1t_141";
        isMobileDevice = "_isMobileDevice_1cs1t_147";
        starter = "_starter_1cs1t_147";
        messageList = "_messageList_1cs1t_152";
        promptContainer = "_promptContainer_1cs1t_168";
        isExistingSession = "_isExistingSession_1cs1t_172";
        prompt = "_prompt_1cs1t_168";
        scrollToBottomButton = "_scrollToBottomButton_1cs1t_190";
