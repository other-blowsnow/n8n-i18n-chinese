const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-bFmQu9GF.js","assets/index-PdEQe4H7.js","assets/index-B7wrqKiF.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aZ as useNDVStore, cO as useTelemetryContext, r as ref, go as useElementSize, x as computed, hp as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dx as defineAsyncComponent, dw as Suspense, hq as VueJsonPretty, hk as __unplugin_components_0, n as normalizeClass, hl as MappingPill, gk as Draggable, aV as __vitePreload, hm as shorten, ho as getMappedExpression, hr as isString, hs as nonExistingJsonPath, bq as useExternalHooks, am as useTelemetry, _ as _export_sfc } from "./index-PdEQe4H7.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-bFmQu9GF.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
