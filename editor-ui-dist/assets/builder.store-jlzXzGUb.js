...
import { Di as isToolMessage$1, Oi as isWorkflowUpdatedMessage$1, ct as useRoute, lt as useRouter } from "./src-pyi3rpL8.js";
import { J as useDebounceFn, v as useLocalStorage } from "./core-vNZq-xzE.js";
import { t as useMessage } from "./useMessage-BY0HVl0h.js";
import { Aa as getNewWorkflow, Da as tryToParseNumber, Dn as useNodeHelpers, Dt as truncateBuilderMessages, Kt as useWorkflowHelpers, On as useCanvasStore, Ot as useAIAssistantHelpers, St as clearBuilderSession, Ta as stringSizeInBytes, Tt as getBuilderCredits, Ur as isDebouncedFunction, en as useWorkflowsListStore, fi as useSourceControlStore, fn as usePostHog, gn as createWorkflowDocumentId, hn as useNDVStore, ln as useTelemetry, r as useUIStore, s as useWorkflowsStore, vn as injectWorkflowDocumentStore, wt as getAiSessions, xt as chatWithBuilder, yn as useWorkflowDocumentStore } from "./users.store-CyAaJx7n.js";
import { t as useToast } from "./useToast-D2mWSxil.js";
import { Ai as MODAL_CONFIRM, Al as CODE_WORKFLOW_BUILDER_EXPERIMENT, Cl as AI_BUILDER_PLAN_MODE_EXPERIMENT, El as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, Hs as dedupe, Mi as NPS_SURVEY_MODAL_KEY, Oi as MODAL_CANCEL, Rl as FOCUSED_NODES_EXPERIMENT, Vl as MERGE_ASK_BUILD_EXPERIMENT, au as SIX_MONTHS_IN_MILLIS, cu as getDebounceTime, dc as isExpression, ea as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, el as getResourcePermissions, eu as DEBOUNCE_TIME, ii as VIEWS, iu as SEVEN_DAYS_IN_MILLIS, ki as MODAL_CLOSE, ou as THREE_DAYS_IN_MILLIS, t as AutoSaveState } from "./constants-Dxn6bmLi.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-DPt_yVCx.js";
import { Rn as STORES, a as getWorkflowVersionsByIds, en as getFirstAdoptionDate, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, ot as updateNpsSurveyState, r as getWorkflowHistory, t as useSettingsStore } from "./settings.store-Bi6z3m7-.js";
import { t as useExternalHooks } from "./useExternalHooks-D0y0WA3N.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-l5g4d11r.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-BM_3tdYj.js";
