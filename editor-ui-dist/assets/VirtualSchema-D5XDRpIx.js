...
import { Ca as N8nCallout_default, Ea as N8nIcon_default, Ta as N8nButton_default, ji as N8nTooltip_default, lt as useRouter, tt as N8nLink_default, wa as N8nText_default } from "./src-pyi3rpL8.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as computedAsync } from "./core-vNZq-xzE.js";
import { t as useMessage } from "./useMessage-BY0HVl0h.js";
import { At as useFlattenSchema, Ct as generateCodeForPrompt, Dn as useNodeHelpers, E as useNodeTypesStore, Tn as needsAgentInput, Vi as executionDataToJson, ba as isEmpty, hn as useNDVStore, kt as useDataSchema, ln as useTelemetry, mn as injectNDVStore, r as useUIStore, s as useWorkflowsStore, tn as useEnvironmentsStore, vn as injectWorkflowDocumentStore, yn as useWorkflowDocumentStore } from "./users.store-CyAaJx7n.js";
import { t as useToast } from "./useToast-D2mWSxil.js";
import { Ai as MODAL_CONFIRM, Gc as ApplicationError, Pt as CHAT_TRIGGER_NODE_TYPE, Ql as EnterpriseEditionFeature, To as createResultError, an as FORM_TRIGGER_NODE_TYPE, b as SCHEMA_PREVIEW_DOCS_URL, bi as FROM_AI_PARAMETERS_MODAL_KEY, cc as DateTime, hc as AI_TRANSFORM_JS_CODE, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, lc as NodeConnectionTypes, mc as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, mr as WEBHOOK_NODE_TYPE, ui as BINARY_DATA_VIEW_MODAL_KEY, xn as MANUAL_TRIGGER_NODE_TYPE } from "./constants-Dxn6bmLi.js";
...
import { i as Ln, o as gu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-Bpn0XSWk.js";
...
import { t as TextWithHighlights_default } from "./TextWithHighlights-gbCurWpU.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-CR9Z4CzD.js";
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-Dl7p70X7.js";
...
function getParentNodes(workflowDocumentId) {
...
function getSchemas(workflowDocumentId) {
...
async function generateCodeForAiTransform(prompt, path, workflowDocumentId, retries = 1) {
...
function useNodeExecution(node, options = {}) {
	...
	async function handleCodeGeneration() {
		...
		try {
			...
			const updateInformation = await generateCodeForAiTransform(prompt, `parameters.${AI_TRANSFORM_JS_CODE}`, workflowDocumentStore.value.documentId, 5);
