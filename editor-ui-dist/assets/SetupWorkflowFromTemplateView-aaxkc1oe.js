import { a0 as defineStore, r as ref, bo as useTemplatesStore, ae as useNodeTypesStore, dh as useCredentialsStore, au as useRootStore, a2 as useWorkflowsStore, x as computed, eW as useCredentialSetupState, bt as useExternalHooks, am as useTelemetry, V as VIEWS, dF as tryToParseNumber, d as defineComponent, a3 as useRoute, b as useRouter, a8 as watch, o as onMounted, e as createBlock, g as openBlock, w as withCtx, j as createBaseVNode, n as normalizeClass, eX as AppsRequiringCredsNotice, l as unref, dS as N8nLoading, h as createElementBlock, F as Fragment, A as renderList, eY as SetupTemplateFormStep, i as createVNode, C as N8nLink, k as createTextVNode, t as toDisplayString, c as useI18n, aa as Tooltip, q as N8nButton, m as N8nHeading, _ as _export_sfc } from "./index-BXVCKjk6.js";
import { c as createWorkflowFromTemplate } from "./templateActions-Bl2a1-C5.js";
import { T as TemplatesView } from "./TemplatesView-BgFzVBOw.js";
      ...
      return openBlock(), createBlock(TemplatesView, { "go-back-enabled": true }, {
        header: withCtx(() => [
          isReady.value ? (openBlock(), createBlock(unref(N8nHeading), {
            ...
            _: 1
          })) : (openBlock(), createBlock(_component_N8nLoading, {
            key: 1,
            variant: "h1"
          }))
        ]),
        content: withCtx(() => [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              }, null, 8, ["app-credentials"])) : (openBlock(), createBlock(_component_N8nLoading, {
                key: 1,
                variant: "p"
              }))
            ], 2),
            ...
            createBaseVNode("div", {
              ...
              isReady.value ? (openBlock(), createBlock(_component_N8nTooltip, {
                key: 0,
                ...
                createVNode(_component_N8nLoading, { variant: "button" })
              ]))
            ], 2)
          ], 2)
        ]),
