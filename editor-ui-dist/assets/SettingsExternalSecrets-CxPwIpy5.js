import { d as defineComponent, di as useExternalSecretsStore, Q as useUIStore, a as useToast, c3 as toRef, x as computed, fY as useExternalSecretsProvider, c as useI18n, be as DateTime, fZ as isDateObject, o as onMounted, e as createBlock, g as openBlock, s as N8nCard, n as normalizeClass, w as withCtx, j as createBaseVNode, i as createVNode, h as createElementBlock, f as createCommentVNode, f_ as _sfc_main$2, p as N8nText, k as createTextVNode, t as toDisplayString, l as unref, N as N8nIcon, aL as N8nBadge, f$ as ExternalSecretsProviderConnectionSwitch, en as N8nActionToggle, q as N8nButton, Z as nextTick, g0 as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, _ as _export_sfc, ay as useDocumentTitle, aB as usePageRedirectionHelper, m as N8nHeading, z as N8nCallout, F as Fragment, A as renderList, ac as I18nT, e4 as N8nActionBox } from "./index-BXVCKjk6.js";
        ...
        default: withCtx(() => [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              createVNode(_component_N8nText, { bold: "" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(provider.value.displayName), 1)
                ]),
                _: 1
              }),
              provider.value.connected ? (openBlock(), createBlock(_component_N8nText, {
                key: 0,
                color: "text-light",
                size: "small"
              }, {
            ...
            ], 2)) : (openBlock(), createBlock(_component_N8nButton, {
              key: 2,
              type: "tertiary",
