...
var zh_CN_default = {
	...
	"agentSessions.loadedAll": "没有更多会话可获取",
	...
	"agentSessions.detail.workingMemory": "内存更新",
	...
	"menuActions.editDescription": "描述",
	...
	"nodeCreator.subcategoryDescriptions.modelContextProtocol": "连接来自 MCP 服务器的工具，如 Notion、Linear 或你自己的 MCP 端点",
	...
	"projectRoles.workflow:updateRedactionSetting.tooltip": "在项目中管理工作流的数据脱敏策略",
	...
	"instanceAi.input.researchToggle": "深入研究",
	"instanceAi.input.researchToggle.tooltip": "在回应之前，请先在网上搜索、阅读文档，并综合研究结果。",
	...
	"instanceAi.gatewayConfirmation.denyOnce": "仅拒绝一次",
	"instanceAi.gatewayConfirmation.prompt": "AI 助手想在计算机使用时访问 '{resources}'",
	"instanceAi.askUser.placeholder": "请输入你的答案…",
	"instanceAi.askUser.submit": "提交",
	"instanceAi.askUser.skip": "跳过",
	"instanceAi.domainAccess.prompt": "AI 助手想要访问 {domain}",
	...
	"instanceAi.webSearch.allowThread": "始终允许此线程",
	...
	"instanceAi.settings.embedderModel.placeholder": "空值 = 语义召回已禁用",
	...
	"instanceAi.tools.research-with-agent": "正在研究",
	"instanceAi.tools.build-workflow-with-agent": "正在构建工作流",
	"instanceAi.tools.manage-data-tables-with-agent": "数据表管理",
	...
	"instanceAi.tools.mastra_workspace_read_file": "正在读取文件",
	"instanceAi.tools.mastra_workspace_write_file": "正在写入文件",
	"instanceAi.tools.mastra_workspace_edit_file": "正在编辑文件",
	"instanceAi.tools.mastra_workspace_list_files": "列出文件",
	"instanceAi.tools.mastra_workspace_delete": "正在删除文件",
	"instanceAi.tools.mastra_workspace_file_stat": "正在检查文件信息",
	"instanceAi.tools.mastra_workspace_mkdir": "正在创建目录",
	"instanceAi.tools.mastra_workspace_grep": "正在搜索文件",
	"instanceAi.tools.mastra_workspace_ast_edit": "正在编辑代码",
	...
	"instanceAi.tools.mastra_workspace_index": "正在对工作区进行索引",
	...
	"agents.builder.sections.memory": "内存",
	...
	"agents.builder.memory.title": "内存",
	"agents.builder.memory.recentMessages.label": "上下文中的最近消息",
	...
	"agents.builder.addTrigger.connectedText.slack": "你的代理已连接到 Slack，可以接收消息。",
