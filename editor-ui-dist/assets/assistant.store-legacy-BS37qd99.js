;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-2Qb71DGn.js", "./src-legacy-BL8uywAx.js", "./truncate-legacy-ZZ87M1Mo.js", "./useTelemetry-legacy-Ck7lGOrk.js", "./useToast-legacy-tN8taI-S.js", "./constants-legacy-D0ziSY9e.js", "./useRootStore-legacy-D1vvqLPX.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, createElementBlock, unref, ref, h, defineComponent, toDisplayString, watch, openBlock, createTextVNode, createBaseVNode, useI18n, isToolMessage, isWorkflowUpdatedMessage, createEventBus, useRoute, useSettingsStore, useCredentialsStore, getSessionsMetadata, getAuthTypeForNodeCredential, getAiSessions, useUIStore, injectWorkflowState, CREDENTIAL_EDIT_MODAL_KEY, chatWithAssistant, chatWithBuilder, useAIAssistantHelpers, replaceCode, useNDVStore, STORES, useUsersStore, codeNodeEditorEventBus, useWorkflowsStore, getMainAuthField, getBuilderCredits, useNodeTypesStore, useTelemetry, stringSizeInBytes, useToast, require_pick, EDITABLE_CANVAS_VIEWS, VIEWS, jsonParse, deepCopy, PLACEHOLDER_EMPTY_WORKFLOW_ID, DEFAULT_NEW_WORKFLOW_NAME, defineStore, assert, useRootStore, ASSISTANT_ENABLED_VIEWS, BUILDER_ENABLED_VIEWS, import_pick, INFINITE_CREDITS, useBuilderStore, DEFAULT_CHAT_WIDTH, useChatPanelStateStore, ndvEventBus, _hoisted_1, AiUpdatedCodeMessage_vue_vue_type_script_setup_true_lang_default, AiUpdatedCodeMessage_default, READABLE_TYPES, useAssistantStore;
    //#endregion
