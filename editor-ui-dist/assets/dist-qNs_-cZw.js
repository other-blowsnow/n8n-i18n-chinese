...
function keyName(event) {
	var name = !(brokenModifierNames && (event.ctrlKey || event.altKey || event.metaKey) || ie$1 && event.shiftKey && event.key && event.key.length == 1 || event.key == "Unidentified") && event.key || (event.shiftKey ? shift : base)[event.keyCode] || event.key || "Unidentified";
...
//#endregion
export { highlightSpecialChars as $, tags as A, findClusterBreak as At, Decoration as B, matchBrackets as C, StateField as Ct, unfoldAll as D, codePointSize as Dt, syntaxTree as E, codePointAt as Et, NodeType as F, WidgetType as G, EditorView as H, NodeWeakMap as I, getPanel as J, drawSelection as K, Parser as L, IterMode as M, NodeProp as N, unfoldCode as O, combineConfig as Ot, NodeSet as P, highlightActiveLineGutter as Q, Tree as R, indentUnit as S, StateEffect as St, syntaxHighlighting as T, Transaction as Tt, GutterMarker as U, Direction as V, ViewPlugin as W, gutter as X, getTooltip as Y, highlightActiveLine as Z, getIndentUnit as _, MapMode as _t, bracketMatching as a, showPanel as at, indentOnInput as b, RangeSetBuilder as bt, delimitedIndent as c, crelt as ct, foldAll as d, ChangeSet as dt, hoverTooltip as et, foldCode as f, CharCategory as ft, foldState as g, Facet as gt, foldNodeProp as h, EditorState as ht, LanguageSupport as i, runScopeHandlers as it, DefaultBufferLength as j, fromCodePoint as jt, styleTags as k, countColumn as kt, ensureSyntaxTree as l, Annotation as lt, foldInside as m, EditorSelection as mt, IndentContext as n, lineNumbers as nt, continuedIndent as o, showTooltip as ot, foldGutter as p, Compartment as pt, dropCursor as q, LRLanguage as r, logException as rt, defineLanguageFacet as s, tooltips as st, HighlightStyle as t, keymap as tt, flatIndent as u, ChangeDesc as ut, getIndentation as v, Prec as vt, sublanguageProp as w, Text as wt, indentString as x, RangeValue as xt, indentNodeProp as y, RangeSet as yt, parseMixed as z };
