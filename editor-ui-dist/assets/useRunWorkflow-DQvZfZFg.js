...
import { Ar as BulkCommand, Dr as useHistoryStore, Fr as RemoveNodeCommand, J as displayForm, Js as useRootStore, Mr as EnableNodeToggleCommand, Or as AddConnectionCommand, Pr as RemoveConnectionCommand, Sn as injectWorkflowState, Tr as CanvasNodeDirtiness, bi as isEmpty, gc as defineStore, kn as useDocumentTitle, kr as AddNodeCommand, mn as useWorkflowHelpers, o as useWorkflowsStore, t as useTelemetry, vc as STORES, xn as useNodeHelpers, zo as useSettingsStore } from "./useTelemetry-D6pZULgL.js";
import { t as useToast } from "./useToast-BabYcC1S.js";
import { N as IN_PROGRESS_EXECUTION_ID, Q as CHAT_TRIGGER_NODE_TYPE, hn as SINGLE_WEBHOOK_TRIGGERS, oi as generateNodesGraph, qi as NodeConnectionTypes, sr as createHeartbeatMessage, ss as LOCAL_STORAGE_RUN_DATA_WORKER } from "./constants-UStNMe6H.js";
...
const runDataWorker = wrap(new Worker(new URL(
	/* @vite-ignore */
	"/%7B%7BBASE_PATH%7D%7D/assets/worker-DYbBH4SI.js",
	"" + import.meta.url
), { type: "module" }));
