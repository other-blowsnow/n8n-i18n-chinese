(function() {
	...
	var append = uncurryThis$19(URLSearchParamsPrototype$1.append);
	var $delete = uncurryThis$19(URLSearchParamsPrototype$1["delete"]);
	var forEach$1 = uncurryThis$19(URLSearchParamsPrototype$1.forEach);
	var push$4 = uncurryThis$19([].push);
	...
	var getAll = uncurryThis$18(URLSearchParamsPrototype.getAll);
	var $has = uncurryThis$18(URLSearchParamsPrototype.has);
	...
	var require_function_uncurry_this_clause = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(fn) {
			if (classofRaw(fn) === "Function") return uncurryThis$17(fn);
		};
	}));
