const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-BRXrg9Kd.js","assets/chunk-CC9Q-vWm.js","assets/core-Cra4UmGe.js","assets/languageModules-9EvuuM9y.js","assets/xml-BVzDSG_x.js"])))=>i.map(i=>d[i]);
...
import { Ja as N8nButton_default, Ji as truncateBeforeLast } from "./src-XWsjz-dU.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-BRXrg9Kd.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-9EvuuM9y.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
