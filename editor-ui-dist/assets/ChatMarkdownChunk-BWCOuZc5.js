const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-DXfqDc-D.js","assets/chunk-CC9Q-vWm.js","assets/core-B3B1zL29.js","assets/languageModules-BMt33f30.js","assets/xml-BB2TKI4c.js"])))=>i.map(i=>d[i]);
...
import { Ni as require_markdown_it_link_attributes, Vi as truncateBeforeLast, _a as N8nButton_default } from "./src-BvkWedrz.js";
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName, footnoteRefClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-DXfqDc-D.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-BMt33f30.js"), __vite__mapDeps([3,4]))])
			};
