...
var en_default = {
	...
	"projectRoles.credential:share.tooltip": "Share credentials with other users",
...
var zh_CN_default = {
	...
	"settings.provisioning.scopesProvisionInstanceRole": "配置实例角色",
	"settings.provisioning.scopesProvisionInstanceRole.help": "启用实例角色的自动配置",
	"settings.provisioning.scopesProvisionProjectRoles": "分配项目角色",
	"settings.provisioning.scopesProvisionProjectRoles.help": "启用项目和项目角色的自动配置",
	"settings.provisioning.scopesProvisioningFrequency": "供应频率",
	"settings.provisioning.scopesProvisioningFrequency.placeholder": "选择供应频率",
	"settings.provisioning.scopesProvisioningFrequency.help": "多频繁进行项目和角色的配置",
	...
	"workflows.empty.readyToRunV2": "尝试一个 AI 工作流程",
	...
	"dataTable.banner.storageLimitWarning.message": "已使用的数据表存储的 {usage}。删除数据以避免错误。",
	"dataTable.banner.storageLimitError.message": "数据表存储使用的 {usage}，操作可能会失败。删除数据以避免错误。",
