;
(function () {
  System.register(["./_MapCache-legacy-2Qb71DGn.js", "./useMessage-legacy-B0itSvLh.js", "./useTelemetry-legacy-Ck7lGOrk.js", "./useToast-legacy-tN8taI-S.js", "./constants-legacy-D0ziSY9e.js", "./useExternalHooks-legacy-DgS1u46v.js", "./npsSurvey.store-legacy-CwlhN2c-.js", "./templates.store-legacy-BBTwiez6.js", "./focusPanel.store-legacy-vFw1UYwX.js"], function (_export, _context) {
    "use strict";

    var useI18n, useMessage, tryToParseNumber, useSourceControlStore, useUIStore, injectWorkflowState, useCanvasStore, useWorkflowHelpers, useWorkflowsStore, useNodeTypesStore, useTelemetry, useNodeHelpers, useToast, MODAL_CANCEL, MODAL_CLOSE, VIEWS, getResourcePermissions, MODAL_CONFIRM, NON_ACTIVATABLE_TRIGGER_NODE_TYPES, PLACEHOLDER_EMPTY_WORKFLOW_ID, useExternalHooks, useNpsSurveyStore, useTemplatesStore, useFocusPanelStore;
    ...
    return {
      setters: [function (_MapCacheLegacy005Js) {
        ...
        MODAL_CANCEL = _constantsLegacy00NJs.Go;
        MODAL_CLOSE = _constantsLegacy00NJs.Ko;
