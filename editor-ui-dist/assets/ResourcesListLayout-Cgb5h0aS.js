import { d as defineComponent, r as ref, x as computed, h as createElementBlock, g as openBlock, i as createVNode, j as createBaseVNode, w as withCtx, F as Fragment, A as renderList, aq as normalizeStyle, n as normalizeClass, t as toDisplayString, Y as renderSlot, e as createBlock, c9 as resolveDynamicComponent, l as unref, f as createCommentVNode, fL as _sfc_main$5, eh as _sfc_main$6, k as createTextVNode, D as useI18n, eg as N8nSelect, K as mergeProps, _ as _export_sfc, a8 as watch, b2 as onBeforeMount, o as onMounted, Z as nextTick, av as useProjectsStore, a9 as resolveComponent, fH as _sfc_main$7, aF as EnterpriseEditionFeature, c as useI18n$1, ed as N8nInputLabel, fM as ProjectSharing, C as N8nLink, aL as N8nBadge, q as N8nButton, a$ as useLocalStorage, fN as LOCAL_STORAGE_WORKFLOW_LIST_PREFERENCES_KEY, fO as isBaseTextKey, a3 as useRoute, b as useRouter, P as useDebounce, u as useUsersStore, fP as useSlots, fQ as isSharedResource, fR as isResourceSortableByDate, X as onBeforeUnmount, dS as N8nLoading, e4 as N8nActionBox, p as N8nText, b3 as withDirectives, d6 as N8nInput, N as N8nIcon, c7 as normalizeProps, c8 as guardReactiveProps, cZ as InfoTip, b4 as vShow, am as useTelemetry } from "./index-BXVCKjk6.js";
import { N as N8nTableBase } from "./TableBase-BPe88VDG.js";
import { _ as __unplugin_components_5 } from "./PageViewLayout-O3qQyg0W.js";
import { u as useProjectPages } from "./useProjectPages-BknnyrMl.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_N8nPopover = _sfc_main$7;
      return openBlock(), createBlock(_component_N8nPopover, {
        ...
        reference: withCtx(() => [
          createVNode(_component_N8nButton, {
            ...
            default: withCtx(() => [
              filtersLength.value > 0 ? (openBlock(), createBlock(_component_N8nBadge, {
                key: 0,
        ...
        default: withCtx(() => [
          createBaseVNode("div", {
            ...
            _ctx.shareable && unref(projectsStore).isProjectHome ? (openBlock(), createBlock(_component_EnterpriseEdition, {
              key: 0,
            ...
            hasFilters.value ? (openBlock(), createElementBlock("div", {
              ...
              createVNode(_component_N8nLink, { onClick: resetFilters }, {
                default: withCtx(() => [
            ...
            showEmptyState.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
              ...
              header: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", {
                    ...
                    props.uiConfig.searchEnabled ? (openBlock(), createBlock(_component_N8nInput, {
                      key: 0,
                      ref_key: "search",
                      ref: search2,
                ...
                props.uiConfig.showFiltersDropdown ? withDirectives((openBlock(), createElementBlock("div", _hoisted_3, [
                  createVNode(_component_N8nInfoTip, { bold: false }, {
                    default: withCtx(() => [
              ...
              default: withCtx(() => [
                ...
                _ctx.resourcesRefreshing ? (openBlock(), createElementBlock("div", _hoisted_4, [
                  ...
                  _ctx.type === "list-full" ? (openBlock(), createBlock(_component_N8nRecycleScroller, {
                    key: 0,
                  ...
                  _ctx.type === "datatable" ? (openBlock(), createBlock(_component_N8nDatatable, {
                    key: 2,
                ...
                ], 2)) : hasAppliedFilters() || filtersModel.value.search !== "" ? (openBlock(), createBlock(_component_N8nText, {
                  key: 2,
                  color: "text-base",
                  size: "medium",
...
const ResourcesListLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__cssModules", cssModules], ["__scopeId", "data-v-5a0cd892"]]);
export {
