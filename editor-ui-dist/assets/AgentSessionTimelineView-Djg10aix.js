...
import { it as useI18n, m as useEventListener, o as useActiveElement } from "./core-CwaTdA6t.js";
import { $i as PopperAnchor_default, Ai as N8nTooltip_default, Ca as N8nText_default, Ct as N8nCard_default, Fi as N8nIconButton_default, Nt as DropdownMenu_default, P as N8nPopover_default, Pi as Input_default, Qi as PopperContent_default, Ta as N8nIcon_default, ba as createContext, ca as Primitive, ct as useRoute, da as useGraceArea, ea as PopperRoot_default, fa as useForwardPropsEmits, h as N8nBreadcrumbs_default, ia as DismissableLayer_default, j as N8nRecycleScroller_default, la as Presence_default, lt as useRouter, ma as useForwardExpose, pa as useForwardProps, ra as Teleport_default, va as useVModel, wa as N8nButton_default, ya as syncRef } from "./src-4M_3Mukr.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Bt as useWorkflowHelpers, b as useNodeTypesStore, s as useWorkflowsStore, tn as useProjectsStore } from "./users.store-DI4bmc3m.js";
import { t as useToast } from "./useToast-iCe0kksm.js";
import { Hr as AGENT_BUILDER_VIEW, To as Workflow, Wr as AGENT_SESSION_DETAIL_VIEW, Xr as CONTINUE_SESSION_ID_PARAM, ii as VIEWS, xl as WorkflowIdKey } from "./constants-CVUc8I0d.js";
import { o as truncate } from "./dist-Dgt364MK.js";
import { t as useExecutionsStore } from "./executions.store-_2bW2z4d.js";
import { i as NodeErrorView_default, t as RunData_default } from "./RunData-CM8_UQcC.js";
import { l as shouldIgnoreCanvasShortcut } from "./canvas.utils-nLDgirzO.js";
import { y as ChatSymbol } from "./useCanvasOperations-KyKH8yE-.js";
import { n as useWorkflowState } from "./useWorkflowState-BPU5tE97.js";
import { t as VueMarkdown } from "./VueMarkdown-CoHzQ2Pr.js";
import { t as convertToDisplayDate } from "./dateFormatter-DL19iitC.js";
import { d as flattenLogEntries, h as getSubtreeTotalConsumedTokens, o as createLogTree, t as LogsOverviewRow_default } from "./LogsOverviewRow-CaZ_V1kX.js";
...
function timelineItemSearchText(item, labelForKey) {
	...
	if (item.kind === "working-memory") parts.push(labelForKey("working-memory-updated"));
	else if (item.kind === "suspension") parts.push(labelForKey("suspension-waiting"));
...
function flattenExecutionsToTimelineItems(executions) {
	...
	for (const exec of executions) {
		...
		} else if (event.type === "working-memory") items.push({
			kind: "working-memory",
			executionId: exec.id,
			content: event.content,
	...
	setup(__props) {
		...
		const icon = computed(() => {
			switch (props.kind) {
				...
				case "working-memory": return "brain";
				case "suspension":
	...
	setup(__props, { emit: __emit }) {
		...
		function popoverLabel(item) {
			switch (item.kind) {
				...
				case "working-memory": return i18n.baseText("agentSessions.timeline.memory");
		...
		function popoverName(item) {
			switch (item.kind) {
				...
				case "working-memory": return i18n.baseText("agentSessions.timeline.memoryUpdated");
	...
	setup(__props, { emit: __emit }) {
		...
		function labelForKey(key) {
			switch (key) {
				...
				case "node": return i18n.baseText("agentSessions.timeline.node");
				case "working-memory": return i18n.baseText("agentSessions.timeline.memory");
				case "working-memory-updated": return i18n.baseText("agentSessions.timeline.memoryUpdated");
				case "suspension": return i18n.baseText("agentSessions.timeline.suspended");
...
var SessionTimelineTable_vue_vue_type_style_index_0_lang_module_default = {
	table: "_table_p2749_126",
	rowWrapper: "_rowWrapper_p2749_132",
	empty: "_empty_p2749_136",
	canScrollDown: "_canScrollDown_p2749_153",
	canScrollUp: "_canScrollUp_p2749_157",
	idleRow: "_idleRow_p2749_165",
	idlePill: "_idlePill_p2749_178"
};
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.panel) }, [__props.item ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.header) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.headerTitle) }, [createVNode(unref(N8nIcon_default), {
				...
				class: normalizeClass(_ctx.$style.json),
				innerHTML: highlightJson(ensureParsed(__props.item.toolOutput))
			}, null, 10, _hoisted_4)], 2)])], 64))], 64)) : __props.item.kind === "node" ? (openBlock(), createBlock(ToolIoView_default, {
				key: 2,
				name: (__props.item.nodeDisplayName ?? unref(formatToolNameForDisplay)(__props.item.toolName)) || "node",
				input: __props.item.toolInput,
				output: __props.item.toolOutput,
				"node-type": __props.item.nodeType,
				"node-type-version": __props.item.nodeTypeVersion,
				...
				"node-type-version",
				"node-parameters"
			])) : __props.item.kind === "working-memory" ? (openBlock(), createElementBlock("div", {
				key: 3,
				class: normalizeClass(_ctx.$style.codeBlock)
			}, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.codeBlockCopy) }, [createVNode(unref(N8nTooltip_default), { content: copiedBlock.value === "working-memory" ? unref(i18n).baseText("agents.builder.addTrigger.copied") : unref(i18n).baseText("agents.builder.addTrigger.copy") }, {
				default: withCtx(() => [createVNode(unref(N8nButton_default), {
					variant: "outline",
					size: "small",
					"icon-only": "",
					icon: copiedBlock.value === "working-memory" ? "check" : "copy",
					"aria-label": copiedBlock.value === "working-memory" ? unref(i18n).baseText("agents.builder.addTrigger.copied") : unref(i18n).baseText("agents.builder.addTrigger.copy"),
					onClick: _cache[4] || (_cache[4] = ($event) => copyJsonBlock("working-memory", __props.item.content))
				}, null, 8, ["icon", "aria-label"])]),
				_: 1
			}, 8, ["content"])], 2), createBaseVNode("pre", { class: normalizeClass(_ctx.$style.json) }, toDisplayString(__props.item.content), 3)], 2)) : __props.item.kind === "user" || __props.item.kind === "agent" ? (openBlock(), createBlock(unref(VueMarkdown), {
				key: 4,
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.view) }, [
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.topBar) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.topBarLeft) }, [createVNode(unref(N8nBreadcrumbs_default), {
					...
					triggerSource.value === "chat" ? (openBlock(), createElementBlock("button", {
						key: 1,
						...
						icon: "message-square",
						size: 12
					}), createTextVNode(" " + toDisplayString(unref(i18n).baseText("agentSessions.timeline.continueChat")), 1)], 2)) : createCommentVNode("", true)
...
var AgentSessionTimelineView_vue_vue_type_style_index_0_lang_module_default = {
	view: "_view_bsnnb_138",
	topBar: "_topBar_bsnnb_145",
	topBarLeft: "_topBarLeft_bsnnb_156",
	topBarRight: "_topBarRight_bsnnb_163",
	sep: "_sep_bsnnb_174",
	metricItem: "_metricItem_bsnnb_178",
	crumbSeparator: "_crumbSeparator_bsnnb_185",
	switcherButton: "_switcherButton_bsnnb_191",
	switcherLabel: "_switcherLabel_bsnnb_197",
	sessionDropdownMenu: "_sessionDropdownMenu_bsnnb_204",
	sessionDropdownName: "_sessionDropdownName_bsnnb_215",
	sessionDropdownDate: "_sessionDropdownDate_bsnnb_223",
	sessionTitle: "_sessionTitle_bsnnb_231",
	continueButton: "_continueButton_bsnnb_237",
	subHeader: "_subHeader_bsnnb_255",
	search: "_search_bsnnb_265",
	chartRow: "_chartRow_bsnnb_270",
	panels: "_panels_bsnnb_277",
	tablePanel: "_tablePanel_bsnnb_283",
	detailPanel: "_detailPanel_bsnnb_291",
	loading: "_loading_bsnnb_328"
};
