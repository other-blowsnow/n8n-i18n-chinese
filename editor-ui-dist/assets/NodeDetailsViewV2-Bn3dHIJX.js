...
import { it as useI18n, p as useElementSize } from "./core-CzIVo7k9.js";
import { Ai as N8nTooltip_default, Ca as N8nText_default, Fi as N8nIconButton_default, Mt as useDeviceSupport, Ta as N8nIcon_default, bt as createEventBus, k as N8nResizeWrapper_default, p as N8nInlineTextEdit_default, tt as N8nLink_default } from "./src-DVkMmVCd.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { a as InputPanel_default } from "./ParameterInputList-VigjHxcD.js";
import { t as useMessage } from "./useMessage-B0gp0e5D.js";
import { Jr as LOCAL_STORAGE_NDV_PANEL_WIDTH, b as useNodeTypesStore, cn as injectNDVStore, fn as injectWorkflowDocumentStore, r as useUIStore, rn as useTelemetry, s as useWorkflowsStore, xn as useNodeHelpers } from "./users.store-Dpbobzbe.js";
import { Qt as EXECUTABLE_TRIGGER_NODE_TYPES, fs as getNodeOutputs, qs as jsonParse, uc as NodeConnectionTypes, w as APP_MODALS_ELEMENT_ID } from "./constants-B2-iseoM.js";
...
import { a as dataPinningEventBus, t as nodeViewEventBus } from "./event-bus-Ccdzpa6T.js";
import { t as usePinnedData } from "./usePinnedData-B8t7zGgW.js";
import { t as getNodeIconSize } from "./nodeIcon-Dym8oa4A.js";
...
import { n as useNodeDocsUrl, t as NodeSettings_default } from "./NodeSettings-CKbmXVXn.js";
import { t as useKeybindings } from "./useKeybindings-DrLA4XhJ.js";
import { n as OutputPanel_default, r as NDVFloatingNodes_default, t as TriggerPanel_default } from "./TriggerPanel-DBrOeavN.js";
...
var NodeDetailsViewV2_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const parentNodes = computed(() => {
			if (activeNode.value) return workflowObject.value?.getParentNodesByDepth(activeNode.value.name, 1).map(({ name }) => name) || [];
			else return [];
		});
		...
		const inputNodeName = computed(() => {
			...
			}).length > 0 && activeNode.value) return workflowObject.value?.getChildNodes(activeNode.value.name, "ALL_NON_MAIN")?.[0];
		...
		return (_ctx, _cache) => {
			return unref(activeNode) && !isActiveStickyNode.value ? (openBlock(), createBlock(Teleport, {
				...
				}, [workflowObject.value ? (openBlock(), createBlock(OutputPanel_default, {
					key: 0,
