...
const generateVersionNameFromId = (versionId) => {
	return `Version ${versionId.substring(0, 8)}`;
};
const getVersionLabel = (workflowHistoryItem) => {
...
const getActiveVersionId = (workflow) => {
	if (!workflow) return;
	return workflow.activeVersionId ?? workflow.activeVersion?.versionId ?? void 0;
};
export { getLastPublishedVersion as a, getActiveVersionId as i, formatTimestamp as n, getVersionLabel as o, generateVersionNameFromId as r, computeTimelineEntries as t };
