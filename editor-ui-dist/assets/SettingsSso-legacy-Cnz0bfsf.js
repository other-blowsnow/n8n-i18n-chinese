;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-2Qb71DGn.js", "./src-legacy-BL8uywAx.js", "./en-legacy-s6H-lEA2.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-ZZ87M1Mo.js", "./icon-legacy-CRT-hvlv.js", "./overlay-legacy-m4tN0qRV.js", "./empty-legacy-CsIOGMHW.js", "./useMessage-legacy-B0itSvLh.js", "./useTelemetry-legacy-Ck7lGOrk.js", "./useToast-legacy-tN8taI-S.js", "./sanitize-html-legacy-Cack6L-S.js", "./path-browserify-legacy-BQKq4wLb.js", "./constants-legacy-D0ziSY9e.js", "./merge-legacy-BVgKBTAX.js", "./useRootStore-legacy-D1vvqLPX.js", "./dateformat-legacy-BaeIHy_2.js", "./useDebounce-legacy-B8z7M2-W.js", "./useExternalHooks-legacy-DgS1u46v.js", "./useStyles-legacy-DnD2qvTK.js", "./cloudPlan.store-legacy-Uv9UJvN5.js", "./useClipboard-legacy-C1DalLye.js", "./versions.store-legacy-DvrrUt8o.js", "./usePageRedirectionHelper-legacy-BOS_Zm4X.js", "./CopyInput-legacy-edZdXnDV.js", "./sso.store-legacy-FlNedFeU.js"], function (_export, _context) {
    "use strict";

    var computed, createElementBlock, createCommentVNode, unref, ref, createVNode, defineComponent, toDisplayString, createBlock, onMounted, Fragment, normalizeClass, withCtx, openBlock, withModifiers, renderList, createTextVNode, createBaseVNode, useI18n, ElSwitch, N8nInfoTip_default, N8nHeading_default, N8nSelect_default, N8nOption_default, N8nActionBox_default, N8nButton_default, N8nRadioButtons_default, N8nInput_default, N8nTooltip_default, __plugin_vue_export_helper_default, useMessage, useDocumentTitle, useTelemetry, useToast, MODAL_CONFIRM, useRootStore, usePageRedirectionHelper, CopyInput_default, useSSOStore, SupportedProtocols, __vite_style__, _hoisted_1, _hoisted_2, _hoisted_3, _hoisted_4, _hoisted_5, _hoisted_6, _hoisted_7, _hoisted_8, _hoisted_9, SettingsSso_vue_vue_type_script_setup_true_lang_default, heading, buttons, group, actionBox, footer, SettingsSso_vue_vue_type_style_index_0_lang_module_default, cssModules, SettingsSso_default;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
      ...
      }, function (_dateformatLegacy00VJs) {}, function (_useDebounceLegacy00XJs) {}, function (_useExternalHooksLegacy00ZJs) {}, function (_useStylesLegacy00$Js) {}, function (_cloudPlanStoreLegacy017Js) {}, function (_useClipboardLegacy01rJs) {}, function (_versionsStoreLegacy01FJs) {}, function (_usePageRedirectionHelperLegacy01HJs) {
        ...
        SupportedProtocols = _ssoStoreLegacy033Js.t;
      }],
      execute: function () {
        ...
        SettingsSso_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            return (_ctx, _cache) => {
              return openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("div", {
              ...
              }, [_cache[10] || (_cache[10] = createBaseVNode("label", null, "Select Authentication Protocol", -1)), createBaseVNode("div", null, [createVNode(unref(N8nSelect_default), {
                filterable: "",
                ...
                class: normalizeClass(_ctx.$style.group)
              }, [_cache[11] || (_cache[11] = createBaseVNode("label", null, "Redirect URL", -1)), createVNode(CopyInput_default, {
                value: unref(ssoStore).oidc.callbackUrl,
                "copy-button-text": unref(i18n).baseText("generic.clickToCopy"),
                "toast-title": "Redirect URL copied to clipboard"
              }, null, 8, ["value", "copy-button-text"]), _cache[12] || (_cache[12] = createBaseVNode("small", null, "Copy the Redirect URL to configure your OIDC provider ", -1))], 2), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.group)
              }, [_cache[13] || (_cache[13] = createBaseVNode("label", null, "Discovery Endpoint", -1)), createVNode(unref(N8nInput_default), {
              ...
              }, null, 8, ["model-value"]), _cache[14] || (_cache[14] = createBaseVNode("small", null, "Paste here your discovery endpoint", -1))], 2), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.group)
              }, [_cache[15] || (_cache[15] = createBaseVNode("label", null, "Client ID", -1)), createVNode(unref(N8nInput_default), {
                "model-value": clientId.value,
                type: "text",
                "data-test-id": "oidc-client-id",
                "onUpdate:modelValue": _cache[6] || (_cache[6] = v => clientId.value = v)
              }, null, 8, ["model-value"]), _cache[16] || (_cache[16] = createBaseVNode("small", null, "The client ID you received when registering your application with your provider", -1))], 2), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.group)
              }, [_cache[17] || (_cache[17] = createBaseVNode("label", null, "Client Secret", -1)), createVNode(unref(N8nInput_default), {
              ...
              }, null, 8, ["model-value"]), _cache[18] || (_cache[18] = createBaseVNode("small", null, "The client Secret you received when registering your application with your provider", -1))], 2), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.group)
              }, [_cache[19] || (_cache[19] = createBaseVNode("label", null, "Prompt", -1)), createVNode(unref(N8nSelect_default), {
                ...
                _: 1
              }, 8, ["model-value"]), _cache[20] || (_cache[20] = createBaseVNode("small", null, "The prompt parameter to use when authenticating with the OIDC provider", -1))], 2), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.group)
              }, [_cache[21] || (_cache[21] = createBaseVNode("label", null, "Authentication Context Class Reference", -1)), createVNode(unref(N8nInput_default), {
              ...
              }, null, 8, ["model-value"]), _cache[22] || (_cache[22] = createBaseVNode("small", null, "ACR values to include in the authorization request (acr_values parameter), separated by commas in order of preference.", -1))], 2), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.group)
              }, [createVNode(unref(ElSwitch), {
                modelValue: unref(ssoStore).isOidcLoginEnabled,
                "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => unref(ssoStore).isOidcLoginEnabled = $event),
