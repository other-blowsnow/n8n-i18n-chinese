const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CYipX2wS.js","assets/index-Dq4vLtnx.js","assets/index-COleXxZf.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CVhBLT2A.js","assets/chartjs.utils-Cv0JLC4F.js","assets/InsightsSummary-D4zX_kSf.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-1AJ7xOdy.js","assets/InsightsChartFailed-Dns5tKHU.js","assets/InsightsChartFailureRate-DZcoRuq-.js","assets/InsightsChartTimeSaved-BD24Pl3a.js","assets/InsightsChartAverageRuntime-BFMldjv_.js","assets/InsightsTableWorkflows-BlSshPwm.js","assets/N8nDataTableServer-DLjJe2CP.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cU as useModel, hj as useInsightsStore, r as ref, hz as UNLICENSED_TIME_RANGE, hn as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, f2 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, f1 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hA as ElDialog, al as usePageRedirectionHelper, _ as _export_sfc, et as defineAsyncComponent, aa as watch, o as onMounted, ai as useDocumentTitle, m as N8nHeading, n as normalizeClass, eE as _sfc_main$4, b_ as resolveDynamicComponent, ay as useTelemetry, hB as TELEMETRY_TIME_RANGE, aI as __vitePreload } from "./index-Dq4vLtnx.js";
import { I as InsightsSummary } from "./InsightsSummary-D4zX_kSf.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CYipX2wS.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CVhBLT2A.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Dns5tKHU.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-DZcoRuq-.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BD24Pl3a.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BFMldjv_.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-BlSshPwm.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
