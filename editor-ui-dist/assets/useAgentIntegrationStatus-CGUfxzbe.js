...
import { a as ResponseError, t as useRootStore } from "./useRootStore-CDKkkplG.js";
import "./settings.store-C8To3Sgr.js";
import { c as connectIntegration, p as disconnectIntegration, v as getIntegrationStatus, x as listAgentIntegrations } from "./agentTelemetry.utils-BrAfTLZy.js";
...
function useAgentIntegrationStatus(projectId, agentId) {
	...
	async function connect(type, credId, settings) {
		...
		try {
			await connectIntegration(rootStore.restApiContext, projectId, agentId, type, credId, settings);
