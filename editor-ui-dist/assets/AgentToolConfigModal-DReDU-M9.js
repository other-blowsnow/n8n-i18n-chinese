...
import { Ca as N8nText_default, M as N8nRadioButtons_default, Pi as Input_default, Ta as N8nIcon_default, dt as Checkbox_default, p as N8nInlineTextEdit_default, wa as N8nButton_default } from "./src-yoaEB2ny.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { r as useUIStore } from "./users.store-C7j4ikpF.js";
import { t as Modal_default } from "./Modal-4w8-Dtde.js";
import { H as EditorView, ht as EditorState, nt as lineNumbers } from "./dist-Cs83JkaM.js";
import { t as javascript } from "./dist-DxbFz15X.js";
import { t as codeEditorTheme } from "./theme-BLwKbWEt.js";
import { t as NodeIcon_default } from "./NodeIcon-y3CjoN8i.js";
import { t as NodeToolSettingsContent_default } from "./NodeToolSettingsContent-C5ABlSmw.js";
import { a as updateWorkflowToolRef, i as updateToolRefFromNode, r as toolRefToNode } from "./useAgentToolRefAdapter-C44gLFng.js";
import { t as AgentJsonEditor_default } from "./AgentJsonEditor-BU5YfeYa.js";
...
var AgentToolConfigModal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		*/
		...
		const nodeName = ref(computed(() => props.data.toolRef.name ?? initialNode.value?.name ?? "").value);
		const customToolCode = computed(() => props.data.customTool?.code ?? "");
		const customToolTitle = computed(() => props.data.customTool?.descriptor.name ?? props.data.toolRef.name ?? props.data.toolRef.id ?? i18n.baseText("agents.builder.tree.customBadge"));
		...
		return (_ctx, _cache) => {
			return canRender.value ? (openBlock(), createBlock(Modal_default, {
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass([_ctx.$style.contentWrapper, (isCustomTool.value || activeView.value === "raw") && _ctx.$style.codeContentWrapper]) }, [isCustomTool.value ? (openBlock(), createBlock(AgentCustomToolViewer_default, {
					...
					withDirectives(createBaseVNode("div", { class: normalizeClass(_ctx.$style.configureTab) }, [isWorkflowTool.value ? (openBlock(), createBlock(WorkflowToolConfigContent_default, {
						key: 0,
