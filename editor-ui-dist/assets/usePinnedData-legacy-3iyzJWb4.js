;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-2Qb71DGn.js", "./useTelemetry-legacy-Ck7lGOrk.js", "./useToast-legacy-tN8taI-S.js", "./constants-legacy-D0ziSY9e.js", "./useRootStore-legacy-D1vvqLPX.js", "./useExternalHooks-legacy-DgS1u46v.js"], function (_export, _context) {
    "use strict";

    var computed, unref, useI18n, toMegaBytes, useDataSchema, useWorkflowsStore, useNodeTypesStore, useTelemetry, stringSizeInBytes, useToast, MAX_WORKFLOW_SIZE, isSubNodeType, MAX_EXPECTED_REQUEST_SIZE, MAX_PINNED_DATA_SIZE, getNodeOutputs, jsonParse, jsonStringify, NodeConnectionTypes, PIN_DATA_NODE_TYPES_DENYLIST, useRootStore, useExternalHooks;
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        MAX_WORKFLOW_SIZE = _constantsLegacy00NJs.Fs;
        isSubNodeType = _constantsLegacy00NJs.Ni;
        MAX_EXPECTED_REQUEST_SIZE = _constantsLegacy00NJs.Ns;
        MAX_PINNED_DATA_SIZE = _constantsLegacy00NJs.Ps;
        getNodeOutputs = _constantsLegacy00NJs.Si;
        jsonParse = _constantsLegacy00NJs.Xi;
        jsonStringify = _constantsLegacy00NJs.Zi;
