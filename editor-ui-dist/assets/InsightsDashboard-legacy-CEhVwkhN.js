;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BGDm4XBh.js", "./src-legacy-6DYpZVh_.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-BWv-BWgW.js", "./icon-legacy-B_qPQAkZ.js", "./overlay-legacy-CKxjEHQ2.js", "./empty-legacy-ZG0-xpne.js", "./dialog-legacy-ZOm2ObnR.js", "./useTelemetry-legacy-z15msZ3G.js", "./useToast-legacy-BYJycbCO.js", "./sanitize-html-legacy-D7fDKXy5.js", "./path-browserify-legacy-BRGcgaOH.js", "./constants-legacy-lM1Uv86G.js", "./merge-legacy-CyNDE0Ib.js", "./_baseOrderBy-legacy-DT_yzgQM.js", "./dateformat-legacy-C7RFTAF8.js", "./useDebounce-legacy-B0zW2D-C.js", "./useExternalHooks-legacy-D--WxRfr.js", "./useStyles-legacy-CJudPaTy.js", "./cloudPlan.store-legacy-CaAxcbYV.js", "./versions.store-legacy-GXtvQmrr.js", "./usePageRedirectionHelper-legacy-BYf33Ms4.js", "./ProjectIcon-legacy-ByRpi0-Z.js", "./orderBy-legacy-C52GdvwP.js", "./ProjectSharing-legacy-B3p6DDWi.js", "./insights.store-legacy-BA4cTmK7.js", "./insights.constants-legacy-BcO47XGR.js", "./insights.utils-legacy-BIH8A6hh.js", "./smartDecimal-legacy-iG84Poh8.js", "./InsightsSummary-legacy-CDs-s8rk.js"], function (_export, _context) {
    "use strict";
    ...
    return {
      ...
      execute: function () {
        ...
        InsightsDashboard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            const InsightsPaywall = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsPaywall-legacy-82o7xgxI.js"), true               ? void 0 : void 0));
            const InsightsChartTotal = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTotal-legacy-C2d4OVRU.js"), true               ? void 0 : void 0));
            const InsightsChartFailed = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailed-legacy-dDHGjHLX.js"), true               ? void 0 : void 0));
            const InsightsChartFailureRate = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailureRate-legacy-CWD54El7.js"), true               ? void 0 : void 0));
            const InsightsChartTimeSaved = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTimeSaved-legacy-D76Gdi4Y.js"), true               ? void 0 : void 0));
            const InsightsChartAverageRuntime = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartAverageRuntime-legacy-Dt4R6a88.js"), true               ? void 0 : void 0));
            const InsightsTableWorkflows = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsTableWorkflows-legacy-DFLwRZel.js"), true               ? void 0 : void 0));
            const props = __props;
