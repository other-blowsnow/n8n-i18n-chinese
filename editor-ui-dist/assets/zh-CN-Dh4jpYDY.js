const _reusableBaseText = { "cancel": "取消", "codeNodeEditor": { "linter": { "useJson": "访问 `.json` 下的项目属性，例如 `item.json`" }, "completer": { "all": "返回节点输出项的数组", "first": "返回节点输出的第一个项目", "last": "返回节点输出的最后一个项目", "itemMatching": "返回匹配的项目，即用于在指定索引处生成当前节点中项目的项目。" } }, "name": "名称", "save": "保存", "dismiss": "忽略", "unlimited": "无限", "activate": "激活", "error": "错误", "user": "用户", "enabled": "已启用", "disabled": "已禁用", "type": "类型", "roles": { "editor": "编辑器", "admin": "管理员", "viewer": "观众" }, "role": "角色" };
...
const zhCN = {
  ...
  "runData.trimmedData.title": "尚无数据",
  "runData.trimmedData.message": "执行完成后，数据将在此处可用。",
  ...
  "dataStore.dataStores": "数据表格",
  "dataStore.empty.label": "您还没有任何数据表。",
  "dataStore.empty.description": "使用数据表来持久化执行结果，分享工作流之间的数据，并跟踪评估指标。",
  "dataStore.card.size": "{size}MB",
  "dataStore.card.column.count": "{count} 列 | {count} 列",
  "dataStore.card.row.count": "{count} 条记录 | {count} 条记录",
  "dataStore.sort.lastUpdated": "按最后更新时间排序",
  "dataStore.sort.lastCreated": "按最后创建时间排序",
  ...
  "dataStore.rename.error": "重命名数据表时出现错误",
  "dataStore.getDetails.error": "获取数据表详细信息时出错",
  "dataStore.notFound": "数据表未找到",
  "dataStore.noColumns.heading": "还没有列",
  "dataStore.noColumns.description": "在此数据表中添加列以开始存储数据。",
  ...
  "dataStore.addColumn.alreadyExistsError": "此列已经存在",
  "dataStore.addColumn.alreadyExistsDescription": "列名已存在，请选择不同的名称。",
  ...
  "dataStore.addColumn.invalidName.description": "列名必须以字母开头，并且只能包含字母、数字或下划线。",
  ...
  "dataStore.deleteRows.confirmation": "你确定要删除 {count} 行吗？ | 你确定要删除 {count} 行吗？",
  "dataStore.deleteRows.error": "删除行时出错",
  "dataStore.banner.storageLimitWarning.message": "使用的Data tables存储的{usage}。请删除数据以避免错误。",
  "dataStore.banner.storageLimitError.message": "数据表存储的 {usage} 已达到，操作可能会失败。请删除数据以避免错误。",
  "dataStore.error.tableNotInitialized": "表未初始化",
  "dataStore.noRows": "没有行",
  "settings.ldap": "LDAP",
