const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-CmD_AjZQ.js","assets/chunk-CC9Q-vWm.js","assets/core-DW0KLzcX.js","assets/languageModules-7eNyAP4k.js","assets/xml-BIRtwBD9.js"])))=>i.map(i=>d[i]);
...
import { Ji as truncateBeforeLast, Oa as N8nButton_default } from "./src-DFOx8N22.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-CmD_AjZQ.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-7eNyAP4k.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
