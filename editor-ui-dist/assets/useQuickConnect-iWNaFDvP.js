...
import { Gt as useProjectsStore, at as useCredentialsStore, qt as useTelemetry, s as useWorkflowsStore, t as useUsersStore } from "./users.store-Bfu2rIUB.js";
import { s as sanitizeHtml, t as useToast } from "./useToast-D9LVQNVI.js";
import { Ha as createResultError, Ua as createResultOk } from "./constants-ixIyBnRU.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-Bh_T0lbL.js");
			return { ConnectPopup };
		}, []);
		return await new Promise((resolve) => {
