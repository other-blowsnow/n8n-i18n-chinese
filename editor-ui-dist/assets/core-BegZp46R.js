...
var zh_CN_default = {
	...
	"settings.encryptionKeys.column.type": "类型",
	...
	"settings.encryptionKeys.sortBy.type": "类型",
	...
	"settings.encryptionKeys.copyId.success": "密钥 ID 已复制到剪贴板",
	...
	"instanceAi.welcomeModal.description": "一个能够代表您修改工作流、凭据和连接服务的代理<br>",
	"instanceAi.welcomeModal.warning": "此功能可能表现异常，并且不建议用于对生产环境至关重要的工作流。",
	"instanceAi.welcomeModal.feature.build": "通过对话构建和编辑工作流",
	"instanceAi.welcomeModal.feature.debug": "调试失败的执行并提出修复建议",
	"instanceAi.welcomeModal.feature.ask": "就 n8n 提出任何问题，即可获得上下文相关的帮助。",
	"instanceAi.welcomeModal.toggle.cardTitle": "在此实例上启用 AI 助手",
	"instanceAi.welcomeModal.toggle.enableCardDescription": "本实例的所有用户",
	"instanceAi.welcomeModal.toggle.disableCardDescription": "你可以稍后在设置中启用。",
	"instanceAi.welcomeModal.toggle.dontEnable": "不要启用",
	"instanceAi.welcomeModal.toggle.enabled": "已启用",
	"instanceAi.welcomeModal.toggle.disabled": "已禁用",
	...
	"instanceAi.welcomeModal.gateway.browserAutomationHint": "需要浏览器自动化吗？请安装 <a href=\"{url}\" target=\"_blank\" rel=\"noopener\">n8n 浏览器使用 Chrome 扩展</a>，以便代理可以控制您的浏览器。"
};
//#endregion
