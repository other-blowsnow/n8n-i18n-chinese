;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./src-legacy-BL8uywAx.js", "./truncate-legacy-ZZ87M1Mo.js", "./icon-legacy-CRT-hvlv.js", "./overlay-legacy-m4tN0qRV.js"], function (_export, _context) {
    "use strict";

    var computed, createElementBlock, createCommentVNode, getCurrentInstance, nextTick, unref, ref, createVNode, defineComponent, toDisplayString, createBlock, mergeProps, onMounted, normalizeClass, watch, renderSlot, Teleport, withCtx, resolveDynamicComponent, openBlock, createSlots, Transition, provide, vShow, useSlots, createBaseVNode, withDirectives, normalizeStyle, inject, ElFocusTrap, FOCUS_TRAP_INJECTION_KEY, useDeprecated, UPDATE_MODEL_EVENT, isUndefined_default, composeRefs, useId, useLocale, useGlobalConfig, defaultNamespace, useZIndex, definePropType, useTimeoutFn, isBoolean, addUnit, isClient, buildProps, useNamespace, CloseComponents, iconPropType, withInstall, _export_sfc, ElIcon, useDraggable, useSameTarget, useLockscreen, ElOverlay, dialogInjectionKey, dialogContentProps, dialogContentEmits, _hoisted_1$1, _hoisted_2, _hoisted_3, ElDialogContent, dialogProps, dialogEmits, useDialog, _hoisted_1, Dialog, ElDialog;
    return {
