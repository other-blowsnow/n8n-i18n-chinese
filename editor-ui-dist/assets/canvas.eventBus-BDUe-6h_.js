...
import { bt as createEventBus } from "./src-pyi3rpL8.js";
import { a as require_toString, o as require__arrayMap, t as require_get } from "./get-Den8eczo.js";
import { $i as getThemedValue, Dr as createCanvasConnectionHandleString, E as useNodeTypesStore, H as finalizeItems, J as isAINode, O as useEvaluationStore, Pr as parseCanvasConnectionHandleString, Q as prepareCommunityNodeDetailsViewStack, U as flattenCreateElements, W as getAiTemplatesCallout, X as mapToolSubcategoryIcon, Z as nodeTypesToCreateElements, et as searchNodes, gt as require_upperFirst, hn as useNDVStore, it as transformNodeType, ln as useTelemetry, nt as sortNodeCreateElements, q as groupItemsInSections, r as useUIStore, ri as CanvasConnectionMode, rt as subcategorizeItems, s as useWorkflowsStore, ti as isVueFlowConnection, vn as injectWorkflowDocumentStore } from "./users.store-CyAaJx7n.js";
import { $ as AI_CATEGORY_TOOLS, B as AI_CATEGORY_AGENTS, Dt as AI_TRANSFORM_NODE_TYPE, Et as AI_MCP_TOOL_NODE_TYPE, G as AI_CATEGORY_LANGUAGE_MODELS, Gn as REMOVE_DUPLICATES_NODE_TYPE, Gt as DATETIME_NODE_TYPE, H as AI_CATEGORY_DOCUMENT_LOADERS, Ho as require__arrayIncludesWith, Ht as CRYPTO_NODE_TYPE, It as CODE_NODE_TYPE, J as AI_CATEGORY_OTHER_TOOLS, K as AI_CATEGORY_MCP_NODES, Lc as v4, Lt as COMPRESSION_NODE_TYPE, Oo as require__createCompounder, Pt as CHAT_TRIGGER_NODE_TYPE, Q as AI_CATEGORY_TEXT_SPLITTERS, Qn as SET_NODE_TYPE, Rt as CONVERT_TO_FILE_NODE_TYPE, Sn as MARKDOWN_NODE_TYPE, Tc as EVALUATION_TRIGGER_NODE_TYPE, Tn as MESSAGE_AN_AGENT_NODE_TYPE, U as AI_CATEGORY_EMBEDDING, Uc as require__cacheHas, Uo as require__arrayIncludes, V as AI_CATEGORY_CHAINS, Wc as require__SetCache, Ws as isCommunityPackageName, Wt as DATA_TABLE_NODE_TYPE, X as AI_CATEGORY_RETRIEVERS, Xt as EMAIL_SEND_NODE_TYPE, Y as AI_CATEGORY_OUTPUTPARSER, Yn as SCHEDULE_TRIGGER_NODE_TYPE, Yt as EMAIL_IMAP_NODE_TYPE, Z as AI_CATEGORY_ROOT_NODES, _t as REGULAR_NODE_CREATOR_VIEW, an as FORM_TRIGGER_NODE_TYPE, at as AI_UNCATEGORIZED_CATEGORY, br as XML_NODE_TYPE, bt as TRANSFORM_DATA_SUBCATEGORY, cn as HTML_NODE_TYPE, ct as CORE_NODES_CATEGORY, dt as HITL_SUBCATEGORY, et as AI_CATEGORY_VECTOR_STORES, fn as IF_NODE_TYPE, ft as HUMAN_IN_THE_LOOP_CATEGORY, ht as OTHER_TRIGGER_NODES_SUBCATEGORY, ir as SPLIT_OUT_NODE_TYPE, lc as NodeConnectionTypes, ln as HTTP_REQUEST_NODE_TYPE, lt as FLOWS_CONTROL_SUBCATEGORY, mr as WEBHOOK_NODE_TYPE, mt as NODE_CREATOR_OPEN_SOURCES, nn as EXTRACT_FROM_FILE_NODE_TYPE, ot as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, po as require__baseFlatten, pt as NEW_TOOL_CATEGORIES, q as AI_CATEGORY_MEMORY, qn as RSS_READ_NODE_TYPE, qt as EDIT_IMAGE_NODE_TYPE, rn as FILTER_NODE_TYPE, rr as SPLIT_IN_BATCHES_NODE_TYPE, rt as AI_OTHERS_NODE_CREATOR_VIEW, sr as SUMMARIZE_NODE_TYPE, tn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, us as getNodeInputs, ut as HELPERS_SUBCATEGORY, vn as LIMIT_NODE_TYPE, wn as MERGE_NODE_TYPE, wt as AGGREGATE_NODE_TYPE, xn as MANUAL_TRIGGER_NODE_TYPE, xs as isHitlToolType, xt as TRIGGER_NODE_CREATOR_VIEW, yt as TEMPLATE_CATEGORY_AI } from "./constants-Dxn6bmLi.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-C54RGJnN.js";
import { T as defineStore } from "./useRootStore-DPt_yVCx.js";
...
import { n as getNodeIconSource } from "./nodeIcon-BBXuan6j.js";
...
var useNodeCreatorStore = defineStore(STORES.NODE_CREATOR, () => {
	...
	function setNodeCreatorState({ source, createNodeActive, nodeCreatorView, connectionType }) {
		if (!nodeCreatorView) nodeCreatorView = workflowDocumentStore.value.workflowTriggerNodes.length > 0 ? REGULAR_NODE_CREATOR_VIEW : TRIGGER_NODE_CREATOR_VIEW;
