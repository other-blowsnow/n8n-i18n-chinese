const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataTable-CI1eWKN9.js","assets/index-BxcQLnKq.js","assets/index-DH8MNLw5.css","assets/useExecutionHelpers-jxXCvVWj.js","assets/RunDataTable-CUxj7dHx.css","assets/RunDataJson-D2mVIU3l.js","assets/FileSaver.min-D6nf5nQG.js","assets/RunDataJson-BH9HLoGC.css","assets/RunDataParsedAiContent-lUuQpLVs.js","assets/RunDataParsedAiContent-9EEUzCKp.css","assets/RunDataSearch-CC4icf6Y.js","assets/RunDataSearch-R6qtl0Jf.css"])))=>i.map(i=>d[i]);
import { eY as hasKey, cb as getDefaultExportFromCjs, d as defineComponent, r as ref, eZ as MarkdownIt, q as computed, aq as h, b2 as isRef, e_ as isReactive, e$ as isProxy, eq as toRaw, f0 as AGENT_LANGCHAIN_NODE_TYPE, bg as useClipboard, a as useToast, f1 as useAIAssistantHelpers, bz as useNodeTypesStore, as as useNDVStore, Z as useRootStore, eM as useAssistantStore, H as useUIStore, f2 as MAX_DISPLAY_DATA_SIZE, eO as isCommunityPackageName, c as useI18n, h as resolveComponent, bN as resolveDirective, i as createElementBlock, g as openBlock, n as normalizeClass, k as createBaseVNode, f as createCommentVNode, aA as withDirectives, t as toDisplayString, j as createVNode, m as unref, f3 as InlineAskAssistantButton, w as withCtx, aT as _sfc_main$b, l as createTextVNode, F as Fragment, D as renderList, f4 as NEW_ASSISTANT_SESSION_MODAL, cT as sanitizeHtml, by as NodeConnectionTypes, f5 as isObjectEmpty, bf as N8nText, b3 as withModifiers, _ as _export_sfc, f6 as requireVue, f7 as sanitizeHtml$1, f8 as sanitizeHtmlExports, Q as useWorkflowsStore, o as onMounted, dc as jsonParse, e as createBlock, bA as useNodeHelpers, aR as N8nTooltip, aS as N8nLink, X as watch, bM as N8nRadioButtons, aV as createSlots, bJ as N8nIcon, a0 as useSourceControlStore, eN as useSchemaPreviewStore, R as useRoute, bL as toRef, bl as usePinnedData, f9 as useNodeType, e0 as storeToRefs, fa as TRIMMED_TASK_DATA_CONNECTIONS_KEY, fb as executionDataToJson, fc as NODE_TYPES_EXCLUDED_FROM_OUTPUT_NAME_APPEND, fd as CORE_NODES_CATEGORY, fe as computedAsync, bW as ndvEventBus, ag as useTelemetry, y as onBeforeUnmount, aJ as useStorage, ff as LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG, fg as dataPinningEventBus, fh as LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG, fi as searchInObject, bw as getConnectionTypes, fj as isObject, fk as MAX_DISPLAY_DATA_SIZE_SCHEMA_VIEW, fl as HTML_NODE_TYPE, x as renderSlot, dk as N8nCallout, fm as DATA_PINNING_DOCS_URL, aB as vShow, cN as Suspense, dj as defineAsyncComponent, b5 as normalizeProps, b8 as mergeProps, bh as N8nButton, fn as _sfc_main$c, fo as N8nSelect, fp as N8nTabs, b6 as guardReactiveProps, fq as _sfc_main$d, fr as JsonEditor, fs as DATA_EDITING_DOCS_URL, eA as InfoTip, ft as N8nBlockUi, ao as __vitePreload, c6 as isPresent, bx as getNodeOutputs, fu as getGenericHints, fv as clearJsonKey, fw as TEST_PIN_DATA, aP as useExternalHooks, fx as isEmpty, cK as isEqual } from "./index-BxcQLnKq.js";
import { F as FileSaver_minExports } from "./FileSaver.min-D6nf5nQG.js";
import { u as useExecutionHelpers } from "./useExecutionHelpers-jxXCvVWj.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-CI1eWKN9.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-D2mVIU3l.js"), true ? __vite__mapDeps([5,1,2,6,3,7]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-BxcQLnKq.js").then((n) => n.ii), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataAi = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataParsedAiContent-lUuQpLVs.js"), true ? __vite__mapDeps([8,1,2,6,3,9]) : void 0)
    );
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-CC4icf6Y.js"), true ? __vite__mapDeps([10,1,2,11]) : void 0)
    );
    const props = __props;
    const emit = __emit;
