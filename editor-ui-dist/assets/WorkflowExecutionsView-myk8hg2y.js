import { d as defineComponent, a3 as useRoute, dQ as useExecutionHelpers, a2 as useWorkflowsStore, v as useSettingsStore, x as computed, aF as EnterpriseEditionFeature, c as useI18n, o as onMounted, a9 as resolveComponent, h as createElementBlock, g as openBlock, n as normalizeClass, i as createVNode, l as unref, V as VIEWS, w as withCtx, j as createBaseVNode, e as createBlock, f as createCommentVNode, p as N8nText, k as createTextVNode, t as toDisplayString, b$ as toDayMonth, dR as _sfc_main$4, b_ as toTime, N as N8nIcon, aN as N8nActionDropdown, aa as Tooltip, _ as _export_sfc, b as useRouter, a_ as useExecutionsStore, aB as usePageRedirectionHelper, r as ref, aC as getResourcePermissions, a8 as watch, m as N8nHeading, dS as N8nLoading, dT as TransitionGroup, F as Fragment, A as renderList, dU as isComponentPublicInstance, az as useWorkflowSaving, dw as onBeforeRouteLeave, dr as getNodeViewTab, L as MAIN_HEADER_TABS, ae as useNodeTypesStore, av as useProjectsStore, a as useToast, P as useDebounce, bU as useCanvasOperations, a4 as PLACEHOLDER_EMPTY_WORKFLOW_ID, dp as NEW_WORKFLOW_ID, X as onBeforeUnmount, dV as NO_NETWORK_ERROR_CODE, am as useTelemetry, dW as executionRetryMessage } from "./index-BXVCKjk6.js";
import { T as Tags } from "./Tags-DbYVCf8q.js";
import { _ as _sfc_main$5, C as ConcurrentExecutionsHeader, E as ExecutionsFilter } from "./ExecutionsTime.vue_vue_type_script_setup_true_lang-aaJrAs5x.js";
import { W as WorkflowExecutionsInfoAccordion } from "./WorkflowExecutionsInfoAccordion-BWbKKwkF.js";
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          _ctx.loading ? (openBlock(), createElementBlock("div", _hoisted_1, [
            createVNode(_component_N8nLoading, { variant: "rect" })
          ])) : createCommentVNode("", true),
...
const WorkflowExecutionsSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$1], ["__scopeId", "data-v-23c53c34"]]);
