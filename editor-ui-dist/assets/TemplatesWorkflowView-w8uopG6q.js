        ...
        header: withCtx(() => [
          !notFoundError.value ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              ...
              template.value && template.value.name ? (openBlock(), createBlock(_component_N8nHeading, {
                key: 0,
                tag: "h1",
                size: "2xlarge"
              }, {
              ...
              template.value && template.value.name ? (openBlock(), createBlock(_component_N8nText, {
                key: 1,
                color: "text-base",
                size: "small"
              }, {
            ...
            createBaseVNode("div", {
              ...
              template.value ? (openBlock(), createBlock(_component_N8nButton, {
                key: 0,
