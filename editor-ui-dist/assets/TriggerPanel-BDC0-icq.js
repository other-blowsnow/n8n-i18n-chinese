...
import { bt as useI18n, h as computedAsync, xt as I18nT } from "./_MapCache-DL4VDRVM.js";
...
import { C as waitingNodeTooltip, Et as useWorkflowHelpers, Ki as getTriggerNodeServiceName, Pr as require_FileSaver_min, en as useTelemetry, f as parseAiContent, hi as CanvasNodeDirtiness, ia as injectWorkflowDocumentStore, in as injectWorkflowState, r as useUIStore, rn as useNDVStore, s as useWorkflowsStore, si as isTriggerPanelObject, u as formatTokenUsageCount, w as useNodeTypesStore } from "./users.store-Bj_XyNBb.js";
import { Ec as MAX_DISPLAY_DATA_SIZE_LOGS_VIEW, Gt as CHAT_TRIGGER_NODE_TYPE, ec as WORKFLOW_SETTINGS_MODAL_KEY, gn as FORM_TRIGGER_NODE_TYPE, ho as NodeConnectionTypes, ms as VIEWS, wr as WEBHOOK_NODE_TYPE } from "./constants-CasV1Nn-.js";
import { N as storeToRefs } from "./_baseOrderBy-CfcpbHUH.js";
import { t as CopyInput_default } from "./CopyInput-CKlMo6S6.js";
import { i as NodeErrorView_default, r as ViewSubExecution_default, t as RunData_default } from "./RunData-BEftQbql.js";
import { t as NDVEmptyState_default } from "./NDVEmptyState-YgsCrfWp.js";
import { n as useNodeType, t as usePinnedData } from "./usePinnedData-CEvgNFnp.js";
import { f as require_capitalize } from "./canvas.eventBus-BcjKaeFN.js";
import { t as NodeIcon_default } from "./NodeIcon-CC7z2JLa.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-DCU6dq1a.js";
import { r as useNodeDirtiness } from "./useRunWorkflow-DJwtSzCb.js";
import { t as useInjectWorkflowId } from "./useInjectWorkflowId-adf-d1AV.js";
import { n as convertToDisplayDateComponents } from "./dateFormatter-DARElawG.js";
import { n as useLogsExecutionData, o as ConsumedTokensDetails_default, r as LogsOverviewRows_default, s as findLogEntryById, t as useLogsTreeExpand, u as getConsumedTokens } from "./useLogsTreeExpand-C_majobD.js";
import { t as useExecutionData } from "./useExecutionData-BmwHLEod.js";
import { n as getReferencedData, t as RunDataParsedAiContent_default } from "./RunDataParsedAiContent-QvRzd1ew.js";
var _hoisted_1$3 = [
	"data-node-name",
	"data-node-placement",
	"onClick"
