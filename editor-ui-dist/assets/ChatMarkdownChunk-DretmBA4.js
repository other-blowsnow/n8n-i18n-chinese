const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-C6Dv66ye.js","assets/chunk-CC9Q-vWm.js","assets/core-nTgY3UvQ.js","assets/languageModules-BNS_h40X.js","assets/xml-DSPlQU-O.js"])))=>i.map(i=>d[i]);
...
import { Ea as N8nButton_default, Vi as truncateBeforeLast } from "./src-D7XhL4SE.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-C6Dv66ye.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-BNS_h40X.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
