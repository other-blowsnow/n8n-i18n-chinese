...
var zh_CN_default = {
	...
	"instanceAi.filesystem.label": "允许 AI 助手连接到我的计算机",
	"instanceAi.filesystem.description": "使 AI 助手能够使用你的本地计算机读取和写入文件、执行命令并使用你的浏览器",
	"instanceAi.filesystem.connected": "已连接的文件",
	...
	"instanceAi.welcomeModal.gateway.description": "允许 AI 助手与本地文件协作、运行终端命令，并控制您的浏览器，以帮助在您的机器上构建自动化。<br><br>它通过 n8n Computer Use 连接，这是一个轻量级的本地进程，您可以随时断开连接。",
	"instanceAi.welcomeModal.gateway.os.mac": "苹果电脑",
	"instanceAi.welcomeModal.gateway.os.windows": "Windows",
	"instanceAi.welcomeModal.gateway.os.linux": "Linux",
	"instanceAi.welcomeModal.gateway.commandLabel": "请将以下内容复制到终端并执行：",
	"instanceAi.welcomeModal.gateway.connected": "连接成功",
	"instanceAi.welcomeModal.gateway.waiting": "正在等待连接...",
	"instanceAi.welcomeModal.gateway.instructions.mac": "打开终端（Cmd + Space，输入“Terminal”）并粘贴上面的命令。稍后你可以在 设置 > 计算机使用 中启用此功能。",
	"instanceAi.welcomeModal.gateway.instructions.windows": "打开终端（按 Windows 键，输入“Terminal”）并粘贴上面的命令。稍后可在 设置 > 计算机使用 中启用它。",
	"instanceAi.welcomeModal.gateway.instructions.linux": "打开你的终端并粘贴上面的命令。稍后你可以在 设置 > 计算机使用 中启用它。",
