const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-C36wKk7a.js","assets/index-BXVCKjk6.js","assets/index-pk1znPBP.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aZ as useNDVStore, cS as useTelemetryContext, r as ref, gs as useElementSize, x as computed, hy as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dA as defineAsyncComponent, dz as Suspense, hz as VueJsonPretty, ht as __unplugin_components_0, n as normalizeClass, hu as MappingPill, go as Draggable, aV as __vitePreload, hv as shorten, hx as getMappedExpression, hA as isString, hB as nonExistingJsonPath, bt as useExternalHooks, am as useTelemetry, _ as _export_sfc } from "./index-BXVCKjk6.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-C36wKk7a.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
