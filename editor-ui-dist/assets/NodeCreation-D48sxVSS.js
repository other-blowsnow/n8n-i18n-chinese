const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-CK_FQCss.js","assets/index-BXVCKjk6.js","assets/index-pk1znPBP.css","assets/NodeCreator-COTYfPaK.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, Q as useUIStore, cO as useFocusPanelStore, fq as useAssistantStore, hI as useActions, h as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, i as createVNode, w as withCtx, ab as _sfc_main$1, l as unref, c as useI18n, cn as KeyboardShortcutTooltip, q as N8nButton, j as createBaseVNode, df as _sfc_main$2, k as createTextVNode, t as toDisplayString, aa as Tooltip, dA as defineAsyncComponent, dz as Suspense, F as Fragment, aV as __vitePreload, dC as NODE_CREATOR_OPEN_SOURCES, hJ as getMidCanvasPosition, b1 as STICKY_NODE_TYPE, am as useTelemetry, hK as DEFAULT_STICKY_WIDTH, hL as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-BXVCKjk6.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-CK_FQCss.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
    ...
    return (_ctx, _cache) => {
      const _component_N8nIconButton = _sfc_main$1;
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        !_ctx.createNodeActive ? (openBlock(), createElementBlock("div", {
          ...
          unref(assistantStore).canShowAssistantButtonsOnCanvas ? (openBlock(), createBlock(_component_N8nTooltip, {
            key: 0,
            placement: "left"
          }, {
            content: withCtx(() => [
