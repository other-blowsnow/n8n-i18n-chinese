;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./src-legacy-BL8uywAx.js", "./truncate-legacy-ZZ87M1Mo.js", "./icon-legacy-CRT-hvlv.js"], function (_export, _context) {
    "use strict";

    var computed, createElementBlock, nextTick, unref, toRefs, ref, defineComponent, reactive, toDisplayString, onMounted, normalizeClass, watch, renderSlot, vModelRadio, openBlock, withModifiers, createTextVNode, isRef, provide, isString, init_shared_esm_bundler, createBaseVNode, withDirectives, normalizeStyle, inject, useFormItemInputId, useFormItem, UPDATE_MODEL_EVENT, useFormDisabled, useId, useFormSize, CHANGE_EVENT, isBoolean, buildProps, useSizeProp, debugWarn, isNumber, useNamespace, withInstall, _export_sfc, withNoopInstall, radioPropsBase, radioProps, radioEmits, radioGroupKey, useRadio, _hoisted_1$2, Radio, radioButtonProps, _hoisted_1$1, RadioButton, radioGroupProps, radioGroupEmits, _hoisted_1, RadioGroup, ElRadio, ElRadioGroup, ElRadioButton;
    return {
