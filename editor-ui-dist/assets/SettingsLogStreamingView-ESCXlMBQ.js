import { d as defineComponent, dX as deepCopy, eG as useLogStreamingStore, r as ref, o as onMounted, eH as defaultMessageEventBusDestinationOptions, b2 as onBeforeMount, x as computed, c as useI18n, eI as assert, a9 as resolveComponent, e as createBlock, g as openBlock, s as N8nCard, n as normalizeClass, w as withCtx, j as createBaseVNode, i as createVNode, p as N8nText, k as createTextVNode, t as toDisplayString, l as unref, en as N8nActionToggle, m as N8nHeading, an as useMessage, ao as MODAL_CONFIRM, _ as _export_sfc, v as useSettingsStore, a2 as useWorkflowsStore, Q as useUIStore, dh as useCredentialsStore, ay as useDocumentTitle, aB as usePageRedirectionHelper, aF as EnterpriseEditionFeature, aE as hasPermission, ar as createEventBus, eJ as getCurrentInstance, cg as resolveDirective, h as createElementBlock, f as createCommentVNode, F as Fragment, b3 as withDirectives, cZ as InfoTip, A as renderList, q as N8nButton, e4 as N8nActionBox, eK as LOG_STREAM_MODAL_KEY, bI as v4, Z as nextTick } from "./index-BXVCKjk6.js";
        ...
        append: withCtx(() => [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              nodeParameters.value.enabled ? (openBlock(), createBlock(_component_N8nText, {
                key: 0,
                color: "success",
                size: "small",
                bold: ""
          ...
          storeHasItems() ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(sortedItemKeysByLabel.value, (item) => {
              return openBlock(), createBlock(_component_ElRow, {
                ...
                default: withCtx(() => [
                  unref(logStreamingStore).items[item.key]?.destination ? (openBlock(), createBlock(_component_ElCol, { key: 0 }, {
                    default: withCtx(() => [
            ...
            createBaseVNode("div", _hoisted_4, [
              canManageLogStreaming.value ? (openBlock(), createBlock(_component_N8nButton, {
                key: 0,
                size: "large",
