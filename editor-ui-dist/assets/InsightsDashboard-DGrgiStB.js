const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CBWNQ3pI.js","assets/index-C2Ey2c-F.js","assets/index-CpPc1kM8.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-BteoNkXY.js","assets/chartjs.utils-C3X9y4oi.js","assets/InsightsSummary-CDvzIFeg.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-BuZAWkl4.js","assets/InsightsChartFailed-zwJgaLTz.js","assets/InsightsChartFailureRate-Boa96rra.js","assets/InsightsChartTimeSaved-BI1JCOLv.js","assets/InsightsChartAverageRuntime-BO6uuLbJ.js","assets/InsightsTableWorkflows-aVYuzGmk.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, em as useModel, gh as useInsightsStore, gr as getTimeRangeLabels, r as ref, hb as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, ed as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, ec as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hc as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hd as INSIGHT_TYPES, dx as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b2 as onBeforeMount, m as N8nHeading, n as normalizeClass, fI as ProjectSharing, dN as _sfc_main$4, c5 as resolveDynamicComponent, aV as __vitePreload, am as useTelemetry, he as TELEMETRY_TIME_RANGE } from "./index-C2Ey2c-F.js";
import { I as InsightsSummary } from "./InsightsSummary-CDvzIFeg.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CBWNQ3pI.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-BteoNkXY.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-zwJgaLTz.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-Boa96rra.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BI1JCOLv.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BO6uuLbJ.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-aVYuzGmk.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
