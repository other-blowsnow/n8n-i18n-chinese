...
import { _t as I18nT, gt as useI18n, h as computedAsync } from "./_MapCache-DZMn6F95.js";
import { Fn as N8nIcon_default, Mn as N8nText_default, Nn as N8nButton_default, ft as N8nTooltip_default, lt as N8nLink_default } from "./src-DuV1yrAd.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter } from "./truncate-OqsyiABz.js";
import { t as useMessage } from "./useMessage-BUlTkhLg.js";
import { Ai as nodeViewEventBus, Gt as generateCodeForPrompt, Js as useRootStore, Li as useUIStore, Qt as useFlattenSchema, Sn as injectWorkflowState, Tn as require_pick, Ur as executionDataToJson, Zt as useDataSchema, a as useNDVStore, bi as isEmpty, o as useWorkflowsStore, rt as useNodeTypesStore, t as useTelemetry, xn as useNodeHelpers, yn as environments_store_default, zo as useSettingsStore } from "./useTelemetry-C3cN19b2.js";
import { t as useToast } from "./useToast-B-CMvNEW.js";
import { Bs as AI_TRANSFORM_NODE_TYPE, Ci as SCHEMA_PREVIEW_DOCS_URL, Do as createResultError, Fs as ApplicationError, Ms as DateTime, Ns as NodeConnectionTypes, Rs as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, ca as WEBHOOK_NODE_TYPE, dn as FORM_TRIGGER_NODE_TYPE, fn as FROM_AI_PARAMETERS_MODAL_KEY, ii as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, kr as MODAL_CONFIRM, nt as CHAT_TRIGGER_NODE_TYPE, on as EnterpriseEditionFeature, or as MANUAL_TRIGGER_NODE_TYPE, zs as AI_TRANSFORM_JS_CODE } from "./constants-CiCQTzlI.js";
import { t as useExternalHooks } from "./useExternalHooks-CFOQ8Nn2.js";
import { t as useRunWorkflow } from "./useRunWorkflow-ayk4R-2L.js";
import { t as usePinnedData } from "./usePinnedData-DhNnlolU.js";
import { t as NodeIcon_default } from "./NodeIcon-gge00gA3.js";
import { i as Ln, o as gu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-0_NC9wG9.js";
...
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-BqFZ1mKq.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$3, [createBaseVNode("div", _hoisted_2$2, [
				...
				_ctx.itemCount ? (openBlock(), createElementBlock("div", _hoisted_5, toDisplayString(unref(i18n).baseText("ndv.output.items", { interpolate: { count: _ctx.itemCount } })), 1)) : _ctx.preview ? (openBlock(), createElementBlock("div", _hoisted_6, toDisplayString(unref(i18n).baseText("dataMapping.schemaView.previewNode")), 1)) : createCommentVNode("", true)
...
var VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	emits: ["click"],
	setup(__props, { emit: __emit }) {
		useCssVars((_ctx) => ({ "8a795c8a": _ctx.level }));
		const props$1 = __props;
		const emit = __emit;
		return (_ctx, _cache) => {
...
var VirtualSchemaItem_default = /* @__PURE__ */ __plugin_vue_export_helper_default(VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": VirtualSchemaItem_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-ea0c3249"]]);
...
var VirtualSchema_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const getNodeSchema = async (fullNode, connectedNode) => {
			...
			const connectedOutputsWithData = connectedOutputIndexes.map((outputIndex) => ({
				outputIndex,
				runIndex: getLastRunIndexWithData(fullNode.name, outputIndex, props$1.connectionType)
			...
			const nodeData = filteredOutputsWithData.map(({ outputIndex, runIndex }) => getNodeInputData(fullNode, runIndex, outputIndex, props$1.paneType, props$1.connectionType)).flat();
		...
		const nodesSchemas = computedAsync(async () => {
			...
			for (const node of props$1.nodes) {
				...
				const { schema, connectedOutputIndexes, itemsCount, preview, hasBinary, isNodeExecuted, isDataEmpty, runIndex } = await getNodeSchema(fullNode, node);
...
var VirtualSchema_vue_vue_type_style_index_0_lang_module_default = { executeButton: "_executeButton_107ze_2" };
var VirtualSchema_default = /* @__PURE__ */ __plugin_vue_export_helper_default(VirtualSchema_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": VirtualSchema_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-a0b79edb"]]);
