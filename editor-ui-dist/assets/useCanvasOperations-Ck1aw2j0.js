...
import { c as useClipboard, it as useI18n$1, v as useLocalStorage } from "./core-CzIVo7k9.js";
import { ct as useRoute, ji as require_markdown_it_link_attributes, lt as useRouter } from "./src-DVkMmVCd.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Bt as useWorkflowHelpers, Ct as useDataSchema, Gn as CanvasConnectionMode, Gt as sanitizeConnections, Ht as useTagsStore, Jn as useHistoryStore, Kr as pinDataToExecutionData, Sn as useCanvasStore, Ut as ensureNodePosition, Vn as isValidNodeConnectionType, Xn as AddNodeCommand, Yn as AddConnectionCommand, b as useNodeTypesStore, bn as serializeNode, cr as CONFIGURATION_NODE_SIZE, da as tryToParseNumber, dr as PUSH_NODES_OFFSET, er as MoveNodeCommand, fn as injectWorkflowDocumentStore, g as getExecutionErrorToastConfiguration, ir as ReplaceNodeParametersCommand, ln as useNDVStore, lr as DEFAULT_NODE_SIZE, mr as generateOffsets, nr as RemoveNodeCommand, oa as isPresent, on as usePostHog, pr as doRectsOverlap, pt as useCredentialsStore, q as removePreviewToken, qn as CanvasNodeRenderType, r as useUIStore, rn as useTelemetry, rr as RenameNodeCommand, s as useWorkflowsStore, sr as CONFIGURABLE_NODE_SIZE, tn as useProjectsStore, tr as RemoveConnectionCommand, ur as DEFAULT_VIEWPORT_BOUNDARIES, xn as useNodeHelpers, xr as getNodesGroupSize, yr as getNewNodePosition } from "./users.store-Dpbobzbe.js";
import { t as useToast } from "./useToast-Pwu_Jqrl.js";
import { As as resolveNodeWebhookId, Gs as isCommunityPackageName, Ho as require__baseUniq, Ks as isObjectEmpty, Ol as CANVAS_ZOOMED_VIEW_EXPERIMENT, Po as require_cloneDeep, Pt as CHAT_TRIGGER_NODE_TYPE, Rc as v4, Ss as isHitlToolType, Vl as NDV_IN_FOCUS_PANEL_EXPERIMENT, Ws as deepCopy, Xl as EnterpriseEditionFeature, bn as MANUAL_CHAT_TRIGGER_NODE_TYPE, da as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, ds as getNodeInputs, fa as LOCAL_STORAGE_LOGS_PANEL_OPEN, fr as UPDATE_WEBHOOK_ID_NODE_TYPES, fs as getNodeOutputs, ii as VIEWS, or as STICKY_NODE_TYPE, pa as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ps as getNodeParameters, ss as generateNodesGraph, ua as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, uc as NodeConnectionTypes, us as getConnectionTypes, vs as getSubworkflowId } from "./constants-B2-iseoM.js";
...
import { t as useTemplatesStore } from "./templates.store-BFlIVMlL.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-DRsqgVDX.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-7j4EhivG.js";
