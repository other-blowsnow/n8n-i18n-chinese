...
import { Go as activateLicenseKey, Jo as renewLicense, Js as useRootStore, Ko as getLicense, Yo as requestLicenseTrial, gc as defineStore, qo as registerCommunityEdition, zo as useSettingsStore } from "./useTelemetry-D6pZULgL.js";
...
const useUsageStore = defineStore("usage", () => {
	...
	const activateLicense = async (activationKey) => {
		setData(await activateLicenseKey(rootStore.restApiContext, { activationKey }));
