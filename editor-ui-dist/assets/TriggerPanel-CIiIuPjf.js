import { d as defineComponent, h as createElementBlock, g as openBlock, n as normalizeClass, j as createBaseVNode, Y as renderSlot, _ as _export_sfc, a2 as useWorkflowsStore, ae as useNodeTypesStore, dl as usePostHog, x as computed, dq as NDV_UI_OVERHAUL_EXPERIMENT, bH as NodeConnectionTypes, o as onMounted, X as onBeforeUnmount, F as Fragment, A as renderList, e as createBlock, f as createCommentVNode, aa as Tooltip, w as withCtx, i as createVNode, c0 as NodeIcon, k as createTextVNode, t as toDisplayString, hV as convertToDisplayDateComponents, cg as resolveDirective, l as unref, cZ as InfoTip, b3 as withDirectives, c as useI18n, p as N8nText, bX as getDefaultExportFromCjs, hW as requireCapitalize, r as ref, hX as parseAiContent, N as N8nIcon, O as N8nRadioButtons, hY as _sfc_main$8, hZ as ViewSubExecution, bW as formatTokenUsageCount, a8 as watch, h_ as ElTree, aq as normalizeStyle, aZ as useNDVStore, eD as storeToRefs, h$ as useNodeDirtiness, i0 as useNodeType, bO as usePinnedData, i1 as CanvasNodeDirtiness, ch as RunData, bv as createSlots, ci as NDVEmptyState, cj as waitingNodeTooltip, cN as _sfc_main$a, ac as I18nT, dR as _sfc_main$b, b4 as vShow, am as useTelemetry, Q as useUIStore, b as useRouter, aA as useWorkflowHelpers, i2 as isTriggerPanelObject, fm as getTriggerNodeServiceName, bM as CHAT_TRIGGER_NODE_TYPE, i3 as WEBHOOK_NODE_TYPE, i4 as FORM_TRIGGER_NODE_TYPE, fe as CopyInput, q as N8nButton, m as N8nHeading, C as N8nLink, ar as createEventBus, i5 as Transition, V as VIEWS, al as WORKFLOW_SETTINGS_MODAL_KEY } from "./index-BXVCKjk6.js";
import { R as RunDataAi$1, g as getConsumedTokens, c as createAiData, a as getTreeNodeData, b as getReferencedData } from "./RunDataParsedAiContent-Dwq9HLB3.js";
import { _ as _sfc_main$9 } from "./ConsumedTokensDetails.vue_vue_type_script_setup_true_lang-BsM2-pdi.js";
import { u as useExecutionData } from "./NodeView-CZh30GU0.js";
import { N as N8nInfoAccordion } from "./InfoAccordion-CoF8qckB.js";
          ...
          return createBaseVNode("ul", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(connectedNodes.value[connectionGroup], ({ node, nodeType }) => {
              return openBlock(), createElementBlock(Fragment, null, [
                node && nodeType ? (openBlock(), createBlock(_component_N8nTooltip, {
                  key: node.name,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_N8nSpinner = _sfc_main$b;
      const _directive_n8n_html = resolveDirective("n8n-html");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      const _component_N8nPulse = N8nPulse;
      const _component_N8nText = N8nText;
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            hasIssues.value || hideContent.value ? (openBlock(), createElementBlock("div", _hoisted_1)) : isListeningForEvents.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
              createVNode(_component_N8nPulse, null, {
                default: withCtx(() => [
                  createVNode(NodeIcon, {
              ...
              isWebhookNode.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
                ...
                createBaseVNode("div", {
                  ...
                  createVNode(_component_N8nText, { tag: "div" }, {
                    default: withCtx(() => [
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", {
                  ...
                  header2.value ? (openBlock(), createBlock(_component_N8nHeading, {
                    key: 0,
                    tag: "h1",
                    bold: ""
                  }, {
                  ...
                  subheader.value ? (openBlock(), createBlock(_component_N8nText, { key: 1 }, {
                    default: withCtx(() => [
                      createBaseVNode("span", {
              ...
              activationHint.value ? (openBlock(), createBlock(_component_N8nText, {
                key: 1,
                size: "small",
                onClick: onLinkClick
              }, {
              ...
              activationHint.value && executionsHelp.value ? (openBlock(), createBlock(_component_N8nLink, {
                key: 2,
                size: "small",
              ...
              executionsHelp.value ? (openBlock(), createBlock(_component_N8nInfoAccordion, {
                key: 3,
                ref_key: "help",
                ref: help,
...
const TriggerPanel = /* @__PURE__ */ _export_sfc(_sfc_main, [["__cssModules", cssModules], ["__scopeId", "data-v-bb5337d4"]]);
export {
  OutputPanel as O,
  TriggerPanel as T,
