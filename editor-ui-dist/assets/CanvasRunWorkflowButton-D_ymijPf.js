...
import { at as I18nT, it as useI18n, t as computedAsync } from "./core-CzIVo7k9.js";
import { Ai as N8nTooltip_default, At as N8nActionDropdown_default, Ca as N8nText_default, Kt as ElCollapseTransition, Ta as N8nIcon_default, lt as useRouter, tt as N8nLink_default, wa as N8nButton_default, zi as truncateBeforeLast } from "./src-DVkMmVCd.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { i as useExpressionResolveCtx } from "./useCanvasMapping-DBf6im0J.js";
import { t as ParameterInputList_default } from "./ParameterInputList-VigjHxcD.js";
import { Bt as useWorkflowHelpers, Jn as useHistoryStore, Kt as sortNodesByExecutionOrder, Ri as getTriggerNodeServiceName, Yt as useEnvironmentsStore, b as useNodeTypesStore, dr as PUSH_NODES_OFFSET, fn as injectWorkflowDocumentStore, ft as listenForCredentialChanges, ln as useNDVStore, pt as useCredentialsStore, r as useUIStore, rn as useTelemetry, s as useWorkflowsStore, xn as useNodeHelpers } from "./users.store-Dpbobzbe.js";
import { t as useToast } from "./useToast-Pwu_Jqrl.js";
import { Bc as require_isEqual, Bs as isResourceLocatorValue, Dc as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, Hi as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, Rc as v4, bo as buildAdjacencyList, cs as displayParameter, ds as getNodeInputs, fs as getNodeOutputs, gl as ExpressionLocalResolveContextSymbol, ii as VIEWS, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, jo as extractReferencesInNodeExpressions, ks as nodeAcceptsInputType, uc as NodeConnectionTypes, xn as MANUAL_TRIGGER_NODE_TYPE, xo as parseExtractableSubgraphSelection } from "./constants-B2-iseoM.js";
import "./builder.store-Bh3JUJ7-.js";
import { i as isPlaceholderValue, n as findPlaceholderDetails } from "./dist-CaxuMXjN.js";
import { t as useTemplatesStore } from "./templates.store-BFlIVMlL.js";
import { i as globalLinkActionsEventBus } from "./event-bus-Ccdzpa6T.js";
import { t as useClipboard } from "./useClipboard-DD1zAisf.js";
import { c as useLogsStore, o as isChatNode, t as useCanvasOperations } from "./useCanvasOperations-Ck1aw2j0.js";
...
function useWorkflowExtraction() {
	...
	function checkExtractableSelectionValidity(selection) {
		...
		const isSingleIO = (nodeName, getIOs) => {
			...
			return getIOs({ expression: workflowDocumentStore.value.getExpressionHandler() }, node, nodeType).filter((x) => typeof x === "string" ? x === "main" : x.type === "main").length <= 1;
		};
