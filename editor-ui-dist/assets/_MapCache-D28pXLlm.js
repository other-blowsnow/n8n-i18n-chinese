...
var zh_CN_default = {
	...
	"aiAssistant.builder.reviewChanges.button": "查看变更",
	"aiAssistant.builder.reviewChanges.editedNodes": "已编辑 {count} 个节点",
	...
	"settings.secretsProviderConnections.modal.scope.info": "选择一个项目将仅与该项目共享机密存储。如果你想与所有项目共享机密存储，请选择“Global”。",
	...
	"settings.secretsProviderConnections.badge.tooltip.project": "此秘密存储与 {projectName} 共享。",
	"settings.secretsProviderConnections.badge.tooltip.global": "本实例的所有项目和用户均可使用此机密存储。",
	...
	"projects.settings.externalSecrets.emptyState.instanceAdmin.noProjectProviders.description": "与此项目共享秘密存储，以便在此处能够使用外部秘密。共享后，秘密将自动出现，并且可以通过凭据中的别名进行引用。",
	"projects.settings.externalSecrets.emptyState.projectAdmin.description": "添加一个机密存储并与本项目共享，以在此处提供外部机密。共享后，机密将自动显示，并且可以通过凭据中的别名进行引用。",
	"projects.settings.externalSecrets.button.addSecretsStore": "添加机密保险库",
	"projects.settings.externalSecrets.button.shareSecretsStore": "共享机密存储",
	...
	"projects.settings.externalSecrets.expand": "扩展外部机密存储",
	"projects.settings.externalSecrets.collapse": "折叠外部密钥存储",
