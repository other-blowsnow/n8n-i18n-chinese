...
import { J as useThrottleFn, it as useI18n } from "./core-CzIVo7k9.js";
import { Ai as N8nTooltip_default, Ca as N8nText_default, Mt as useDeviceSupport, Ta as N8nIcon_default, bt as createEventBus, k as N8nResizeWrapper_default } from "./src-DVkMmVCd.js";
...
import { Yr as useStorage, b as useNodeTypesStore, cn as injectNDVStore, fn as injectWorkflowDocumentStore, r as useUIStore, rn as useTelemetry, s as useWorkflowsStore, xn as useNodeHelpers } from "./users.store-Dpbobzbe.js";
import { Qt as EXECUTABLE_TRIGGER_NODE_TYPES, fs as getNodeOutputs, i as BASE_NODE_SURVEY_URL, ma as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, qs as jsonParse, uc as NodeConnectionTypes, w as APP_MODALS_ELEMENT_ID } from "./constants-B2-iseoM.js";
...
var NodeDetailsView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const parentNodes = computed(() => {
			if (activeNode.value) return workflowObject.value?.getParentNodesByDepth(activeNode.value.name, 1) ?? [];
			return [];
		});
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(ElDialog), {
				...
				default: withCtx(() => [createVNode(unref(N8nTooltip_default), {
					...
					output: withCtx(() => [workflowObject.value ? (openBlock(), createBlock(OutputPanel_default, {
						key: 0,
					...
					fn: withCtx(() => [showTriggerPanel.value ? (openBlock(), createBlock(TriggerPanel_default, {
						...
						onExecute: onNodeExecute,
						onActivate: onWorkflowActivate
					}, null, 8, ["node-name", "push-ref"])) : !isTriggerNode.value && workflowObject.value ? (openBlock(), createBlock(InputPanel_default, {
						key: 1,
						"workflow-object": workflowObject.value,
						"can-link-runs": canLinkRuns.value,
