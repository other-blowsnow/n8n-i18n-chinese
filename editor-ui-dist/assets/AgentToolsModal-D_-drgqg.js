...
import { Ai as N8nTooltip_default, Ca as N8nText_default, Fi as N8nIconButton_default, Pi as Input_default, Ta as N8nIcon_default, wa as N8nButton_default, xa as N8nHeading_default } from "./src-yoaEB2ny.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Jt as useWorkflowsListStore, b as useNodeTypesStore, ha as getWorkflow, r as useUIStore, rn as useTelemetry, xn as useNodeHelpers } from "./users.store-C7j4ikpF.js";
import { t as useToast } from "./useToast-uyEWXkNO.js";
import { Ka as INCOMPATIBLE_WORKFLOW_TOOL_BODY_NODE_TYPES, Ql as DEBOUNCE_TIME, Rc as v4, ou as getDebounceTime, qa as SUPPORTED_WORKFLOW_TOOL_TRIGGERS, qr as AGENT_TOOL_CONFIG_MODAL_KEY, uc as NodeConnectionTypes, vc as AI_VENDOR_NODE_TYPES } from "./constants-B2-iseoM.js";
...
import { n as nodeTypeToNewToolRef, o as workflowToNewToolRef, r as toolRefToNode, t as getExistingToolNames } from "./useAgentToolRefAdapter-C44gLFng.js";
...
var AgentToolsModal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		*/
		const availableWorkflows = computed(() => projectWorkflows.value.filter((wf) => !wf.isArchived));
		...
		async function handleAddWorkflow(workflow) {
			...
			const incompatible = (full.nodes ?? []).filter((n) => INCOMPATIBLE_WORKFLOW_TOOL_BODY_NODE_TYPES.includes(n.type));
