const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-DjVP89N9.js","assets/index-DfVt-3V5.js","assets/index-DXNU_2Fk.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-255zu6UL.js","assets/chartjs.utils-B96zlnRn.js","assets/InsightsSummary-DKyv8ymo.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-D50gjPzV.js","assets/InsightsChartFailed-BJnHANLI.js","assets/InsightsChartFailureRate-5lzmSstl.js","assets/InsightsChartTimeSaved-d8WCo1Fa.js","assets/InsightsChartAverageRuntime-BJ_xmiYF.js","assets/InsightsTableWorkflows-Bqgau3o-.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eg as useModel, gb as useInsightsStore, r as ref, gY as UNLICENSED_TIME_RANGE, gl as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, e9 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e8 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gZ as ElDialog, aA as usePageRedirectionHelper, _ as _export_sfc, a2 as useRoute, g_ as INSIGHT_TYPES, ds as defineAsyncComponent, a7 as watch, o as onMounted, ax as useDocumentTitle, m as N8nHeading, n as normalizeClass, dJ as _sfc_main$4, c4 as resolveDynamicComponent, aU as __vitePreload, al as useTelemetry, g$ as TELEMETRY_TIME_RANGE } from "./index-DfVt-3V5.js";
import { I as InsightsSummary } from "./InsightsSummary-DKyv8ymo.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-DjVP89N9.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-255zu6UL.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BJnHANLI.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-5lzmSstl.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-d8WCo1Fa.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BJ_xmiYF.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-Bqgau3o-.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
