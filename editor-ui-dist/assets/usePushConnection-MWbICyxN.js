...
import { i as usePushConnectionStore, t as useRunWorkflow } from "./useRunWorkflow-Bd2-68As.js";
...
async function executionFinished({ data }, options) {
	...
	if (templateId) {
		...
		else if (templateId === "ready-to-run-ai-workflow-v1" || templateId === "ready-to-run-ai-workflow-v2") if (data.status === "success") readyToRunWorkflowsV2Store.trackExecuteAiWorkflowSuccess();
