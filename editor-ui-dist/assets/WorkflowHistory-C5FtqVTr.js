...
import { $ as N8nActionToggle_default, An as N8nHeading_default, Fn as N8nIcon_default, Nn as N8nButton_default, et as N8nLoading_default, ft as N8nTooltip_default, it as N8nBadge_default } from "./src-B9lyFNPE.js";
...
import { Bo as getWorkflowHistory, Fo as getNewWorkflow, Js as useRootStore, Li as useUIStore, Vo as getWorkflowVersion, gc as defineStore, o as useWorkflowsStore, r as telemetry, zo as useSettingsStore } from "./useTelemetry-BnWkdL5v.js";
import { t as useToast } from "./useToast-CYEyObML.js";
import "./sanitize-html-BuXr7o4T.js";
import "./path-browserify-DsmB_HMK.js";
import { _a as WORKFLOW_HISTORY_VERSION_RESTORE, oa as VIEWS, oo as getResourcePermissions } from "./constants-7lEZpYki.js";
...
var WorkflowHistoryList_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const onItemMounted = ({ index, offsetTop, isActive }) => {
			...
			if (index === props.items.length - 1 && props.lastReceivedItemsLength === props.requestNumberOfItems) observeElement(listElement.value?.children[index]);
		};
		return (_ctx, _cache) => {
