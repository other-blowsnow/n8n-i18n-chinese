...
import { A as createEventHook, T as useStorage$1, at as useI18n, et as addHeaders, nt as i18n, s as useAsyncState, tt as addNodeTranslation, v as useLocalStorage, y as useMediaQuery } from "./core-BYwHXEXE.js";
import { Bi as truncate, Ct as createEventBus, _i as isClient$1, dr as removeClass, fn as useGlobalComponentSettings, j as isBinary, lr as getStyle, lt as useRoute, sr as addClass } from "./src-BvkWedrz.js";
import { a as require_toString, s as require_memoize, t as require_get } from "./get-Den8eczo.js";
import { $i as LOCAL_STORAGE_SIDEBAR_WIDTH, $r as FROM_AI_PARAMETERS_MODAL_KEY, $t as EXECUTE_COMMAND_NODE_TYPE, Aa as require_pick, Ai as WORKFLOW_SETTINGS_MODAL_KEY, At as CALENDLY_TRIGGER_NODE_TYPE, B as AI_CATEGORY_AGENTS, Bi as LOCAL_STORAGE_EXPERIMENT_OVERRIDES, Bo as makeNodeName, Br as ABOUT_MODAL_KEY, Bt as CREDENTIAL_ONLY_NODE_PREFIX, C as TEMPLATES_NODES_FILTER, Ci as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, Co as displayParameterPath, Di as WORKFLOW_HISTORY_VERSION_RESTORE, Dn as MODULE_ENABLED_NODES, Do as getNodeParameters, Dt as AI_TRANSFORM_NODE_TYPE, Ei as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, En as MICROSOFT_TEAMS_NODE_TYPE, Eo as getNodeOutputs, Es as isExpression, Et as AI_MCP_TOOL_NODE_TYPE, Fs as CHAT_TRIGGER_NODE_TYPE, Ft as CLEARBIT_NODE_TYPE, Ga as require__createCompounder, Gr as CHAT_EMBED_MODAL_KEY, Hr as AI_GATEWAY_TOP_UP_MODAL_KEY, I as MAPPING_PARAMS, Ia as isAssignmentCollectionValue, Io as isHitlToolType, It as CODE_NODE_TYPE, J as AI_CATEGORY_OTHER_TOOLS, Ja as require__baseIteratee, Jn as SCHEDULE_TRIGGER_NODE_TYPE, Jo as isFilterValue, Jr as DELETE_SECRETS_PROVIDER_MODAL_KEY, Jt as ELASTIC_SECURITY_NODE_TYPE, Kr as CONFIRM_PASSWORD_MODAL_KEY, Ks as SEND_AND_WAIT_OPERATION, Ma as require__baseFlatten, Mc as WorkflowDocumentStoreKey, Mn as NOTION_TRIGGER_NODE_TYPE, N as CUSTOM_API_CALL_KEY, Ns as BINARY_MODE_SEPARATE, Oi as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Oo as getNodeParametersIssues, Ot as BAMBOO_HR_NODE_TYPE, P as DATA_TYPE_ICON_MAP, Pt as CHAT_TRIGGER_NODE_TYPE$1, Qr as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, Qs as require_isEqual, Rr as MAIN_HEADER_TABS, Rs as EVALUATION_TRIGGER_NODE_TYPE, Si as WORKFLOW_DIFF_MODAL_KEY, So as displayParameter, Ss as ExpressionError, Ti as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Tn as MICROSOFT_EXCEL_NODE_TYPE, To as getNodeInputs, Ts as nodeConnectionTypes, Un as QUICKBOOKS_NODE_TYPE, Ur as BINARY_DATA_VIEW_MODAL_KEY, Va as Workflow, Vo as mergeIssues, Vr as AI_BUILDER_DIFF_MODAL_KEY, W as AI_CATEGORY_HUMAN_IN_THE_LOOP, Wr as CHANGE_PASSWORD_MODAL_KEY, Ws as MANUAL_TRIGGER_NODE_TYPE, Xn as SERVICENOW_NODE_TYPE, Xr as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Xs as v4, Xt as EMAIL_SEND_NODE_TYPE, Yn as SEGMENT_NODE_TYPE, Yr as DUPLICATE_MODAL_KEY, Zn as SET_NODE_TYPE, Zr as EXPERIMENT_TEMPLATE_RECO_V3_KEY, Zt as ERROR_TRIGGER_NODE_TYPE, _i as VERSIONS_MODAL_KEY, _r as WORKFLOW_TRIGGER_NODE_TYPE, an as FORM_TRIGGER_NODE_TYPE$1, bi as WORKFLOW_ACTIVE_MODAL_KEY, bn as MANUAL_CHAT_TRIGGER_NODE_TYPE, bo as getChildNodes, br as ZENDESK_NODE_TYPE, cl as EnterpriseEditionFeature, ct as CORE_NODES_CATEGORY, di as NEW_ASSISTANT_SESSION_MODAL, dn as HUBSPOT_TRIGGER_NODE_TYPE, ds as sleep$1, ea as LOCAL_STORAGE_THEME, ec as require_keys, ei as IMPORT_CURL_MODAL_KEY, eo as traverseNodeParameters, es as isResourceLocatorValue, et as AI_CATEGORY_VECTOR_STORES, f as DOCS_DOMAIN, fi as NPS_SURVEY_MODAL_KEY, fn as IF_NODE_TYPE, ft as HUMAN_IN_THE_LOOP_CATEGORY, gi as STOP_MANY_EXECUTIONS_MODAL_KEY, gn as JIRA_TRIGGER_NODE_TYPE, go as createRunExecutionData, gr as WORKABLE_TRIGGER_NODE_TYPE, gt as RECOMMENDED_NODES, hi as SETUP_CREDENTIALS_MODAL_KEY, hn as JIRA_NODE_TYPE, ho as createEmptyRunExecutionData, hr as WOOCOMMERCE_TRIGGER_NODE_TYPE, ic as ApplicationError, ii as INSTANCE_AI_CREDENTIAL_SETUP_MODAL_KEY, ir as SPREADSHEET_FILE_NODE_TYPE, is as deepCopy, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, ji as WORKFLOW_SHARE_MODAL_KEY, jn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, ki as WORKFLOW_PUBLISH_MODAL_KEY, kn as NODE_POSITION_CONFLICT_ALLOWLIST, ko as getNodeWebhookUrl, ln as HTTP_REQUEST_NODE_TYPE, lr as THE_HIVE_TRIGGER_NODE_TYPE, mc as hasScope$1, mi as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, mn as ITEM_LISTS_NODE_TYPE, mr as WIKIPEDIA_TOOL_NODE_TYPE, oi as LOG_STREAM_MODAL_KEY, on as GITHUB_TRIGGER_NODE_TYPE, os as isObjectEmpty, pc as getResourcePermissions, pi as PROMPT_MFA_CODE_MODAL_KEY, pr as WEBHOOK_NODE_TYPE, qc as EXPERIMENTS_TO_TRACK, qn as SALESFORCE_NODE_TYPE, qr as CREDENTIAL_RESOLVER_EDIT_MODAL_KEY, qs as TRIMMED_TASK_DATA_CONNECTIONS_KEY, r as DUPLICATE_POSTFFIX, ro as splitExpression, si as MFA_SETUP_MODAL_KEY, sn as GOOGLE_SHEETS_NODE_TYPE, so as require__baseFindIndex, sr as SWITCH_NODE_TYPE, ss as jsonParse, st as BETA_NODES, ti as IMPORT_WORKFLOW_URL_MODAL_KEY, tr as SLACK_NODE_TYPE, ts as isResourceMapperValue$1, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, ua as ROLE, vi as WHATS_NEW_MODAL_KEY, vr as XERO_NODE_TYPE, wi as WORKFLOW_HISTORY_DIFF_MODAL_KEY, wo as getConnectionTypes, ws as NodeConnectionTypes, xi as WORKFLOW_DESCRIPTION_MODAL_KEY, xo as generateNodesGraph, xr as ZENDESK_TRIGGER_NODE_TYPE, yi as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, yn as LIST_LIKE_NODE_OPERATIONS, yo as mapConnectionsByDestination, zn as PAGERDUTY_NODE_TYPE, zr as VIEWS } from "./constants-CLWmEjmW.js";
...
function useWorkflowDocumentNodes(deps) {
	...
	*/
	...
	const allNodes = computed(() => workflowsStore.workflow.nodes);
	const nodesByName = computed(() => {
		return workflowsStore.workflow.nodes.reduce((acc, node) => {
			acc[node.name] = node;
			return acc;
		}, {});
	});
...
function useWorkflowDocumentConnections(deps) {
	...
	const connectionsByDestinationNode = computed(() => mapConnectionsByDestination(workflowsStore.workflow.connections));
