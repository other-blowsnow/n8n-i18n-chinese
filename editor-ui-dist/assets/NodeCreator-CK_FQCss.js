import { d as defineComponent, de as reactive, o as onMounted, bt as useExternalHooks, X as onBeforeUnmount, c6 as toRefs, h as createElementBlock, g as openBlock, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, i as createVNode, N as N8nIcon, _ as _export_sfc, l as unref, ip as REGULAR_NODE_CREATOR_VIEW, F as Fragment, Y as renderSlot, iq as useViewStacks, r as ref, x as computed, ir as useInstalledCommunityPackage, ae as useNodeTypesStore, u as useUsersStore, e as createBlock, p as N8nText, w as withCtx, k as createTextVNode, t as toDisplayString, is as _sfc_main$b, aa as Tooltip, fa as i18n, it as captureException, iu as useKeyboardNavigation, hI as useActions, dg as useNodeCreatorStore, bq as useCalloutHelpers, iv as CUSTOM_API_CALL_KEY, iw as TRIGGER_NODE_CREATOR_VIEW, ix as isNodePreviewKey, iy as OPEN_AI_NODE_TYPE, iz as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, am as useTelemetry, iA as getActiveViewCallouts, cg as resolveDirective, iB as ItemsRenderer, bv as createSlots, iC as withMemo, iD as CategorizedItemsRenderer, c as useI18n, z as N8nCallout, b3 as withDirectives, cZ as InfoTip, B as withModifiers, iE as CommunityNodeFooter, iF as HTTP_REQUEST_NODE_TYPE, fE as createStaticVNode, C as N8nLink, iG as REQUEST_NODE_FORM_URL, iH as filterAndSearchNodes, iI as getRootSearchCallouts, i3 as WEBHOOK_NODE_TYPE, iJ as PRE_BUILT_AGENTS_COLLECTION, iK as camelCase, iL as shouldShowCommunityNodeDetails, ft as isCommunityPackageName, iM as prepareCommunityNodeDetailsViewStack, ia as getNodeIconSource, iN as transformNodeType, iO as AINodesView, iP as AIView, iQ as RegularView, iR as TriggerView, iS as flattenCreateElements, iT as HITL_SUBCATEGORY, iU as getHumanInTheLoopActions, iV as AI_OTHERS_NODE_CREATOR_VIEW, iW as AI_NODE_CREATOR_VIEW, ez as useCommunityNodesStore, a as useToast, c0 as NodeIcon, iX as OfficialIcon, q as N8nButton, dh as useCredentialsStore, iY as removePreviewToken, P as useDebounce, bm as onUnmounted, a8 as watch, ef as N8nNotice, c7 as normalizeProps, K as mergeProps, i5 as Transition, iZ as AI_EVALUATION, i_ as AI_UNCATEGORIZED_CATEGORY, Q as useUIStore, fq as useAssistantStore, dk as useBuilderStore, bu as onClickOutside, ab as _sfc_main$c, aq as normalizeStyle, i$ as SlideTransition, dP as DRAG_EVENT_DATA_KEY, j0 as useActionsGenerator } from "./index-BXVCKjk6.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        unref(isUpdateCheckAvailable) && unref(installedPackage)?.updateAvailable ? (openBlock(), createBlock(_component_CommunityNodeUpdateInfo, {
          key: 0,
            ...
            fn: withCtx(() => [
              withMemo([search.value], () => createVNode(CategorizedItemsRenderer, {
                ...
                hasNoTriggerActions.value ? {
                  name: "empty",
                  fn: withCtx(() => [
                    hasNoTriggerActions.value ? (openBlock(), createBlock(_component_N8nCallout, {
                      key: 0,
                      theme: "info",
                      iconless: "",
                      slim: "",
          ...
          !isTriggerRootView.value || parsedActionActionsBaseline.value.length !== 0 ? {
            ...
            fn: withCtx(() => [
              withMemo([search.value], () => createVNode(CategorizedItemsRenderer, {
                ...
                empty: withCtx(() => [
                  !search.value ? (openBlock(), createBlock(_component_N8nInfoTip, {
                    key: 0,
                    theme: "info",
                    type: "note",
                ...
                default: withCtx(() => [
                  !unref(userActivated) && isTriggerRootView.value ? (openBlock(), createBlock(_component_N8nCallout, {
                    key: 0,
                    theme: "info",
                    iconless: "",
                    slim: "",
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          _ctx.rootView === unref(REGULAR_NODE_CREATOR_VIEW) || _ctx.rootView === unref(TRIGGER_NODE_CREATOR_VIEW) ? (openBlock(), createElementBlock("div", {
            ...
            _ctx.rootView === unref(REGULAR_NODE_CREATOR_VIEW) ? (openBlock(), createBlock(_component_N8nLink, {
              key: 0,
            ...
            _ctx.rootView === unref(TRIGGER_NODE_CREATOR_VIEW) ? (openBlock(), createBlock(_component_N8nLink, {
              key: 1,
        ...
        _ctx.showRequest ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", null, [
            createVNode(_component_N8nLink, { to: unref(REQUEST_NODE_FORM_URL) }, {
              default: withCtx(() => [
        ...
        default: withCtx(() => [
          (openBlock(), createElementBlock("aside", {
            ...
            createBaseVNode("div", {
              ...
              activeViewStack.value.info && !activeViewStack.value.search ? (openBlock(), createBlock(_component_N8nNotice, {
                key: 0,
                class: normalizeClass(_ctx.$style.info),
